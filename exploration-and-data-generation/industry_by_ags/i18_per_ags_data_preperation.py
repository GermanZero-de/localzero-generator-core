...
PATH_I18_VALUES = "i18_values_germany.csv"  # all i18 from an export of the current cenerator (TODO needs to be automated!)
PATH_FILE_EXPORT = "i18_ratio_x_to_co2e_total.csv"

AGS_FILE_PATH = "../data/public/ags/master.csv"
DEHST_FILE_PATH = "Anlagenliste_2018_DEHST.xlsx"
...
def main():
    calcualate_factors_to_co2e_total(PATH_I18_VALUES, PATH_FILE_EXPORT)
