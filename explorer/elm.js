...
var $author$project$Main$PrepareCalculate = F3(
	function (a, b, c) {
		return {$: 'PrepareCalculate', a: a, b: b, c: c};
	});
...
var $author$project$Main$LoadFailure = function (a) {
	return {$: 'LoadFailure', a: a};
};
...
var $author$project$Main$updateModal = F2(
	function (msg, model) {
		if (model.$ === 'Nothing') {
			...
			switch (model.a.$) {
				case 'PrepareCalculate':
					var _v1 = model.a;
					var ndx = _v1.a;
					var inputs = _v1.b;
					var overrides = _v1.c;
					if (msg.$ === 'CalculateModalAgsUpdated') {
						var a = msg.a;
				...
				default:
					...
					return $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
						$elm$core$Maybe$Just(
							$author$project$Main$LoadFailure(f)));
			}
		}
	});
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'FileContentLoaded':
				var content = msg.a;
				var _v1 = A2($elm$json$Json$Decode$decodeString, $author$project$Storage$decoder, content);
				if (_v1.$ === 'Err') {
				...
				if (resultOrError.$ === 'Ok') {
					...
					var newDiffs = function () {
						if (maybeRunId.$ === 'Nothing') {
							...
							return A2(
								$elm$core$Dict$map,
								F2(
									function (_v5, diffData) {
										var runA = _v5.a;
										var runB = _v5.b;
										if (_Utils_eq(runA, runId) || _Utils_eq(runB, runId)) {
											var _v6 = A4($author$project$Main$diffRunsById, runA, runB, diffData.tolerance, modelWithRun);
											if (_v6.$ === 'Nothing') {
												return diffData;
											} else {
												var d = _v6.a;
					...
					switch (resultOrError.a.$) {
						case 'BadUrl':
							...
							return A2($author$project$Main$withLoadFailure, 'BAD URL: ' + s, model);
						case 'Timeout':
							var _v8 = resultOrError.a;
							return A2($author$project$Main$withLoadFailure, 'TIMEOUT', model);
						case 'NetworkError':
							var _v9 = resultOrError.a;
							return A2($author$project$Main$withLoadFailure, 'NETWORK ERROR', model);
						case 'BadStatus':
							var code = resultOrError.a.a;
							return A2(
								$author$project$Main$withLoadFailure,
								'BAD STATUS CODE' + $elm$core$String$fromInt(code),
								model);
						default:
							var error = resultOrError.a.a;
							return A2($author$project$Main$withLoadFailure, 'Failed to decode: ' + error, model);
					}
				}
			...
			case 'ModalMsg':
				...
				return A2(
					...
					A2(
						...
						A2($author$project$Main$updateModal, modalMsg, model.showModal)));
			...
			case 'FilterEdited':
				...
				var newActiveSearch = function () {
					var _v15 = A2($author$project$AllRuns$get, runId, model.runs);
					if (_v15.$ === 'Nothing') {
				...
				var activeSearchFieldChanged = function () {
					var _v12 = _Utils_Tuple2(model.activeSearch, newActiveSearch);
					if (_v12.b.$ === 'Nothing') {
						var _v13 = _v12.b;
						return false;
					} else {
						if (_v12.a.$ === 'Nothing') {
							...
							var a = _v12.a.a;
							var b = _v12.b.a;
							return !_Utils_eq(a.runId, b.runId);
						}
					}
				}();
				return A2(
			...
			case 'OverrideEdited':
				...
				var isFocusChanged = function () {
					var _v18 = model.activeOverrideEditor;
					if (_v18.$ === 'Nothing') {
						return true;
					} else {
						var e = _v18.a;
			...
			case 'OverrideEditFinished':
				var _v19 = model.activeOverrideEditor;
				if (_v19.$ === 'Nothing') {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
					var editor = _v19.a;
					var modelEditorClosed = _Utils_update(
						model,
						{activeOverrideEditor: $elm$core$Maybe$Nothing});
					var _v20 = editor.asFloat;
					if (_v20.$ === 'Nothing') {
						return _Utils_Tuple2(modelEditorClosed, $elm$core$Platform$Cmd$none);
					} else {
						var f = _v20.a;
						var _v21 = A2($author$project$AllRuns$get, editor.runId, model.runs);
						if (_v21.$ === 'Nothing') {
							return _Utils_Tuple2(modelEditorClosed, $elm$core$Platform$Cmd$none);
						} else {
							var run = _v21.a;
			...
			case 'RemoveOverrideClicked':
				var runId = msg.a;
				var name = msg.b;
				var _v22 = A2($author$project$AllRuns$get, runId, model.runs);
				if (_v22.$ === 'Nothing') {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
					var run = _v22.a;
			...
			case 'DiffToleranceUpdated':
				...
				var _v25 = A4($author$project$Main$diffRunsById, aId, bId, newTolerance, model);
				if (_v25.$ === 'Nothing') {
					return $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(model);
				} else {
					var d = _v25.a;
			...
			case 'ToggleSelectForCompareClicked':
				var runId = msg.a;
				var _v26 = model.selectedForComparison;
				if (_v26.$ === 'Nothing') {
					return $Janiczek$cmd_extra$Cmd$Extra$withNoCmd(
						_Utils_update(
							model,
					...
					if (_Utils_eq(r, runId)) {
						...
						var idB = runId;
						var idA = r;
						var _v27 = A4($author$project$Main$diffRunsById, idA, idB, $author$project$Value$defaultTolerance, withoutComparison);
						if (_v27.$ === 'Nothing') {
			...
			default:
				var dragMsg = msg.a;
				var _v28 = A2($author$project$Html5$DragDrop$update, dragMsg, model.dragDrop);
				var newDragDrop = _v28.a;
				return A2(
					$Janiczek$cmd_extra$Cmd$Extra$withCmd,
...
var $author$project$Main$CalculateModalAgsUpdated = function (a) {
	return {$: 'CalculateModalAgsUpdated', a: a};
};
...
var $author$project$Main$CalculateModalTargetYearUpdated = function (a) {
	return {$: 'CalculateModalTargetYearUpdated', a: a};
};
...
var $author$project$Styling$sizes = {large: 12, medium: 8, small: 4};
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					{
						...
						onChange: A2($elm$core$Basics$composeL, $author$project$Main$ModalMsg, $author$project$Main$CalculateModalAgsUpdated),
						...
						]),
					{
						label: A2(
							...
							labelStyle,
							$mdgriffith$elm_ui$Element$text(
								$elm$core$String$fromInt(inputs.year))),
						max: 2050,
						min: 2025,
						onChange: A2(
							$elm$core$Basics$composeL,
...
var $author$project$Main$defaultInputs = {ags: '', year: 2035};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A3($author$project$Main$viewDiffTree, id, collapseStatus, diffData.diff)
				]));
	});
...
var $author$project$Main$FilterQuickAddRequested = {$: 'FilterQuickAddRequested'};
							...
							[
								...
								_Utils_ap(
									...
									A2(
										$elm$core$List$map,
										$mdgriffith$elm_ui$Element$htmlAttribute,
										A2($author$project$Html5$DragDrop$draggable, $author$project$Main$DragDropMsg, thisPath))),
								$mdgriffith$elm_ui$Element$text(name)),
								originalValue,
								maybeOverride
							]);
					...
					_Utils_ap(
						...
						A2(
							...
							function (_v1) {
								...
								var b = _v2.b;
								var diffData = _v1.b;
								return A4($author$project$Main$viewComparison, a, b, model.collapseStatus, diffData);
							},
					...
					case 'Loading':
						return _Utils_Tuple2(
							...
							A2(
								...
								_List_fromArray(
									[
										$mdgriffith$elm_ui$Element$text('This should be done immediately. If it doesn\'t go away something is probably broken.')
									])));
					default:
						var msg = modalState.a;
						return _Utils_Tuple2(
							'Loading failed',
