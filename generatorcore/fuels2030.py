...
def Fuels2030_calc(root):
    ...
    try:
        ...
        f.d_e_hydrogen_reconv.energy = (
            ...
            ass('Ass_E_P_renew_reverse_addon_to_demand_2035') / ass('Ass_E_P_renew_reverse_gud_efficiency')
        ...
        f.p_diesel.energy = root.b30.p.demand_ediesel + root.t30.t.demand_ediesel + root.a30.p_operation.demand_ediesel
        f.p_emethan.energy = root.r30.p.demand_emethan + root.b30.p.demand_emethan + root.i30.p.demand_emethan + root.a30.p_operation.demand_emethan
...
#---------------------------
        ...
        f.p_petrol.demand_electricity = f.p_petrol.energy / ass('Ass_S_power_to_x_efficiency')
        f.p_jetfuel.demand_electricity = f.p_jetfuel.energy / ass('Ass_S_power_to_x_efficiency')
        f.p_diesel.demand_electricity = f.p_diesel.energy / ass('Ass_S_power_to_x_efficiency')
        
        f.p_emethan.demand_electricity = f.p_emethan.energy / ass('Ass_S_methan_efficiency')
        f.p_hydrogen.demand_electricity = f.p_hydrogen.energy / ass('Ass_F_P_electrolysis_efficiency')
        f.p_hydrogen_reconv.demand_electricity = f.p_hydrogen_reconv.energy / ass('Ass_F_P_electrolysis_efficiency')
#-----------------------
...
#---------------------------------
        f.p_petrol.change_energy_pct = f.p_petrol.change_energy_MWh / root.f18.p_petrol.energy
        f.p_jetfuel.change_energy_pct = f.p_jetfuel.change_energy_MWh / root.f18.p_jetfuel.energy
        f.p_diesel.change_energy_pct = f.p_diesel.change_energy_MWh / root.f18.p_diesel.energy
        
        f.p_bioethanol.change_energy_pct =  f.p_bioethanol.change_energy_MWh/ root.f18.p_bioethanol.energy
        f.p_biodiesel.change_energy_pct = f.p_biodiesel.change_energy_MWh/ root.f18.p_biodiesel.energy
        f.p_biogas.change_energy_pct = f.p_biogas.change_energy_MWh/ root.f18.p_biogas.energy
#-------------------------------------
...
#--------------------------------------
        f.p_petrol.CO2e_total_2021_estimated = root.f18.p_petrol.CO2e_total * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        f.p_jetfuel.CO2e_total_2021_estimated = root.f18.p_jetfuel.CO2e_total * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        f.p_diesel.CO2e_total_2021_estimated = root.f18.p_diesel.CO2e_total * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
#---------------------------------------
        f.p_petrol.cost_climate_saved =  (f.p_petrol.CO2e_total_2021_estimated - f.p_petrol.CO2e_total) * entry('In_M_duration_neutral')*fact('Fact_M_cost_per_CO2e_2020')
        f.p_jetfuel.cost_climate_saved = (f.p_jetfuel.CO2e_total_2021_estimated - f.p_jetfuel.CO2e_total) * entry('In_M_duration_neutral')*fact('Fact_M_cost_per_CO2e_2020')
        f.p_diesel.cost_climate_saved = (f.p_diesel.CO2e_total_2021_estimated - f.p_diesel.CO2e_total) * entry('In_M_duration_neutral')*fact('Fact_M_cost_per_CO2e_2020')      
        
        f.p_emethan.cost_climate_saved = - f.p_emethan.CO2e_total * entry('In_M_duration_neutral')*fact('Fact_M_cost_per_CO2e_2020')
#---------------------------------------
...
#--------------------------------------
        f.p_petrol.power_to_be_installed = f.p_petrol.demand_electricity / f.p_petrol.full_load_hour 
        f.p_jetfuel.power_to_be_installed = f.p_jetfuel.demand_electricity / f.p_jetfuel.full_load_hour
        f.p_diesel.power_to_be_installed = f.p_diesel.demand_electricity / ass('Ass_S_power_to_x_full_load_hours2')
        
        f.p_emethan.power_to_be_installed = f.p_emethan.demand_electricity / f.p_emethan.full_load_hour 
        f.p_hydrogen.power_to_be_installed = f.p_hydrogen.demand_electricity / ass('Ass_F_P_electrolysis_full_load_hours')
        f.p_hydrogen_reconv.power_to_be_installed = (
            f.p_hydrogen_reconv.demand_electricity / ass('Ass_F_P_electrolysis_full_load_hours')
        )
#---------------------------------------
        f.p_hydrogen_reconv.invest_per_x = ass('Ass_S_electrolyses_invest_per_power')
#---------------------------------------
        f.p_petrol.invest = f.p_petrol.power_to_be_installed * ass('Ass_S_power_to_x_invest_per_power') 
        f.p_jetfuel.invest = f.p_jetfuel.power_to_be_installed * ass('Ass_S_power_to_x_invest_per_power') 
        f.p_diesel.invest = f.p_diesel.power_to_be_installed * ass('Ass_S_power_to_x_invest_per_power') 
        
        f.p_emethan.invest = f.p_emethan.power_to_be_installed * ass('Ass_S_methan_invest_per_power') 
        f.p_hydrogen.invest = f.p_hydrogen.power_to_be_installed * ass('Ass_S_electrolyses_invest_per_power')
        f.p_hydrogen_reconv.invest = f.p_hydrogen_reconv.power_to_be_installed * f.p_hydrogen_reconv.invest_per_x
#---------------------------------------
        ...
        f.p_hydrogen_reconv.invest_pa = f.p_hydrogen_reconv.invest / entry('In_M_duration_target')
#--------------------------------------
...
#--------------------------------------
        ...
        f.p_hydrogen_reconv.ratio_wage_to_emplo = ass('Ass_S_constr_renew_gas_wage_per_year_2017')
#--------------------------------------
        ...
        f.p_hydrogen_reconv.cost_wage = f.p_hydrogen_reconv.invest_pa * f.p_hydrogen_reconv.pct_of_wage
#--------------------------------------
        f.p_petrol.demand_emplo = f.p_petrol.cost_wage / f.p_petrol.ratio_wage_to_emplo 
        f.p_jetfuel.demand_emplo = f.p_jetfuel.cost_wage / f.p_jetfuel.ratio_wage_to_emplo
        f.p_diesel.demand_emplo = f.p_diesel.cost_wage / f.p_diesel.ratio_wage_to_emplo
        
        f.p_emethan.demand_emplo = f.p_emethan.cost_wage / f.p_emethan.ratio_wage_to_emplo
        f.p_hydrogen.demand_emplo = (
            f.p_hydrogen.cost_wage / f.p_hydrogen.ratio_wage_to_emplo
            if entry('In_M_AGS_com') == "DG000000" else 0
        )
        ...
        f.d_t.energy = (root.t30.t.demand_epetrol + root.t30.t.demand_ediesel + root.t30.t.demand_ejetfuel + root.t30.t.demand_hydrogen)
        f.d_a.energy = (root.a30.p_operation.demand_epetrol + root.a30.p_operation.demand_ediesel + root.a30.p_operation.demand_emethan)
        f.d.energy = (
            f.d_r.energy +
            f.d_b.energy +
            f.d_i.energy +
        ...
        f.p_emethan.invest_pa_outside = (
            0 if entry('In_M_AGS_com') == "DG000000" else
            f.p_emethan.invest_pa * root.e30.d.energy / ass('Ass_E_P_renew_nep_total_2035')
        )
        f.p_hydrogen.invest_pa_outside = (
            0 if entry('In_M_AGS_com') == "DG000000" else
            f.p_hydrogen.invest_pa * root.e30.d.energy / ass('Ass_E_P_renew_nep_total_2035')
        )
        f.p_hydrogen_reconv.invest_pa_outside = (
            0 if entry('In_M_AGS_com') == "DG000000" else
            f.p_hydrogen_reconv.invest_pa * root.e30.d_h.energy / ass('Ass_E_P_renew_nep_total_2035')
        )
        ...
        f.p_emethan.invest_outside = (
            0 if entry('In_M_AGS_com') == "DG000000" else
            f.p_emethan.invest * root.e30.d.energy / ass('Ass_E_P_renew_nep_total_2035')
        )
        f.p_hydrogen.invest_outside = (
            0 if entry('In_M_AGS_com') == "DG000000" else
            f.p_hydrogen.invest * root.e30.d.energy / ass('Ass_E_P_renew_nep_total_2035')
        )
        f.p_hydrogen_reconv.invest_outside = (
            0 if entry('In_M_AGS_com') == "DG000000" else
            f.p_hydrogen_reconv.invest * root.e30.d_h.energy / ass('Ass_E_P_renew_nep_total_2035')
        )
        f.p.invest_outside = (
            f.p_emethan.invest_outside +
            f.p_hydrogen.invest_outside +
        ...
        f.p_petrol.change_CO2e_pct = f.p_petrol.change_CO2e_t / root.f18.p_petrol.CO2e_total
        f.p_petrol.invest_per_x = ass('Ass_S_power_to_x_invest_per_power')
        f.p_jetfuel.change_CO2e_pct = f.p_jetfuel.change_CO2e_t / root.f18.p_jetfuel.CO2e_total
        f.p_jetfuel.invest_per_x = ass('Ass_S_power_to_x_invest_per_power')
        f.p_diesel.change_CO2e_pct = f.p_diesel.change_CO2e_t / root.f18.p_diesel.CO2e_total
