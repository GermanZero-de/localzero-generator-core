...
# ---------------------------------------
        f.p_petrol.cost_climate_saved = (f.p_petrol.CO2e_total_2021_estimated - f.p_petrol.CO2e_total) * \
            entry('In_M_duration_neutral')*fact('Fact_M_cost_per_CO2e_2020')
        f.p_jetfuel.cost_climate_saved = (f.p_jetfuel.CO2e_total_2021_estimated - f.p_jetfuel.CO2e_total) * \
            entry('In_M_duration_neutral')*fact('Fact_M_cost_per_CO2e_2020')
        f.p_diesel.cost_climate_saved = (f.p_diesel.CO2e_total_2021_estimated - f.p_diesel.CO2e_total) * \
            entry('In_M_duration_neutral')*fact('Fact_M_cost_per_CO2e_2020')
