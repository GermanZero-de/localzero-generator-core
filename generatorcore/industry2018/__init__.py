...
def calc(inputs: Inputs) -> I18:
    ...
    p_miner_cement = CO2e_per_t.calc_p_miner_cement(inputs, p_miner_energy)  # type: ignore
    p_miner_chalk = CO2e_per_t.calc_p_miner_chalk(inputs, p_miner_energy)  # type: ignore
    p_miner_glas = CO2e_per_t.calc_p_miner_glas(inputs, p_miner_energy)  # type: ignore
    p_miner_ceram = CO2e_per_t.calc_p_miner_ceram(inputs, p_miner_energy)  # type: ignore
    ...
    p_chem_basic = CO2e_per_t.calc_p_chem_basic(inputs, p_chem_energy)  # type: ignore
    p_chem_ammonia = CO2e_per_t.calc_p_chem_ammonia(inputs, p_chem_energy)  # type: ignore
    p_chem_other = CO2e_per_t.calc_p_chem_other(inputs, p_chem_energy)  # type: ignore
    ...
    p_metal_steel_primary = CO2e_per_t.calc_p_metal_steel_primary_route(inputs, p_metal_steel_energy)  # type: ignore
    p_metal_steel_secondary = CO2e_per_t.calc_p_metal_steel_secondary_route(inputs, p_metal_steel_energy)  # type: ignore
    p_metal_steel = CO2e_with_pct_energy.calc_p_metal_steel(inputs, p_metal_steel_pct_energy, p_metal_steel_energy, p_metal_steel_primary, p_metal_steel_secondary)  # type: ignore
    p_metal_nonfe = CO2e_per_t.calc_p_metal_non_fe(inputs, p_metal_energy)  # type: ignore
    ...
    p_other_paper = CO2e_per_t.calc_p_other_paper(inputs, p_other_energy)  # type: ignore
    p_other_food = CO2e_per_t.calc_p_other_food(inputs, p_other_energy)  # type: ignore
    p_other_further = CO2e_per_MWh.calc_p_other_further(inputs, p_other_energy)  # type: ignore
    p_other_2efgh = CO2e_basic.calc_p_other_2efgh(inputs, p_other_further.energy)  # type: ignore
