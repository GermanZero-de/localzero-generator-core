...
def prepare_facts(inputs: Inputs):
    ...
    new_facts: refdata.DataFrame[
        str
    ] = new_facts_and_assumptions.return_fact_data_frame()

    def replace_value(
        instr: str,
        replace_value_functions: Callable[[float], float] = lambda x: x,
        inputs: refdata.DataFrame[str] = new_facts,
    ) -> list[str]:

        header = inputs.header
        string_list = [x for x in inputs.get(instr)]  # copy by value
        string_list[header["value"]] = str(
            replace_value_functions(float(string_list[header["value"]]))
        )
    ...
    additional_facts = {
        ...
        "Fact_I_P_miner_fec_pct_of_cement": replace_value(
            "Fact_I_P_miner_fec_pct_of_cement_2018"
        ),
        "Fact_I_P_miner_cement_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_miner_cement_energy_use_factor_2017"
        ),
        "Fact_I_P_miner_cement_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_miner_cement_ratio_CO2e_pb_to_prodvol_2018"
        ),
        "Fact_I_P_miner_cement_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_miner_cement_ratio_CO2e_cb_to_prodvol_2018"
        ),
        "Fact_I_P_miner_fec_pct_of_chalk": replace_value(
            "Fact_I_P_miner_fec_pct_of_chalk_2017"
        ),
        "Fact_I_P_miner_chalk_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_miner_chalk_energy_use_factor_2017"
        ),
        "Fact_I_P_miner_chalk_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_miner_chalk_ratio_CO2e_pb_to_prodvol_2018"
        ),
        "Fact_I_P_miner_chalk_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_miner_chalk_ratio_CO2e_cb_to_prodvol_2018"
        ),
        "Fact_I_P_miner_fec_pct_of_glas": replace_value(
            "Fact_I_P_miner_fec_pct_of_glas_2017"
        ),
        "Fact_I_P_miner_glas_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_miner_glas_energy_use_factor_2017"
        ),
        "Fact_I_P_miner_glas_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_miner_glas_ratio_CO2e_pb_to_prodvol_2018"
        ),
        "Fact_I_P_miner_glas_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_miner_glas_ratio_CO2e_cb_to_prodvol_2018"
        ),
        "Fact_I_P_miner_fec_pct_of_ceram": replace_value(
            "Fact_I_P_miner_fec_pct_of_ceram_2017"
        ),
        "Fact_I_P_miner_ceram_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_miner_ceram_energy_use_factor_2017"
        ),
        "Fact_I_P_miner_ceram_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_miner_ceram_ratio_CO2e_pb_to_prodvol_2018"
        ),
        "Fact_I_P_miner_ceram_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_miner_ceram_ratio_CO2e_cb_to_prodvol_2018"
        ),
        # chemische Industrie Fakten
        "Fact_I_P_chem_fec_pct_of_basic": replace_value(
            "Fact_I_S_chem_basic_wo_ammonia_fec_ratio_to_chem_all_2018"
        ),
        "Fact_I_P_chem_basic_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_chem_basic_wo_ammonia_ratio_prodvol_to_fec_2018"
        ),
        "Fact_I_P_chem_basic_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_chem_basic_wo_ammonia_CO2e_pb_ratio_per_t_product_2018"
        ),
        "Fact_I_P_chem_basic_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_chem_basic_wo_ammonia_CO2e_eb_ratio_per_t_product_2018"
        ),
        "Fact_I_P_chem_fec_pct_of_ammonia": replace_value(
            "Fact_I_S_chem_ammonia_fec_ratio_to_chem_all_2018"
        ),
        "Fact_I_P_chem_ammonia_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_chem_ammonia_fec_ratio_per_t_product_2013", lambda x: div(1, x)
        ),
        "Fact_I_P_chem_ammonia_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_chem_ammonia_CO2e_pb_ratio_per_t_product_2018"
        ),
        "Fact_I_P_chem_ammonia_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_chem_ammonia_CO2e_eb_ratio_per_t_product_2018"
        ),
        "Fact_I_P_chem_fec_pct_of_other": replace_value(
            "Fact_I_S_chem_other_fec_ratio_to_chem_all_2018"
        ),
        "Fact_I_P_chem_other_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_chem_other_ratio_prodvol_to_fec_2018"
        ),
        "Fact_I_P_chem_other_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_chem_other_CO2e_pb_ratio_per_t_product_2018"
        ),
        "Fact_I_P_chem_other_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_chem_other_CO2e_eb_ratio_per_t_product_2018"
        ),
        # metallherstellende Industrie Fakten
        "Fact_I_P_metal_fec_pct_of_steel": replace_value(
            "Fact_I_P_metal_fec_pct_of_steel_2018"
        ),
        "Fact_I_P_metal_fec_pct_of_steel_primary": replace_value(
            "Fakt_I_N_metallh_Primaerroute_EEV_2018_Anteil"
        ),
        "Fact_I_P_metal_steel_primary_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_metal_steel_primary_ratio_fec_to_prodvol_2018",
            lambda x: div(1, x),
        ),
        "Fact_I_P_metal_steel_primary_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_metal_steel_primary_ratio_CO2e_pb_to_prodvol_2018"
        ),
        "Fact_I_P_metal_steel_primary_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_metal_steel_primary_ratio_CO2e_eb_to_prodvol_2018"
        ),
        "Fact_I_P_metal_fec_pct_of_steel_secondary": replace_value(
            "Fakt_I_N_metallh_Sekundaerroute_EEV_2018_Anteil"
        ),
        "Fact_I_P_metal_steel_secondary_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_metal_steel_secondary_ratio_fec_to_prodvol_2018",
            lambda x: div(1, x),
        ),
        "Fact_I_P_metal_steel_secondary_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_metal_steel_secondary_ratio_CO2e_pb_to_prodvol_2018"
        ),
        "Fact_I_P_metal_steel_secondary_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_metal_steel_secondary_ratio_CO2e_eb_to_prodvol_2018"
        ),
        "Fact_I_P_metal_fec_pct_of_nonfe": replace_value(
            "Fact_I_P_metal_fec_pct_of_nonfe_2018"
        ),
        "Fact_I_P_metal_nonfe_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_metal_nonfe_ratio_fec_to_prodvol_2018", lambda x: div(1, x)
        ),
        "Fact_I_P_metal_nonfe_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_metal_nonfe_ratio_CO2e_pb_to_prodvol_2018"
        ),
        "Fact_I_P_metal_nonfe_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_metal_nonfe_ratio_CO2e_cb_to_prodvol_2018"
        ),
        # sontige Industrie Fakten
        "Fact_I_P_other_fec_pct_of_paper": replace_value(
            "Fact_I_P_other_fec_pct_of_paper_2018"
        ),
        "Fact_I_P_other_paper_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_other_paper_ratio_fec_to_prodvol_2018", lambda x: div(1, x)
        ),
        "Fact_I_P_other_paper_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_other_paper_ratio_CO2e_pb_to_prodvol_2018"
        ),
        "Fact_I_P_other_paper_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_other_paper_ratio_CO2e_cb_to_prodvol_2018"
        ),
        "Fact_I_P_other_fec_pct_of_food": replace_value(
            "Fact_I_P_other_fec_pct_of_food_2018"
        ),
        "Fact_I_P_other_food_ratio_prodvol_to_fec": replace_value(
            "Fact_I_P_other_food_ratio_fec_to_prodvol_2018", lambda x: div(1, x)
        ),
        "Fact_I_P_other_food_ratio_CO2e_pb_to_prodvol": replace_value(
            "Fact_I_P_other_food_ratio_CO2e_pb_to_prodvol_2018"
        ),
        "Fact_I_P_other_food_ratio_CO2e_cb_to_prodvol": replace_value(
            "Fact_I_P_other_food_ratio_CO2e_cb_to_prodvol_2018"
        ),
        "Fact_I_P_other_fec_pct_of_further": replace_value(
            "Fact_I_P_other_fec_pct_of_further_2018"
        ),
        "Fact_I_P_other_further_prodvol": replace_value(
            "Fact_I_P_other_further_prodvol_2018"
        ),
        "Fact_I_P_other_further_ratio_CO2e_pb_to_fec": replace_value(
            "Fact_I_P_other_2d_ratio_CO2e_pb_to_fec_2018"
        ),
        "Fact_I_P_other_further_ratio_CO2e_cb_to_fec": replace_value(
            "Fact_I_P_other_further_ratio_CO2e_cb_to_fec_2018"
        ),
        "Fact_I_P_other_2efgh_ratio_CO2e_pb_to_fec": replace_value(
