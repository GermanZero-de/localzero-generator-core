...
class T30:
    ...
    s_epetrol: TColVars2030 = TColVars2030 ()  # Todo: in Excel ist die Bennenung "S_petrol, s_diesel ..." , ggf. umbenennen
...
def Transport2030_calc(root):
    ...
    try:
        ...
        t.transport_capacity_pkm = (
            ...
            ass ('Ass_T_D_ratio_trnsprt_ppl_to_ppl_city') if entry ('In_T_rt3') == "city" else
            ass ('Ass_T_D_ratio_trnsprt_ppl_to_ppl_smcity') if entry ('In_T_rt3') == "smcty" else
            ass ('Ass_T_D_ratio_trnsprt_ppl_to_ppl_rural') if entry ('In_T_rt3') == "rural" else
            ass ('Ass_T_D_trnsprt_ppl_nat') / entry ('In_M_population_nat')
        )
        road_car_it_ot.transport_capacity_pkm = (
            t.transport_capacity_pkm * t18.road_car_it_ot.mileage / (
                        t18.road_car_it_ot.mileage + t18.road_car_ab.mileage) *
            ass ('Ass_T_D_trnsprt_ppl_city_car1_frac_2050') + ass ('Ass_T_D_trnsprt_ppl_city_car2_frac_2050') +
            ass ('Ass_T_D_trnsprt_ppl_city_car3_frac_2050') + ass ('Ass_T_D_trnsprt_ppl_city_car4_frac_2050')
            if entry ('In_T_rt3') == "city" else
            ass ('Ass_T_D_trnsprt_ppl_smcty_car1_frac_2050') + ass ('Ass_T_D_trnsprt_ppl_smcty_car2_frac_2050') +
            ass ('Ass_T_D_trnsprt_ppl_smcty_car3_frac_2050') + ass ('Ass_T_D_trnsprt_ppl_smcty_car4_frac_2050')
            if entry ('In_T_rt3') == "smcty" else
            ass ('Ass_T_D_trnsprt_ppl_rural_car1_frac_2050') + ass ('Ass_T_D_trnsprt_ppl_rural_car2_frac_2050') +
            ass ('Ass_T_D_trnsprt_ppl_rural_car3_frac_2050') + ass ('Ass_T_D_trnsprt_ppl_rural_car4_frac_2050')
            if entry ('In_T_rt3') == "rural" else
            ass ('Ass_T_D_trnsprt_ppl_nat_car1_frac_2050') + ass ('Ass_T_D_trnsprt_ppl_nat_car2_frac_2050') +
            ass ('Ass_T_D_trnsprt_ppl_nat_car3_frac_2050') + ass ('Ass_T_D_trnsprt_ppl_nat_car4_frac_2050')
        )

        road_gds_ldt_it_ot.transport_capacity_tkm = (
                ass ('Ass_T_D_trnsprt_gds_Rd_2050') / fact ('Fact_T_D_trnsprt_gds_Rd_2018') *
                t18.road_gds_ldt_it_ot.transport_capacity_tkm
        )
        air_inter.demand_ejetfuel = (
                ass ('Ass_T_D_Air_nat_EB_2050') * entry ('In_M_population_com_203X') /
                entry ('In_M_population_nat')
        )
        road_gds_ldt_it_ot.mileage = (
                road_gds_ldt_it_ot.transport_capacity_tkm / ass ('Ass_T_D_lf_gds_LDT_2050')
        )

        air.demand_change = 0  # (SUM(BJ235:BJ236))

        road_car_it_ot.mileage = (
                road_car_it_ot.transport_capacity_pkm / ass ('Ass_T_D_lf_ppl_Car_2050')
        )
        road_car_it_ot.demand_electricity = (
                road_car_it_ot.mileage *
                ass ('Ass_T_S_Car_frac_bev_with_phev_mlg_2050') * ass ('Ass_T_S_Car_SEC_elec_it_at_2030')
        )
        air_inter.transport_capacity_tkm = (
                t18.air_inter.transport_capacity_tkm / t18.air_inter.demand_jetfuel *
                air_inter.demand_ejetfuel
        )
        air_inter.CO2e_cb = (
                air_inter.demand_ejetfuel * ass ('Ass_T_S_jetfuel_EmFa_tank_wheel_2050')
        )
        air.CO2e_cb = (
            air_inter.CO2e_cb
        ...
        road_car_ab.transport_capacity_pkm = (
            t.transport_capacity_pkm * t18.road_car_ab.mileage / (
                        t18.road_car_it_ot.mileage + t18.road_car_ab.mileage) *
            ass ('Ass_T_D_trnsprt_ppl_city_car1_frac_2050') + ass ('Ass_T_D_trnsprt_ppl_city_car2_frac_2050') +
            ass ('Ass_T_D_trnsprt_ppl_city_car3_frac_2050') + ass ('Ass_T_D_trnsprt_ppl_city_car4_frac_2050')
            if entry ('In_T_rt3') == "city" else
        ...
        road_car_ab.mileage = (
                road_car_ab.transport_capacity_pkm / ass ('Ass_T_D_lf_ppl_Car_2050')
        )
        road_car_it_ot.demand_epetrol = (
                road_car_it_ot.mileage * ass ('Ass_T_S_Car_frac_petrol_with_phev_mlg_2050') * ass (
            'Ass_T_S_Car_SEC_petrol_it_at_2050')
        )
        road_car_it_ot.CO2e_cb = (
                road_car_it_ot.demand_epetrol * ass ('Ass_T_S_petrol_EmFa_tank_wheel_2050') +
                road_car_it_ot.demand_electricity * fact ('Fact_T_S_electricity_EmFa_tank_wheel_2018')
        )
        air_inter.CO2e_total_2021_estimated = (
                t18.air_inter.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ...
        road_action_charger.base_unit = (
            road_car.base_unit /
            ass ('Ass_S_ratio_bev_car_per_charge_point_city') if entry ('In_T_rt3') == "city" else
            ass ('Ass_S_ratio_bev_car_per_charge_point_smcity_rural') if entry ('In_T_rt3') == "smcty" else
            ass ('Ass_S_ratio_bev_car_per_charge_point_smcity_rural') if entry ('In_T_rt3') == "rural" else
        ...
        road_bus_action_infra.invest_per_x = ass ('Ass_T_C_cost_per_trnsprt_ppl_bus_infrstrctr')
        road_bus.transport_capacity_pkm = (
            t.transport_capacity_pkm * t18.road_bus.transport_capacity_pkm / (
                        t18.road_bus.transport_capacity_pkm + t18.rail_ppl_.transport_capacity_pkm + t18.rail_ppl_metro.transport_capacity_pkm) *
            ass ('Ass_T_D_trnsprt_ppl_city_pt_frac_2050') if entry ('In_T_rt3') == "city" else
            ass ('Ass_T_D_trnsprt_ppl_smcty_pt_frac_2050') if entry ('In_T_rt3') == "smcty" else
            ass ('Ass_T_D_trnsprt_ppl_rural_pt_frac_2050') if entry ('In_T_rt3') == "rural" else
        ...
        road_gds_mhd_action_wire.invest_per_x = (
            ass ('Ass_T_C_cost_per_trnsprt_gds_truck_infrstrctr')
        )
        road_gds_mhd_action_wire.invest = (
                entry ('In_M_population_com_203X') * road_gds_mhd_action_wire.invest_per_x
        )

        rail_action_invest_infra.invest_per_x = ass ('Ass_T_C_cost_per_trnsprt_rail_infrstrctr')
        road_action_charger.invest_pa = (
                road_action_charger.invest / entry ('In_M_duration_target')
        )
        air.demand_ejetfuel = (
        ...
        air.energy = (
                air.demand_ejetfuel +
                air.demand_change  # SUM(AW234:air.demand_change)
        )
        air_inter.transport_capacity_pkm = (
                t18.air_inter.transport_capacity_pkm /
                t18.air_inter.demand_jetfuel * air_inter.demand_ejetfuel
        )
        ...
        road_car_ab.demand_epetrol = (
                road_car_ab.mileage * ass ('Ass_T_S_Car_frac_petrol_with_phev_mlg_2050') *
                ass ('Ass_T_S_Car_SEC_petrol_ab_2050')
        )
        air.CO2e_total = air.CO2e_cb  # (CJ234 + air.CO2e_cb)
        air.change_energy_MWh = (
                air.energy - t18.air.energy
        )
        air.change_energy_pct = (
                air.change_energy_MWh / t18.air.energy
        )
        air.change_CO2e_t = (
                air.CO2e_cb - t18.air.CO2e_cb
        )
        air.change_CO2e_pct = (
                air.change_CO2e_t / t18.air.CO2e_cb
        )
        road_ppl.CO2e_total_2021_estimated = (
                t18.road_ppl.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        road_car_ab.CO2e_cb = (
                road_car_ab.demand_epetrol * ass ('Ass_T_S_petrol_EmFa_tank_wheel_2050') +
                road_car_ab.demand_electricity * fact ('Fact_T_S_electricity_EmFa_tank_wheel_2018')
        )
        air_inter.change_km = (
                air_inter.transport_capacity_pkm - t18.air_inter.transport_capacity_pkm
        )
        road_action_charger.pct_of_wage = (
            fact ('Fact_T_D_constr_roadrail_revenue_pct_of_wage_2018')
        )
        road_action_charger.invest_com = (
                road_action_charger.invest * ass ('Ass_T_C_invest_state_charge_point_prctg')
        )
        ...
        road_action_charger.ratio_wage_to_emplo = fact ('Fact_T_D_constr_roadrail_ratio_wage_to_emplo_2018')
        t.demand_ejetfuel = (
            air.demand_ejetfuel  # + BD237 + BD253 + BD261 + BD265
        )
        air_inter.energy = (
            air_inter.demand_ejetfuel  # SUM(AW235:BJ235)
        )
        ...
        road_gds_ldt_it_ot.demand_electricity = (
                road_gds_ldt_it_ot.mileage * ass ('Ass_T_S_LDT_frac_bev_mlg_2050') *
        ...
        air_inter.change_energy_MWh = (
                air_inter.energy - t18.air_inter.energy
        )
        air_inter.change_energy_pct = (
                air_inter.change_energy_MWh / t18.air_inter.energy
        )
        air_inter.change_CO2e_t = (
                air_inter.CO2e_cb - t18.air_inter.CO2e_cb
        )
        air_inter.change_CO2e_pct = (
                air_inter.change_CO2e_t / t18.air_inter.CO2e_cb
        )
        air_dmstc.CO2e_total_2021_estimated = (
                t18.air_dmstc.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ...
        air.change_km = (
                air_dmstc.change_km + air_inter.change_km
        )

        # air_dmstc.actionKein Kurzstrecken - Flugverkehr mehr)

        rail_ppl_.transport_capacity_pkm = (
            t.transport_capacity_pkm * t18.rail_ppl_.transport_capacity_pkm /
        ...
        ship_dmstc.demand_ediesel = (
                ass ('Ass_T_D_Shp_dmstc_nat_EB_2050') * entry ('In_M_population_com_203X') / entry (
            'In_M_population_nat')
        )
        road_gds_ldt_ab.mileage = (
                road_gds_ldt_ab.transport_capacity_tkm / ass ('Ass_T_D_lf_gds_LDT_2050')
        )
        rail.demand_change = 0  # SUM(BJ256:BJ260))
        rail_action_invest_infra.invest = (
                rail_action_invest_infra.invest_per_x * entry ('In_M_population_com_203X')
        )
        road_car.CO2e_cb = (
                road_car_it_ot.CO2e_cb + road_car_ab.CO2e_cb
        )
        road_car.transport_capacity_pkm = (
                road_car_it_ot.transport_capacity_pkm + road_car_ab.transport_capacity_pkm
        )
        rail_gds.transport_capacity_tkm = (
                t18.rail_gds.transport_capacity_tkm *
                (ass ('Ass_T_D_trnsprt_gds_Rl_2050') / fact ('Fact_T_D_Rl_train_nat_trnsprt_gds_2018'))
        )
        rail_ppl_.demand_electricity = (
                rail_ppl_.transport_capacity_pkm * ass ('Ass_T_S_Rl_Train_ppl_long_elec_SEC_2050')
        )
        road_bus.mileage = (
                road_bus.transport_capacity_pkm / ass ('Ass_T_D_lf_ppl_Bus_2050')
        )
        ...
        road_bus.CO2e_cb = (
                road_bus.demand_electricity * fact ('Fact_T_S_electricity_EmFa_tank_wheel_2018')
        )
        road_ppl.CO2e_cb = (
                road_car.CO2e_cb + road_bus.CO2e_cb
        )
        rail_ppl.CO2e_total_2021_estimated = (
                t18.rail_ppl.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        rail_ppl_.CO2e_cb = (
                rail_ppl_.demand_electricity * fact ('Fact_T_S_electricity_EmFa_tank_wheel_2018')
        )
        ...
        rail_action_invest_infra.invest_pa = (
                rail_action_invest_infra.invest / entry ('In_M_duration_target')
        )
        other_cycl.invest_per_x = ass ('Ass_T_C_cost_per_trnsprt_ppl_cycle')
        rail_action_invest_infra.pct_of_wage = fact ('Fact_T_D_constr_roadrail_revenue_pct_of_wage_2018')
        ...
        road_bus_action_infra.invest_pa = road_bus_action_infra.invest / entry ('In_M_duration_target')
        road_car.invest = (
                road_car.base_unit * road_car.invest_per_x
        )
        road_bus.demand_emplo = (
                road_bus.mileage / fact ('Fact_T_S_bus_ratio_mlg_to_driver_2018')
        )
        road_ppl.demand_electricity = (
                road_car.demand_electricity + road_bus.demand_electricity
        )
        road_action_charger.invest_pa_com = (
                road_action_charger.invest_com / entry ('In_M_duration_target')
        )
        road_bus_action_infra.pct_of_wage = fact ('Fact_T_D_constr_roadrail_revenue_pct_of_wage_2018')
        ...
        other_cycl.transport_capacity_pkm = (
            t.transport_capacity_pkm *
            ass ('Ass_T_D_trnsprt_ppl_city_cycl_frac_2050') if entry ('In_T_rt3') == "city" else
            ass ('Ass_T_D_trnsprt_ppl_smcty_cycl_frac_2050') if entry ('In_T_rt3') == "smcty" else
            ass ('Ass_T_D_trnsprt_ppl_rural_cycl_frac_2050') if entry ('In_T_rt3') == "rural" else
            ass ('Ass_T_D_trnsprt_ppl_nat_cycl_frac_2050')
        )
        road_action_charger.demand_emplo_new = road_action_charger.demand_emplo
        road_bus_action_infra.ratio_wage_to_emplo = fact ('Fact_T_D_constr_roadrail_ratio_wage_to_emplo_2018')
        ...
        road_gds_ldt_it_ot.CO2e_cb = (
                road_gds_ldt_it_ot.demand_ediesel * ass ('Ass_T_S_diesel_EmFa_tank_wheel_2050') +
                road_gds_ldt_it_ot.demand_electricity * fact ('Fact_T_S_electricity_EmFa_tank_wheel_2018')
        )
        ...
        road_gds_ldt_ab.demand_hydrogen = (
                road_gds_ldt_ab.mileage *
                ass ('Ass_T_S_LDT_frac_fcev_mlg_2050') * ass ('Ass_T_S_LDT_SEC_fcev_2030')
        )
        ...
        road_gds_ldt_ab.demand_ediesel = (
                road_gds_ldt_ab.mileage *
                ass ('Ass_T_S_LDT_frac_diesel_mlg_2050') * ass ('Ass_T_S_LDT_SEC_diesel_ab_2030')
        )
        road_car_it_ot.CO2e_total = (
            road_car_it_ot.CO2e_cb
        )
        ...
        road_ppl.change_CO2e_t = (
                road_ppl.CO2e_cb - t18.road_ppl.CO2e_cb
        )
        road_ppl.change_CO2e_pct = (
                road_ppl.change_CO2e_t / t18.road_ppl.CO2e_cb
        )
        road_gds_mhd_ab.CO2e_total_2021_estimated = (
                t18.road_gds_mhd_ab.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        road_gds.CO2e_total_2021_estimated = (
                t18.road_gds.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        road_car_it_ot.change_km = (
                road_car_it_ot.transport_capacity_pkm - t18.road_car_it_ot.transport_capacity_pkm
        )
        other_cycl.invest = (
                other_cycl.transport_capacity_pkm * other_cycl.invest_per_x
        )
        g_planning.invest = (
                ass ('Ass_T_C_planer_cost_per_invest_cost') *
                (road_bus_action_infra.invest + road_gds_mhd_action_wire.invest + road_action_charger.invest +
                 rail_ppl_metro_action_infra.invest + rail_action_invest_infra.invest + other_cycl.invest)
        )
        road_gds_ldt.base_unit = (
                (road_gds_ldt_it_ot.transport_capacity_tkm + road_gds_ldt_ab.transport_capacity_tkm) /
                fact ('Fact_T_S_LDT_ratio_mlg_to_stock_2018')
        )
        road_gds_mhd_action_wire.invest_com = (
                road_gds_mhd_action_wire.invest * ass ('Ass_T_C_ratio_public_sector_100')
        )
        road_gds_mhd_action_wire.invest_pa = (
                road_gds_mhd_action_wire.invest / entry ('In_M_duration_target')
        )
        road_gds_mhd_action_wire.pct_of_wage = fact ('Fact_T_D_constr_roadrail_revenue_pct_of_wage_2018')
        road_gds_mhd_it_ot.transport_capacity_tkm = (
                ass ('Ass_T_D_trnsprt_gds_Rd_2050') / fact ('Fact_T_D_trnsprt_gds_Rd_2018') *
                t18.road_gds_mhd_it_ot.transport_capacity_tkm
        )
        road_gds_mhd_it_ot.mileage = (
                road_gds_mhd_it_ot.transport_capacity_tkm / ass ('Ass_T_D_lf_gds_MHD_2050')
        )
        ...
        road_gds_mhd_ab.mileage = (
                road_gds_mhd_ab.transport_capacity_tkm / ass ('Ass_T_D_lf_gds_MHD_2050')
        )
        road_gds_mhd.demand_emplo = (
                (road_gds_mhd_it_ot.mileage + road_gds_mhd_ab.mileage) / fact ('Fact_T_D_MHD_ratio_mlg_to_driver')
        )
        road_gds_mhd.emplo_existing = (
                (t18.road_gds_mhd_it_ot.mileage + t18.road_gds_mhd_ab.mileage) / fact (
        ...
        road_bus.emplo_existing = (
                t18.road_bus.mileage /
                road_bus.mileage * road_bus.demand_emplo
        )
        road_bus.base_unit = (
                road_bus.mileage / fact ('Fact_T_S_Bus_ratio_mlg_to_stock_2018')
        )
        ...
        road_car.mileage = (
                road_car_it_ot.mileage + road_car_ab.mileage
        )
        ...
        road_gds_ldt_ab.CO2e_cb = (
                ...
                road_gds_ldt_ab.demand_electricity * fact ('Fact_T_S_electricity_EmFa_tank_wheel_2018')
        )
        road_bus.CO2e_total = road_bus.CO2e_cb

        road_bus.energy = road_bus.demand_electricity  # (SUM(road_bus.demand_electricity:BJ243))

        road_car_ab.change_energy_MWh = (
                road_car_ab.energy - t18.road_car_ab.energy
        )
        road_car.change_CO2e_t = (
                road_car.CO2e_cb - t18.road_car.CO2e_cb
        )
        road_car.change_CO2e_pct = (
                road_car.change_CO2e_t / t18.road_car.CO2e_cb
        )
        road_car.CO2e_total_2021_estimated = (
                t18.road_car.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ...
        road_bus.demand_emplo_new = (
                road_bus.demand_emplo - road_bus.emplo_existing
        )
        g_planning.invest_pa = (
                g_planning.invest / entry ('In_M_duration_target')
        )
        road_car.invest_pa = (
                road_car.invest / entry ('In_M_duration_target')
        )
        ...
        road_gds_ldt.CO2e_cb = (
                road_gds_ldt_it_ot.CO2e_cb + road_gds_ldt_ab.CO2e_cb
        )
        road_gds_mhd_it_ot.demand_electricity = (
                road_gds_mhd_it_ot.mileage * ass ('Ass_T_S_MHD_frac_bev_mlg_2050') *
                ass ('Ass_T_S_MHD_SEC_elec_it_at_2030')
        )
        road_car_ab.CO2e_total = road_car_ab.CO2e_cb
        road_car.change_energy_pct = (
        ...
        road_car_it_ot.CO2e_total_2021_estimated = (
                t18.road_car_it_ot.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ...
        t.demand_epetrol = road.demand_epetrol  # (BB234 + road.demand_epetrol + BB253 + BB261 + BB265)
        road_car.energy = (
                road_car_it_ot.energy + road_car_ab.energy
        )
        road_ppl.mileage = (
                road_car.mileage + road_bus.mileage
        )
        g_planning.cost_wage = g_planning.invest_pa
        road_gds_mhd_it_ot.CO2e_cb = (
                road_gds_mhd_it_ot.demand_ediesel * ass ('Ass_T_S_diesel_EmFa_tank_wheel_2050') +
                road_gds_mhd_it_ot.demand_electricity * fact ('Fact_T_S_electricity_EmFa_tank_wheel_2018')
        )
        road_car.CO2e_total = (
                road_car_it_ot.CO2e_total + road_car_ab.CO2e_total
        )
        road_bus.change_energy_MWh = (
                road_bus.energy - t18.road_bus.energy
        )
        road_car_ab.change_energy_pct = (
                road_car_ab.change_energy_MWh / t18.road_car_ab.energy
        )
        road_car_ab.change_CO2e_t = (
                road_car_ab.CO2e_cb - t18.road_car_ab.CO2e_cb
        )
        road_car_ab.change_CO2e_pct = (
                road_car_ab.change_CO2e_t / t18.road_car_ab.CO2e_cb
        )
        road_car_ab.CO2e_total_2021_estimated = (
                t18.road_car_ab.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ...
        road_ppl.energy = (
                road_car.energy + road_bus.energy
        )
        road_ppl.change_energy_MWh = (
                road_car.change_energy_MWh + road_bus.change_energy_MWh
        )
        road_bus.cost_wage = (
                road_bus.ratio_wage_to_emplo * road_bus.demand_emplo_new
        )
        ...
        road_ppl.CO2e_total = (
                road_car.CO2e_total + road_bus.CO2e_total
        )
        road_ppl.change_energy_pct = (
                road_ppl.change_energy_MWh / t18.road_ppl.energy
        )
        road_bus.change_energy_pct = (
                road_bus.change_energy_MWh / t18.road_bus.energy
        )
        road_bus.change_CO2e_t = (
                road_bus.CO2e_cb - t18.road_bus.CO2e_cb
        )
        road_bus.change_CO2e_pct = (
                road_bus.change_CO2e_t / t18.road_bus.CO2e_cb
        )
        road_bus.CO2e_total_2021_estimated = (
                t18.road_bus.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ...
        road_ppl.change_km = (
                road_car.change_km + road_bus.change_km
        )
        # road_bus.actionKauf E - Busse)

        road_bus_action_infra.demand_emplo_new = (
            road_bus_action_infra.demand_emplo
        )
        road_bus_action_infra.invest_com = (
                road_bus_action_infra.invest * ass ('Ass_T_C_ratio_public_sector_100')
        )
        road_bus.invest = (
        ...
        road_bus.invest_com = (
                road_bus.invest * ass ('Ass_T_C_ratio_public_sector_100')
        )
        road_bus.invest_pa = (
                road_bus.invest / entry ('In_M_duration_target')
        )
        road_ppl.demand_emplo_new = (
                road_bus.demand_emplo_new +
                road_bus_action_infra.demand_emplo_new
        )  # (DM241:road_bus_action_infra.demand_emplo_new))
        road_bus.pct_of_wage = (
                road_bus.cost_wage / road_bus.invest_pa
        )
        ...
        road_ppl.base_unit = (
                road_car.base_unit + road_bus.base_unit
        )
        road_bus.invest_pa_com = (
                road_bus.invest_com / entry ('In_M_duration_target')
        )
        ...
        road_bus_action_infra.invest_pa_com = (
                road_bus_action_infra.invest_com / entry ('In_M_duration_target')
        )
        g_planning.demand_emplo = (
                g_planning.cost_wage / g_planning.ratio_wage_to_emplo
        )
        road_ppl.invest_pa_com = (
                road_bus.invest_pa_com + road_bus_action_infra.invest_pa_com
        )
        road_ppl.cost_wage = (
                road_bus.cost_wage + road_bus_action_infra.cost_wage
        )
        road_gds_mhd_action_wire.cost_wage = (
                road_gds_mhd_action_wire.invest_pa * road_gds_mhd_action_wire.pct_of_wage
        )
        rail_action_invest_infra.ratio_wage_to_emplo = fact ('Fact_T_D_constr_roadrail_ratio_wage_to_emplo_2018')
        ...
        road_gds_ldt.mileage = (
                road_gds_ldt_it_ot.mileage + road_gds_ldt_ab.mileage
        )
        road_gds_ldt.transport_capacity_tkm = (
                road_gds_ldt_it_ot.transport_capacity_tkm + road_gds_ldt_ab.transport_capacity_tkm
        )
        rail_gds.demand_electricity = (
                rail_gds.transport_capacity_tkm * ass ('Ass_T_S_Rl_Train_gds_elec_SEC_2050')
        )
        ...
        road_gds_mhd_ab.CO2e_cb = (
                road_gds_mhd_ab.demand_ediesel * ass ('Ass_T_S_diesel_EmFa_tank_wheel_2050') +
                road_gds_mhd_ab.demand_electricity * fact ('Fact_T_S_electricity_EmFa_tank_wheel_2018')
        )
        road_gds_mhd.CO2e_cb = (
                road_gds_mhd_it_ot.CO2e_cb +
                road_gds_mhd_ab.CO2e_cb
        )
        road_gds_ldt_it_ot.change_km = (
                road_gds_ldt_it_ot.transport_capacity_tkm - t18.road_gds_ldt_it_ot.transport_capacity_tkm
        )
        ...
        road_gds.CO2e_cb = (
                road_gds_ldt.CO2e_cb + road_gds_mhd.CO2e_cb
        )
        road_gds.invest_com = (
            road_gds_mhd_action_wire.invest_com
        )
        ...
        road_gds_mhd_action_wire.ratio_wage_to_emplo = fact ('Fact_T_D_constr_roadrail_ratio_wage_to_emplo_2018')
        ...
        road_gds_mhd.base_unit = (
                (road_gds_mhd_it_ot.transport_capacity_tkm + road_gds_mhd_ab.transport_capacity_tkm) /
        ...
        road_gds.base_unit = (
                road_gds_ldt.base_unit + road_gds_mhd.base_unit
        )
        road_gds_mhd.transport_capacity_tkm = (
                road_gds_mhd_it_ot.transport_capacity_tkm + road_gds_mhd_ab.transport_capacity_tkm
        )
        road_gds.change_CO2e_t = (
                road_gds.CO2e_cb - t18.road_gds.CO2e_cb
        )
        ...
        road_gds_mhd_it_ot.change_km = (
                road_gds_mhd_it_ot.transport_capacity_tkm - t18.road_gds_mhd_it_ot.transport_capacity_tkm
        )
        road_gds_ldt_ab.change_km = (
                road_gds_ldt_ab.transport_capacity_tkm - t18.road_gds_ldt_ab.transport_capacity_tkm
        )
        road_gds_mhd.invest = (
                road_gds_mhd.base_unit * road_gds_mhd.invest_per_x
        )
        road_gds_ldt.invest = (
                road_gds_ldt.base_unit * road_gds_ldt.invest_per_x
        )
        road_gds.invest = (
                road_gds_ldt.invest + road_gds_mhd.invest
        )
        road_gds_ldt.invest_pa = (
                road_gds_ldt.invest / entry ('In_M_duration_target')
        )
        ...
        road_gds.change_CO2e_pct = (
                road_gds.change_CO2e_t / t18.road_gds.CO2e_cb
        )

        road.CO2e_cb = (
                road_ppl.CO2e_cb + road_gds.CO2e_cb
        )
        ...
        road.change_energy_MWh = (
                road.energy - t18.road.energy
        )
        road.change_CO2e_t = (
                road.CO2e_cb - t18.road.CO2e_cb
        )

        road_gds_ldt.energy = (
                road_gds_ldt_it_ot.energy + road_gds_ldt_ab.energy
        )
        road_gds_mhd.mileage = (
        ...
        road.change_CO2e_pct = (
                road.change_CO2e_t / t18.road.CO2e_cb
        )
        ...
        road_gds_ldt_ab.CO2e_total_2021_estimated = (
                t18.road_gds_ldt_ab.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ...
        rail_ppl_metro.mileage = (
                rail_ppl_metro.transport_capacity_pkm / ass ('Ass_T_D_lf_Rl_Metro_2050'))

        road_gds_mhd_ab.change_energy_MWh = (
                road_gds_mhd_ab.energy - t18.road_gds_mhd_ab.energy
        )
        road_gds.mileage = (
                road_gds_ldt.mileage + road_gds_mhd.mileage
        )
        road.transport_capacity_tkm = road_gds.transport_capacity_tkm
        rail_ppl_metro.demand_electricity = (
                rail_ppl_metro.mileage * ass ('Ass_T_S_Rl_Metro_SEC_fzkm_2050')
        )
        ...
        road_gds_mhd_ab.change_km = (
                road_gds_mhd_ab.transport_capacity_tkm - t18.road_gds_mhd_ab.transport_capacity_tkm
        )
        road_gds_mhd.change_km = (
                road_gds_mhd_it_ot.change_km + road_gds_mhd_ab.change_km
        )
        road_gds_mhd.invest_pa = (
                road_gds_mhd.invest / entry ('In_M_duration_target')
        )
        road_gds.invest_pa = (
                road_gds_mhd_action_wire.invest_pa +
                road_gds_ldt.invest_pa +
        ...
        road.invest = (
                road_action_charger.invest + road_ppl.invest + road_gds.invest
        )
        road.change_energy_pct = (
                road.change_energy_MWh / t18.road.energy
        )
        road_gds_mhd.energy = (
                road_gds_mhd_it_ot.energy + road_gds_mhd_ab.energy
        )
        ...
        road_gds_mhd.CO2e_total = (
                road_gds_mhd_it_ot.CO2e_total +
                road_gds_mhd_ab.CO2e_total
        )
        ...
        road_gds.change_km = (
                road_gds_ldt.change_km + road_gds_mhd.change_km
        )
        ...
        road_gds.energy = (
                road_gds_ldt.energy + road_gds_mhd.energy
        )
        road.mileage = (
                road_ppl.mileage + road_gds.mileage
        )
        road.demand_emplo = (
                road_action_charger.demand_emplo +
                road_ppl.demand_emplo +
        ...
        rail_ppl_metro.CO2e_cb = (
                rail_ppl_metro.demand_electricity * fact ('Fact_T_S_electricity_EmFa_tank_wheel_2018')
        )
        road_gds.CO2e_total = (
                road_gds_ldt.CO2e_total + road_gds_mhd.CO2e_total
        )
        road_gds.change_energy_pct = (
                road_gds.change_energy_MWh / t18.road_gds.energy
        )
        ...
        rail_ppl_.mileage = (
                rail_ppl_.transport_capacity_pkm / fact ('Fact_T_D_rail_ppl_ratio_pkm_to_fzkm_2018')
        )
        rail_ppl.CO2e_cb = (
                rail_ppl_.CO2e_cb + rail_ppl_metro.CO2e_cb
        )
        ship_dmstc.transport_capacity_tkm = (
                ass ('Ass_T_D_trnsprt_gds_ship_2050') * entry ('In_M_population_com_203X') / entry (
            'In_M_population_nat')
        )
        ship_dmstc.CO2e_cb = (
                ship_dmstc.demand_ediesel * ass ('Ass_T_S_diesel_EmFa_tank_wheel_2050')
        )
        rail_gds.CO2e_cb = (
                rail_gds.demand_electricity * fact ('Fact_T_S_electricity_EmFa_tank_wheel_2018')
        )
        rail.energy = (
                rail.demand_electricity +
                rail.demand_change
        ...
        rail.change_energy_MWh = (
                rail.energy - t18.rail.energy
        )
        rail.CO2e_cb = (
                rail_ppl.CO2e_cb + rail_gds.CO2e_cb
        )
        rail.change_CO2e_t = (
                rail.CO2e_cb - t18.rail.CO2e_cb
        )
        ship_dmstc.CO2e_total_2021_estimated = (
                t18.ship_dmstc.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ...
        ship_dmstc.ratio_wage_to_emplo = (
            ass ('Ass_T_D_shp_wage_driver')
        )
        ship_dmstc.demand_emplo = (
                ship_dmstc.transport_capacity_tkm / fact ('Fact_T_D_shp_ratio_mlg_to_driver')
        )
        ship_dmstc.emplo_existing = (
                t18.ship_dmstc.transport_capacity_tkm / fact ('Fact_T_D_shp_ratio_mlg_to_driver')
        )
        rail_ppl_.base_unit = (
                (rail_ppl_.mileage - t18.rail_ppl_.mileage) / fact ('Fact_T_D_rail_ppl_ratio_mlg_to_vehicle')
        )
        ...
        rail_ppl_.demand_emplo = (
                rail_ppl_.mileage / fact ('Fact_T_D_rail_ratio_mlg_to_driver')
        )
        ...
        rail_action_invest_infra.invest_com = (
                rail_action_invest_infra.invest * ass ('Ass_T_C_ratio_public_sector_100')
        )
        ...
        rail_action_invest_station.invest_per_x = (
            ass ('Ass_T_C_cost_per_trnsprt_rail_train station')
        )
        ...
        rail_action_invest_station.ratio_wage_to_emplo = (
            fact ('Fact_T_D_constr_roadrail_ratio_wage_to_emplo_2018')
        )
        rail_action_invest_station.demand_emplo = (
                rail_action_invest_station.cost_wage / rail_action_invest_station.ratio_wage_to_emplo
        )
        rail_action_invest_station.demand_emplo_new = (
            rail_action_invest_station.demand_emplo
        )
        rail_ppl_.emplo_existing = (
                t18.rail_ppl_.mileage / fact ('Fact_T_D_rail_ratio_mlg_to_driver')
        )
        rail_ppl_.demand_emplo_new = (
                rail_ppl_.demand_emplo - rail_ppl_.emplo_existing
        )
        ...
        rail.change_CO2e_pct = (
                rail.change_CO2e_t / t18.rail.CO2e_cb
        )
        rail_ppl_.energy = (
            rail_ppl_.demand_electricity
        )
        rail_gds.mileage = (
                rail_gds.transport_capacity_tkm / fact ('Fact_T_D_rail_gds_ratio_tkm_to_fzkm_2018')
        )
        ...
        ship_inter.demand_ediesel = (
                ass ('Ass_T_D_Shp_sea_nat_EB_2050') * entry ('In_M_population_com_203X') / entry ('In_M_population_nat')
        )
        rail_ppl_.CO2e_total = (
            rail_ppl_.CO2e_cb
        )
        rail_ppl_.change_energy_MWh = (
                rail_ppl_.energy - t18.rail_ppl_.energy
        )
        rail_ppl_metro.energy = (
            rail_ppl_metro.demand_electricity
        )
        rail_ppl.change_CO2e_t = (
                rail_ppl.CO2e_cb - t18.rail_ppl.CO2e_cb
        )
        rail_ppl.change_CO2e_pct = (
                rail_ppl.change_CO2e_t / t18.rail_ppl.CO2e_cb
        )
        rail_gds.CO2e_total_2021_estimated = (
                t18.rail_gds.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ...
        rail_gds.ratio_wage_to_emplo = (
            ass ('Ass_T_D_rail_wage_driver')
        )
        rail_ppl_metro_action_infra.invest_pa_com = (
                rail_ppl_metro_action_infra.invest_com / entry ('In_M_duration_target')
        )
        rail_ppl_.cost_wage = (
                rail_ppl_.ratio_wage_to_emplo * rail_ppl_.demand_emplo_new
        )
        rail_ppl.invest_com = (
            rail_ppl_metro_action_infra.invest_com
        )
        ...
        rail_gds.demand_emplo = (
                rail_gds.mileage / fact ('Fact_T_D_rail_ratio_mlg_to_driver')
        )
        rail_ppl_.invest_per_x = (
            fact ('Fact_T_D_rail_ppl_vehicle_invest')
        )
        rail_gds.emplo_existing = (
                t18.rail_gds.mileage / fact ('Fact_T_D_rail_ratio_mlg_to_driver')
        )
        rail_gds.change_km = (
                rail_gds.transport_capacity_tkm - t18.rail_gds.transport_capacity_tkm
        )
        rail.change_energy_pct = (
                rail.change_energy_MWh / t18.rail.energy
        )
        rail_ppl_metro.change_energy_MWh = (
                rail_ppl_metro.energy - t18.rail_ppl_metro.energy
        )
        rail_ppl.mileage = (
                rail_ppl_.mileage + rail_ppl_metro.mileage
        )
        rail.CO2e_total = (
            rail.CO2e_cb
        )
        ship_inter.CO2e_cb = (
                ship_inter.demand_ediesel * ass ('Ass_T_S_diesel_EmFa_tank_wheel_2050')
        )
        rail_ppl_metro.CO2e_total = (
            rail_ppl_metro.CO2e_cb
        )
        rail_ppl.change_energy_MWh = (
                rail_ppl_.change_energy_MWh + rail_ppl_metro.change_energy_MWh
        )
        rail_ppl_.change_energy_pct = (
                rail_ppl_.change_energy_MWh / t18.rail_ppl_.energy
        )
        rail_ppl_.change_CO2e_t = (
                rail_ppl_.CO2e_cb - t18.rail_ppl_.CO2e_cb
        )
        rail_ppl_.change_CO2e_pct = (
                rail_ppl_.change_CO2e_t / t18.rail_ppl_.CO2e_cb
        )
        rail_ppl_.CO2e_total_2021_estimated = (
                t18.rail_ppl_.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        rail_ppl_.cost_climate_saved = (
                (rail_ppl_.CO2e_total_2021_estimated - rail_ppl_.CO2e_cb) * entry ('In_M_duration_neutral') * fact (
            'Fact_M_cost_per_CO2e_2020')
        )
        rail_ppl_metro.change_km = (
                rail_ppl_metro.transport_capacity_pkm - t18.rail_ppl_metro.transport_capacity_pkm
        )
        ...
        rail_gds.demand_emplo_new = (
                rail_gds.demand_emplo - rail_gds.emplo_existing
        )
        rail_ppl_.invest = (
                rail_ppl_.base_unit * rail_ppl_.invest_per_x + rail_ppl_.cost_wage * entry ('In_M_duration_target')
        )
        rail_ppl_.invest_pa = (
                rail_ppl_.invest / entry ('In_M_duration_target')
        )
        rail_ppl_metro.invest_per_x = (
            fact ('Fact_T_D_rail_metro_vehicle_invest')
        )
        rail_ppl_metro.ratio_wage_to_emplo = (
            ass ('Ass_T_D_bus_metro_wage_driver')
        )
        rail_ppl_metro.demand_emplo = (
                rail_ppl_metro.mileage / fact ('Fact_T_D_metro_ratio_mlg_to_driver')
        )
        rail_ppl_metro.emplo_existing = (
                t18.rail_ppl_metro.mileage / fact ('Fact_T_D_metro_ratio_mlg_to_driver')
        )
        ...
        rail_ppl_metro.invest = (
                rail_ppl_metro.base_unit * rail_ppl_metro.invest_per_x + rail_ppl_metro.cost_wage * entry (
        ...
        rail_ppl_metro_action_infra.demand_emplo = (
                rail_ppl_metro_action_infra.cost_wage / rail_ppl_metro_action_infra.ratio_wage_to_emplo
        )
        rail_gds.base_unit = (
                rail_gds.change_km / fact ('Fact_T_D_rail_gds_ratio_mlg_to_vehicle')
        )
        rail_ppl_.pct_of_wage = (
                rail_ppl_.cost_wage / rail_ppl_.invest_pa
        )
        t.demand_change = (
                air.demand_change + road.demand_change + rail.demand_change +
                ship.demand_change + other.demand_change
        )
        rail_ppl.energy = (
                rail_ppl_.energy + rail_ppl_metro.energy
        )
        t.demand_electricity = (
                road.demand_electricity + rail.demand_electricity
        )
        ...
        rail_ppl.CO2e_total = (
                rail_ppl_.CO2e_total + rail_ppl_metro.CO2e_total
        )
        rail_ppl.change_energy_pct = (
                rail_ppl.change_energy_MWh / t18.rail_ppl.energy
        )
        ...
        rail_ppl_metro.CO2e_total_2021_estimated = (
                t18.rail_ppl_metro.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ...
        rail_ppl.change_km = (
                rail_ppl_.change_km + rail_ppl_metro.change_km
        )
        ...
        rail_ppl_metro.invest_pa = (
                rail_ppl_metro.invest / entry ('In_M_duration_target')
        )
        ...
        rail_gds.cost_wage = (
                rail_gds.ratio_wage_to_emplo * rail_gds.demand_emplo_new
        )
        ...
        t.demand_ediesel = (
                road.demand_ediesel + ship.demand_ediesel
        )
        ...
        rail.mileage = (
                rail_ppl.mileage + rail_gds.mileage
        )
        rail.transport_capacity_tkm = (
            rail_gds.transport_capacity_tkm
        )
        ship.CO2e_cb = (
                ship_dmstc.CO2e_cb + ship_inter.CO2e_cb
        )
        rail_gds.CO2e_total = (
            rail_gds.CO2e_cb
        )
        rail_gds.change_energy_MWh = (
                rail_gds.energy - t18.rail_gds.energy
        )
        rail_gds.change_energy_pct = (
                rail_gds.change_energy_MWh / t18.rail_gds.energy
        )
        rail_gds.change_CO2e_t = (
                rail_gds.CO2e_cb - t18.rail_gds.CO2e_cb
        )
        rail_gds.change_CO2e_pct = (
            (rail_gds.change_CO2e_t / t18.rail_gds.CO2e_cb)
        )
        ...
        rail.base_unit = (
                rail_ppl.base_unit + rail_gds.base_unit
        )
        #  rail_gds.actionInvestitionen in zusätzliche Eisenbahnen und Personal

        rail_gds.invest_per_x = (
            fact ('Fact_T_D_rail_gds_vehicle_invest')
        )
        rail_gds.invest = (
                rail_gds.base_unit * rail_gds.invest_per_x + rail_gds.cost_wage * entry ('In_M_duration_target')
        )
        rail_gds.invest_pa = (
                rail_gds.invest / entry ('In_M_duration_target')
        )
        rail_gds.pct_of_wage = (
                rail_gds.cost_wage / rail_gds.invest_pa
        )
        rail.invest_pa = (
            rail_action_invest_infra.invest_pa +
            rail_action_invest_station.invest_pa +
        ...
        rail.demand_emplo = (
                rail_action_invest_infra.demand_emplo + rail_action_invest_station.demand_emplo + rail_ppl.demand_emplo + rail_gds.demand_emplo
        )
        rail.cost_wage = (
                rail_action_invest_infra.cost_wage +
                rail_action_invest_station.cost_wage +
        ...
        t.CO2e_cb = (
                air.CO2e_cb + road.CO2e_cb + rail.CO2e_cb + ship.CO2e_cb
        )
        t.change_energy_MWh = (
                t.energy - t18.t.energy
        )
        ship.energy = (
                ship.demand_ediesel +
                ship.demand_change
        ...
        ship.change_energy_MWh = (
                ship.energy - t18.ship.energy
        )
        ship.change_energy_pct = (
                ship.change_energy_MWh / t18.ship.energy
        )
        ship.change_CO2e_t = (
                ship.CO2e_cb - t18.ship.CO2e_cb
        )
        ship.change_CO2e_pct = (
            (ship.change_CO2e_t / t18.ship.CO2e_cb)
        )
        other_foot.CO2e_total_2021_estimated = (
                t18.other_foot.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        other_foot.cost_climate_saved = (
                (other_foot.CO2e_total_2021_estimated) * entry ('In_M_duration_neutral') * fact (
            'Fact_M_cost_per_CO2e_2020')
        )
        other_foot.invest_per_x = (
            ass ('Ass_T_D_invest_pedestrians')
        )
        other_foot.invest_pa = (
                other_foot.invest_per_x * entry ('In_M_population_com_203X')
        )
        other_foot.invest = (
                other_foot.invest_pa * entry ('In_M_duration_target')
        )
        other_foot.invest_com = (
            other_foot.invest
        )
        other_foot.pct_of_wage = (
            fact ('Fact_T_D_constr_roadrail_revenue_pct_of_wage_2018')
        )
        other_foot.cost_wage = (
                other_foot.invest_pa * other_foot.pct_of_wage
        )
        ship_dmstc_dmstc_infra.invest_pa = (
                ship_dmstc_dmstc_infra.invest / entry ('In_M_duration_target')
        )
        other_foot.ratio_wage_to_emplo = (
            fact ('Fact_T_D_constr_roadrail_ratio_wage_to_emplo_2018')
        )
        ...
        t.transport_capacity_tkm = (
                air.transport_capacity_tkm + road.transport_capacity_tkm +
                rail.transport_capacity_tkm + ship.transport_capacity_tkm
        )
        t.change_CO2e_t = (
                t.CO2e_cb - t18.t.CO2e_cb
        )
        ship_dmstc.CO2e_total = (
            ship_dmstc.CO2e_cb
        )
        ship_dmstc.change_energy_MWh = (
                ship_dmstc.energy - t18.ship_dmstc.energy
        )
        ship_dmstc.change_energy_pct = (
                ship_dmstc.change_energy_MWh / t18.ship_dmstc.energy
        )
        ship_dmstc.change_CO2e_t = (
                ship_dmstc.CO2e_cb - t18.ship_dmstc.CO2e_cb
        )
        ship_dmstc.change_CO2e_pct = (
            (ship_dmstc.change_CO2e_t / t18.ship_dmstc.CO2e_cb)
        )
        ship_inter.CO2e_total_2021_estimated = (
                t18.ship_inter.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ship_inter.cost_climate_saved = (
                (ship_inter.CO2e_total_2021_estimated - ship_inter.CO2e_cb) * entry ('In_M_duration_neutral') * fact (
            'Fact_M_cost_per_CO2e_2020')
        )
        ship_dmstc.base_unit = (
                ship_dmstc.change_km / fact ('Fact_T_D_Shp_dmstc_nat_ratio_mlg_to_vehicle')
        )
        # ship_dmstc.actionKauf Schiffe

        ship_dmstc.invest_per_x = (
            fact ('Fact_T_D_Shp_dmstc_vehicle_invest')
        )
        ship_dmstc.cost_wage = (
                ship_dmstc.ratio_wage_to_emplo * ship_dmstc.demand_emplo_new
        )
        ship_dmstc.invest = (
                ship_dmstc.base_unit * ship_dmstc.invest_per_x + ship_dmstc.cost_wage * entry ('In_M_duration_target')
        )
        ship_dmstc_dmstc_infra.pct_of_wage = (
            fact ('Fact_T_D_constr_roadrail_revenue_pct_of_wage_2018')
        )
        ship_dmstc.invest_pa = (
                ship_dmstc.invest / entry ('In_M_duration_target')
        )
        ...
        ship_dmstc.pct_of_wage = (
                ship_dmstc.cost_wage / ship_dmstc.invest_pa
        )
        ...
        ship_dmstc_dmstc_infra.demand_emplo = (
                ship_dmstc_dmstc_infra.cost_wage / ship_dmstc_dmstc_infra.ratio_wage_to_emplo
        )
        ship.invest_pa_com = (
            ship_dmstc_dmstc_infra.invest_pa_com
        )  # SUM(ship_dmstc_dmstc_infra.invest_pa_com:DB264)
        ship_dmstc_dmstc_infra.demand_emplo_new = (
            ship_dmstc_dmstc_infra.demand_emplo
        )
        ship.cost_wage = (
                ship_dmstc.cost_wage + ship_dmstc_dmstc_infra.cost_wage
        )
        ...
        other_foot.demand_emplo = (
                other_foot.cost_wage / other_foot.ratio_wage_to_emplo
        )
        ...
        t.change_CO2e_pct = (
                t.change_CO2e_t / t18.t.CO2e_cb
        )
        ship_inter.CO2e_total = (
            ship_inter.CO2e_cb
        )
        ...
        ship_inter.change_CO2e_t = (
                ship_inter.CO2e_cb - t18.ship_inter.CO2e_cb
        )
        ship_inter.change_CO2e_pct = (
            (ship_inter.change_CO2e_t / t18.ship_inter.CO2e_cb)
        )
        ...
        t.change_energy_pct = (
                t.change_energy_MWh / t18.t.energy
        )
        other_foot.transport_capacity_pkm = (
            t.transport_capacity_pkm *
            ass ('Ass_T_D_trnsprt_ppl_city_foot_frac_2050') if entry ('In_T_rt3') == "city" else
            ass ('Ass_T_D_trnsprt_ppl_smcty_foot_frac_2050') if entry ('In_T_rt3') == "smcty" else
            ass ('Ass_T_D_trnsprt_ppl_rural_foot_frac_2050') if entry ('In_T_rt3') == "rural" else
            ass ('Ass_T_D_trnsprt_ppl_nat_foot_frac_2050')
        )
        other.CO2e_total = 0  # CJ265 + CM265(

        other_cycl.CO2e_total_2021_estimated = (
                t18.other_cycl.CO2e_cb * fact ('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        other_cycl.cost_climate_saved = (
                (other_cycl.CO2e_total_2021_estimated) * entry ('In_M_duration_neutral') * fact (
            'Fact_M_cost_per_CO2e_2020')
        )
        ...
        other_cycl_action_infra.base_unit = (
                other_cycl.transport_capacity_pkm * ass ('Ass_T_D_cycl_ratio_cargo_to_bikes') / ass (
            'Ass_T_D_cycl_cargo_mlg')
        )
        other_foot.invest_pa_com = (
            other_foot.invest_pa
        )
        other_cycl_action_infra.invest_per_x = (
            fact ('Fact_T_D_cycl_vehicle_invest_hannah')
        )
        other_cycl.invest_com = (
                other_cycl.invest * ass ('Ass_T_C_ratio_public_sector_100')
        )
        ...
        other_cycl.invest_pa = (
                other_cycl.invest / entry ('In_M_duration_target')
        )
        other_cycl.pct_of_wage = (
            fact ('Fact_T_D_constr_roadrail_revenue_pct_of_wage_2018')
        )
        other_foot.demand_emplo_new = (
            other_foot.demand_emplo
        )
        g_planning.demand_emplo_new = (
            g_planning.demand_emplo
        )
        ...
        other_cycl.invest_pa_com = (
                other_cycl.invest_com / entry ('In_M_duration_target')
        )
        other.invest_pa_com = (
                other_foot.invest_pa_com +
                other_cycl.invest_pa_com
        ...
        other_cycl.cost_wage = (
                other_cycl.invest_pa * other_cycl.pct_of_wage
        )
        other_cycl.ratio_wage_to_emplo = (
            fact ('Fact_T_D_constr_roadrail_ratio_wage_to_emplo_2018')
        )
        other_cycl.demand_emplo = (
                other_cycl.cost_wage / other_cycl.ratio_wage_to_emplo
        )
        other_cycl.demand_emplo_new = (
            other_cycl.demand_emplo
        )
        ...
        other.change_km = (
                other_foot.change_km + other_cycl.change_km
        )
        ...
        other.cost_wage = (
                other_foot.cost_wage + other_cycl.cost_wage
        )
        t.cost_wage = (
                g.cost_wage + road.cost_wage + rail.cost_wage + ship.cost_wage + other.cost_wage
        )
        other.demand_emplo = (
                other_foot.demand_emplo + other_cycl.demand_emplo
        )
        t.demand_emplo = (
                g.demand_emplo +
                air.demand_emplo +
        ...
        other_cycl_action_infra.invest_pa = (
                other_cycl_action_infra.invest / entry ('In_M_duration_target')
        )
        other.invest_pa = (
                other_foot.invest_pa +
                other_cycl_action_infra.invest_pa
