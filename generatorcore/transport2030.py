...
class RoadCar(Road):
    ...
    def calc(cls, inputs: Inputs, *, t18: T18, it_ot: Road, ab: Road) -> "RoadCar":
        ...
        base_unit = sum.transport_capacity_pkm / fact(
    ...
    @staticmethod
    def calc_action_charger(
        inputs: Inputs, car_base_unit: float
...
class RoadGoods(Road):
    ...
    def calc(
        ...
        *,
        ...
        road_gds.change_energy_pct = div(
            road_gds.change_energy_MWh, t18.road_gds.energy
        )
        road_gds.demand_epetrol = 0
        road_gds.transport_capacity_pkm = 0
