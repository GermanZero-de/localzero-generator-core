...
class Road(Transport):
    ...
    def calc_goods_lightduty_it_ot(cls, inputs: Inputs, *, t18: T18) -> "Road":
        ...
        res.calc_and_set_changes(t18.road_gds_ldt_it_ot)
        return res
    ...
    def calc_goods_lightduty_ab(cls, inputs: Inputs, *, t18: T18) -> "Road":
        ...
        res.calc_and_set_changes(t18.road_gds_ldt_ab)
        return res
    ...
    def calc_goods_medium_and_heavy_duty_ab(cls, inputs: Inputs, *, t18: T18) -> "Road":
        ...
        res.calc_and_set_changes(t18.road_gds_mhd_ab)
        return res
    ...
    def calc_goods_medium_and_heavy_duty_it_ot(
        ...
        res.calc_and_set_changes(t18.road_gds_mhd_it_ot)
        return res
    ...
    def calc_car_it_ot(
        ...
        res.calc_and_set_changes(t18.road_car_it_ot)
        return res
    ...
    def calc_car_ab(
        ...
        res.calc_and_set_changes(t18.road_car_ab)
        return res
...
class RoadCar(Road, TransportInvestments):
    ...
    def calc(cls, inputs: Inputs, *, t18: T18, it_ot: Road, ab: Road) -> "RoadCar":
        sum = Transport.sum(it_ot, ab, transport2018=t18.road_car)
        return cls(
...
class RoadPeople(Road):
    ...
    def calc(
        ...
        *,
        ...
        sum = Transport.sum(car, bus, transport2018=t18.road_ppl)
...
class RoadGoodsMediumAndHeavyDuty(Road):
    ...
    def calc(
        ...
        sum = Transport.sum(it_ot, ab, transport2018=t18.road_gds_mhd)
        mileage = it_ot.mileage + ab.mileage
...
class RoadGoodsLightDuty(Road):
    ...
    def calc(
        ...
        *,
        ...
        sum = Transport.sum(ab, it_ot, transport2018=t18.road_gds_ldt)
...
class RoadGoods(Road):
    ...
    def calc(
        ...
        *,
        ...
        sum = Transport.sum(ldt, mhd, transport2018=t18.road_gds)
...
class RoadSum(Road):
    ...
    def calc(
        ...
        *,
        ...
        sum = Transport.sum(goods, people, transport2018=t18.road)
        demand_emplo_new = (
