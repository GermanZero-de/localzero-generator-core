                            ...
                            if type(expr) == str:
                                ...
                                for item in elist:
                                    if item in excel_calc:
                                        ...
                                        expr = expr.replace(item, cl + rdict[var[0]] + '.' + cdict[var[1]])
                                    else:
                                        item = item.strip()
                                        m = re.match('[\w]+![\w]+', item)
                                        if m:
                                            ...
                                            if item in name_coords:
                                                replace_item = self.__mk_fake_call(name_coords[item])
                                ...
                                if print_cell:
                                    ...
                                    print(cell + '\t' + rdict[i] + '.' + cdict[j] + expr + ')', file=out)
                                else:
                                    print('\t' + rdict[i] + '.' + cdict[j] + expr + ')', file=out)
