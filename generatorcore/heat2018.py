...
def Heat2018_calc(root):
    ...
    #Demand Heat 2018 in total: 
        ...
        #1
        d.energy = (
            d_r.energy + d_b.energy + d_i.energy + d_t.energy + a_t.energy
    ...
    #Production gas: 
        ...
        p_gas.CO2e_pb = (
                p_gas.energy*p_gas.CO2e_pb_per_MWh
        )
        ...
        p_gas.CO2e_cb = (
                p_gas.energy*p_gas.CO2e_cb_per_MWh
        )               

        #7 total CO2e
        p_gas.CO2e_total = (
                p_gas.CO2e_pb+p_gas.CO2e_cb
        )  
    ...
    #Production lpg: 
        ...
        #6 combustion-based CO2e 
        p_lpg.CO2e_cb = (
                p_lpg.energy*p_lpg.CO2e_cb_per_MWh
        )               
    ...
    #Production fueloil: 
        ...
        #6 combustion-based CO2e 
        p_fueloil.CO2e_cb = (
                p_fueloil.energy*p_fueloil.CO2e_cb_per_MWh
        )               
    ...
    #Production other petrol products (opetpro): 
        ...
        #4 process-based CO2e 
        p_opetpro.CO2e_pb = (
                p_opetpro.energy*p_opetpro.CO2e_pb_per_MWh
        )
        ...
        #6 combustion-based CO2e 
        p_opetpro.CO2e_cb = (
                p_opetpro.energy*p_opetpro.CO2e_cb_per_MWh
        )               

        #7 total CO2e
        p_opetpro.CO2e_total = (
                p_opetpro.CO2e_pb+p_opetpro.CO2e_cb
        )  
    ...
    #Production coal: 
        ...
        #5 combustion-based CO2e factor per MWh final energy
        p_coal.CO2e_cb_per_MWh = (
                fact('Fact_H_P_coal_ratio_CO2e_cb_to_fec_2018')
        )         
        #6 combustion-based CO2e 
        p_coal.CO2e_cb = (
                p_coal.energy*p_coal.CO2e_cb_per_MWh
        )               

        #7 total CO2e
        p_coal.CO2e_total = (
                p_coal.CO2e_pb+p_coal.CO2e_cb
        )  
    ...
    #Production cogenerated heatnet: 
        ...
        else: p_heatnet_cogen.energy = p_heatnet.energy
        ...
        p_heatnet_cogen.CO2e_cb_per_MWh = (
                fact('Fact_H_P_heatnet_cogen_ratio_CO2e_cb_to_fec_2018')
        )         
        #6 combustion-based CO2e 
    ...
    #Production heatnet in plants: 
        ...
        p_heatnet_plant.pct_energy = (
            p_heatnet_plant.energy/p_heatnet.energy
        )

        #4 no process-based CO2e

        #5 combustion-based CO2e factor per MWh final energy
        p_heatnet_plant.CO2e_cb_per_MWh = (
    ...
    ## back to total heatnet ##
        ...
        #6 combustion-based CO2e 
        p_heatnet.CO2e_cb = (
                p_heatnet_cogen.CO2e_cb + p_heatnet_plant.CO2e_cb
        )               
        ...
        p_heatnet_geoth.energy = (
                p_heatnet_geoth.pct_energy * p_heatnet.energy
        )

        p_heatnet_geoth.CO2e_cb = 0
        p_heatnet_geoth.CO2e_pb = 0
        p_heatnet_geoth.CO2e_total = (
                p_heatnet_geoth.CO2e_pb + p_heatnet_geoth.CO2e_cb
        )
        ...
        p_heatnet_lheatpump.energy = (
                p_heatnet_lheatpump.pct_energy * p_heatnet.energy
        )
    ...
    #Production biomass: 
        ...
        #4 process-based CO2e 
        p_biomass.CO2e_pb = (
                p_biomass.energy*p_biomass.CO2e_pb_per_MWh
        )
    ...
    #Production ofossil: 
        ...
        #4 process-based CO2e 
        p_ofossil.CO2e_pb = (
                p_ofossil.energy*p_ofossil.CO2e_pb_per_MWh
        )
    ...
    #Production solarthermal energy within other renewables: 
        ...
        p_solarth.pct_energy = (
            fact('Fact_R_S_ratio_solarth_to_orenew_2018')
        )

        #1 final energy consumption
        p_solarth.energy = (
            p_orenew.energy * p_solarth.pct_energy
        ...
        #4 process-based CO2e 
        p_solarth.CO2e_pb = (
                p_solarth.energy * p_solarth.CO2e_pb_per_MWh
        )

        #6 no combustion-based CO2e       

        #7 total CO2e
        p_solarth.CO2e_total = (
                p_solarth.CO2e_pb
        )  
    ...
    #Production heatpump energy within other renewables: 
        ...
        #1 final energy consumption
        p_heatpump.energy = (
            p_orenew.energy * p_heatpump.pct_energy
        ...
        #4 process-based CO2e 
        p_heatpump.CO2e_pb = (
                p_heatpump.energy * p_heatpump.CO2e_pb_per_MWh
        )
    ...
    ## back to other renewables
        ...
        #4 process-based CO2e 
        p_orenew.CO2e_pb = (
                p_solarth.CO2e_pb + p_heatpump.CO2e_pb
        )
        ...
        p_solarth.energy = (
                p_orenew.energy * fact('Fact_R_S_ratio_solarth_to_orenew_2018')
        )
        p_solarth.pct_energy = (
        ...
        p_heatpump = root.h18.p_heatpump
        p_heatpump.energy = (
                p_orenew.energy * fact('Fact_R_S_ratio_heatpump_to_orenew_2018')
        )
        p_heatpump.pct_energy = (
