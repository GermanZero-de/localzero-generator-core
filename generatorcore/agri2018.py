...
def Agri2018_calc(root):
    ...
    try:
        ...
        p_fermen_nondairy.CO2e_pb_per_t = (
            fact('Fact_A_P_fermen_nondairy_ratio_CO2e_to_amount_2018')
        )
        ...
        p_fermen_swine.CO2e_pb_per_t = (
            fact('Fact_A_P_fermen_swine_ratio_CO2e_to_amount_2018')
        )
        ...
        p_fermen_poultry.CO2e_pb_per_t = (
            fact('Fact_A_P_fermen_poultry_ratio_CO2e_to_amount_2018')
        )
        ...
        p_fermen_oanimal.CO2e_pb_per_t = (
            fact('Fact_A_P_fermen_oanimal_ratio_CO2e_to_amount_2018')
        )
        ...
        p_manure_nondairy.CO2e_pb_per_t = (
            entry('In_A_manure_nondairy_ratio_CO2e_to_amount')
        )
        ...
        p_manure_dswine.CO2e_pb_per_t = (
            entry('In_A_manure_swine_ratio_CO2e_to_amount')
        )
        ...
        p_manure_dpoultry.CO2e_pb_per_t = (
            entry('In_A_manure_poultry_ratio_CO2e_to_amount')
        )
        ...
        p_manure_dswine.CO2e_total = (
            p_manure_dswine.CO2e_pb + p_manure_dswine.CO2e_cb
        )
        p_manure_dpoultry.amount = p_fermen_poultry.amount
        p_manure_doanimal.CO2e_pb_per_t = (
            entry('In_A_manure_oanimal_ratio_CO2e_to_amount')
        )
        ...
        p_soil_manure.CO2e_pb_per_t = (
            entry('In_A_soil_manure_ratio_CO2e_to_ha')
        )
        ...
        p_soil_sludge.CO2e_pb_per_t = (
            entry('In_A_soil_sludge_ratio_CO2e_to_ha')
        )
        ...
        p_soil_ecrop.CO2e_pb_per_t = (
            entry('In_A_soil_ecrop_ratio_CO2e_to_ha')
        )
        ...
        p_soil_grazing.CO2e_pb_per_t = (
            entry('In_A_soil_crazing_ratio_CO2e_to_ha')
        )
        ...
        p_soil_residue.CO2e_pb_per_t = (
            entry('In_A_soil_residue_ratio_CO2e_to_ha')
        )
        ...
        p_soil_orgfarm.CO2e_pb_per_t = (
            entry('In_A_soil_orgfarm_ratio_CO2e_to_ha')
        )
        ...
        p_other_liming_dolomite.prod_volume = entry('In_A_other_liming_dolomite_prod_volume')
        ...
        p_other_urea.CO2e_total = (
            p_other_urea.CO2e_pb + p_other_urea.CO2e_cb
        )
        ...
        p_other_kas.CO2e_pb = (
            p_other_kas.prod_volume * p_other_kas.CO2e_pb_per_t
        )
        p_other.CO2e_pb = (
            p_other_liming.CO2e_pb +
            p_other_urea.CO2e_pb +
