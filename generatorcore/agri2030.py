...
def Agri2030_calc(root):
    ...
    p_operation_elec_elcon.demand_heatpump = p_elec_heatpump.demand_heatpump = p_operation_vehicles.demand_heatpump = 0
    p_operation_elec_elcon.demand_biomass = p_elec_heatpump.demand_biomass = p_operation_vehicles.demand_biomass = 0
    p_operation_heat.demand_ediesel = p_operation_elec_elcon.demand_ediesel = p_elec_heatpump.demand_ediesel = 0
    p_operation_heat.demand_epetrol = p_operation_elec_elcon.demand_epetrol = p_elec_heatpump.demand_epetrol = 0
    p_operation_heat.demand_electricity = p_operation_vehicles.demand_electricity = 0
    p_operation_elec_elcon.demand_emethan = p_elec_heatpump.demand_emethan = p_operation_vehicles.demand_emethan = 0
    s_emethan.CO2e_cb = 0
    ...
    for i in range(20):
        ...
        g_consult.invest = (
            g_consult.area_ha_available *
            g_consult.invest_per_x)
        g_consult.invest_com = (
            g_consult.invest *
            ass('Ass_A_G_consult_invest_pct_of_public'))
        g_consult.pct_of_wage = (ass('Ass_A_G_consult_invest_pct_of_wage'))
        g_consult.invest_pa = (
            g_consult.invest /
            entry('In_M_duration_target'))
        g_consult.ratio_wage_to_emplo = (
            ass('Ass_A_G_consult_ratio_wage_to_emplo'))
        g_consult.cost_wage = (
            g_consult.invest_pa *
            g_consult.pct_of_wage)
        g_consult.demand_emplo = (
            g_consult.cost_wage /
            g_consult.ratio_wage_to_emplo)
        g_consult.invest_pa_com = (
            g_consult.invest_pa *
            ass('Ass_A_G_consult_invest_pct_of_public'))
        g_conversion.invest_per_x = (
            ass('Ass_A_G_area_agri_organic_ratio_invest_to_ha'))
        g_conversion.power_installed = (
            entry('In_A_area_agri_com_pct_of_organic'))
        g_conversion.pct_of_wage = (
            fact('Fact_B_P_constr_main_revenue_pct_of_wage_2017'))
        g_conversion.power_to_be_installed_pct = (
            ass('Ass_A_G_area_agri_pct_of_organic_2050'))
        g_conversion.ratio_wage_to_emplo = (
            fact('Fact_B_P_constr_main_ratio_wage_to_emplo_2017'))
        ...
        g_conversion.invest = (
            g_conversion.power_to_be_installed *
            g_conversion.invest_per_x)
        g_conversion.invest_pa = (
            g_conversion.invest /
            entry('In_M_duration_target'))
        g_conversion.cost_wage = (
            g_conversion.invest_pa *
            g_conversion.pct_of_wage)
        ...
        p_fermen_dairycow.pet_sites = (
            a18.p_fermen_dairycow.amount * (1 + p_fermen_dairycow.demand_change))
        p_fermen_dairycow.CO2e_pb = (
            p_fermen_dairycow.pet_sites *
            p_fermen_dairycow.CO2e_pb_per_t)
        p.CO2e_total_2021_estimated = (
            a18.p.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        p_fermen_nondairy.pet_sites = (
            a18.p_fermen_nondairy.amount * (1 + p_fermen_nondairy.demand_change))
        p_fermen_nondairy.CO2e_pb_per_t = a18.p_fermen_nondairy.CO2e_pb_per_t
        p_manure_dairycow.demand_change = (
            ass('Ass_A_P_manure_ratio_CO2e_to_amount_change'))
        p_fermen_nondairy.CO2e_pb = (
            p_fermen_nondairy.pet_sites *
            p_fermen_nondairy.CO2e_pb_per_t)
        p_fermen_swine.pet_sites = (
            a18.p_fermen_swine.amount * (1 + p_fermen_swine.demand_change))
        p_fermen.CO2e_total_2021_estimated = (
            a18.p_fermen.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        p_fermen_swine.CO2e_pb = (
            p_fermen_swine.pet_sites *
            p_fermen_swine.CO2e_pb_per_t)
        p_fermen_poultry.pet_sites = (
            a18.p_fermen_poultry.amount * (1 + p_fermen_poultry.demand_change))
        p_fermen_poultry.CO2e_pb_per_t = a18.p_fermen_poultry.CO2e_pb_per_t
        p_fermen_dairycow.CO2e_total = (
            p_fermen_dairycow.CO2e_pb +
            p_fermen_dairycow.CO2e_cb)
        ...
        p_fermen_oanimal.CO2e_pb = (
            p_fermen_oanimal.pet_sites *
            p_fermen_oanimal.CO2e_pb_per_t)
        p_fermen.CO2e_pb = (
            p_fermen_dairycow.CO2e_pb +
            p_fermen_nondairy.CO2e_pb +
            p_fermen_swine.CO2e_pb +
        ...
        p_fermen_swine.CO2e_total = (
            p_fermen_swine.CO2e_pb +
            p_fermen_swine.CO2e_cb)
        p_fermen_swine.change_CO2e_t = (
            p_fermen_swine.CO2e_total -
            a18.p_fermen_swine.CO2e_total)
        p_fermen_swine.change_CO2e_pct = (
            p_fermen_swine.change_CO2e_t /
            a18.p_fermen_swine.CO2e_total)
        p_fermen_swine.CO2e_total_2021_estimated = (
            a18.p_fermen_swine.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        p_fermen.cost_climate_saved = (
            ...
            entry('In_M_duration_neutral') *
            fact('Fact_M_cost_per_CO2e_2020'))
        p_fermen.change_CO2e_t = (
            p_fermen.CO2e_total -
            a18.p_fermen.CO2e_total)
        p_fermen.change_CO2e_pct = (
            p_fermen.change_CO2e_t /
            a18.p_fermen.CO2e_total)
        p_fermen_poultry.CO2e_total = (
            p_fermen_poultry.CO2e_pb +
            p_fermen_poultry.CO2e_cb)
        ...
        p_manure_dairycow.CO2e_pb_per_t = (
            a18.p_manure_dairycow.CO2e_pb_per_t * (1 + p_manure_dairycow.demand_change))
        p_manure_dairycow.CO2e_pb = (
            p_manure_dairycow.pet_sites *
            p_manure_dairycow.CO2e_pb_per_t)
        p_fermen_oanimal.CO2e_total = (
            p_fermen_oanimal.CO2e_pb +
            p_fermen_oanimal.CO2e_cb)
        p_fermen_oanimal.change_CO2e_t = (
            p_fermen_oanimal.CO2e_total -
            a18.p_fermen_oanimal.CO2e_total)
        ...
        p_soil_fertilizer.demand_change = (
            ass('Ass_A_P_soil_N_application_2030_change'))
        p_manure_nondairy.demand_change = (
            ass('Ass_A_P_manure_ratio_CO2e_to_amount_change'))
        p_manure_nondairy.CO2e_pb_per_t = (
            a18.p_manure_nondairy.CO2e_pb_per_t * (1 + p_manure_nondairy.demand_change))
        p_manure.CO2e_total_2021_estimated = (
            a18.p_manure.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        p_manure_nondairy.CO2e_pb = (
            p_manure_nondairy.pet_sites *
            p_manure_nondairy.CO2e_pb_per_t)
        p_manure_dswine.pet_sites = (p_fermen_swine.pet_sites)
        p_manure_dswine.demand_change = (
            ass('Ass_A_P_manure_ratio_CO2e_to_amount_change'))
        p_manure_dswine.CO2e_pb_per_t = (
            a18.p_manure_dswine.CO2e_pb_per_t * (1 + p_manure_dswine.demand_change))
        p_manure_dswine.CO2e_pb = (
            p_manure_dswine.pet_sites *
            p_manure_dswine.CO2e_pb_per_t)
        p_manure_dairycow.CO2e_total = (
            p_manure_dairycow.CO2e_pb +
            p_manure_dairycow.CO2e_cb)
        ...
        p_manure_dpoultry.demand_change = (
            ass('Ass_A_P_manure_ratio_CO2e_to_amount_change'))
        p_manure_dpoultry.CO2e_pb_per_t = (
            a18.p_manure_dpoultry.CO2e_pb_per_t * (1 + p_manure_dpoultry.demand_change))
        p_manure_dpoultry.CO2e_pb = (
            p_manure_dpoultry.pet_sites *
            p_manure_dpoultry.CO2e_pb_per_t)
        p_manure_nondairy.CO2e_total = (
            p_manure_nondairy.CO2e_pb +
            p_manure_nondairy.CO2e_cb)
        ...
        p_manure_doanimal.demand_change = (
            ass('Ass_A_P_manure_ratio_CO2e_to_amount_change'))
        p_manure_doanimal.CO2e_pb_per_t = (
            a18.p_manure_doanimal.CO2e_pb_per_t * (1 + p_manure_doanimal.demand_change))
        p_manure_doanimal.CO2e_pb = (
            p_manure_doanimal.pet_sites *
            p_manure_doanimal.CO2e_pb_per_t)
        p_manure_dswine.CO2e_total = (
            p_manure_dswine.CO2e_pb +
            p_manure_dswine.CO2e_cb)
        p_manure_dswine.change_CO2e_t = (
            p_manure_dswine.CO2e_total -
            a18.p_manure_dswine.CO2e_total)
        ...
        p_manure_deposition.pet_sites = (
            ...
            p_fermen_swine.pet_sites +
            p_fermen_oanimal.pet_sites)
        p_manure_deposition.demand_change = (
            ass('Ass_A_P_manure_ratio_CO2e_to_amount_change'))
        p_manure_deposition.CO2e_pb_per_t = (
            a18.p_manure_deposition.CO2e_pb_per_t * (1 + p_manure_deposition.demand_change))
        p_manure_deposition.CO2e_pb = (
            p_manure_deposition.pet_sites *
            p_manure_deposition.CO2e_pb_per_t)
        p_manure_dpoultry.CO2e_total = (
            p_manure_dpoultry.CO2e_pb +
            p_manure_dpoultry.CO2e_cb)
        ...
        p_manure.cost_climate_saved = (
            ...
            entry('In_M_duration_neutral') *
            fact('Fact_M_cost_per_CO2e_2020'))
        p_manure.change_CO2e_t = (
            p_manure.CO2e_total -
            a18.p_manure.CO2e_total)
        p_manure_doanimal.CO2e_total = (
            p_manure_doanimal.CO2e_pb +
            p_manure_doanimal.CO2e_cb)
        ...
        p_manure_doanimal.cost_climate_saved = (
            ...
            entry('In_M_duration_neutral') *
            fact('Fact_M_cost_per_CO2e_2020'))
        p_manure.change_CO2e_pct = (
            p_manure.change_CO2e_t /
            a18.p_manure.CO2e_total)
        p_soil_fertilizer.area_ha = (l30.g_crop.area_ha)
        p_soil_fertilizer.CO2e_pb_per_t = (
            a18.p_soil_fertilizer.CO2e_pb_per_t * (1 + p_soil_fertilizer.demand_change))
        p_soil_fertilizer.CO2e_pb = (
            p_soil_fertilizer.area_ha *
            p_soil_fertilizer.CO2e_pb_per_t)
        p_manure_deposition.CO2e_total = (
            p_manure_deposition.CO2e_pb +
            p_manure_deposition.CO2e_cb)
        ...
        p_soil_manure.demand_change = (
            ass('Ass_A_P_soil_N_application_2030_change'))
        p_soil_manure.CO2e_pb_per_t = (
            a18.p_soil_manure.CO2e_pb_per_t * (1 + p_soil_manure.demand_change))
        p_soil.CO2e_total_2021_estimated = (
            a18.p_soil.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        p_soil_manure.CO2e_pb = (
            p_soil_manure.area_ha *
            p_soil_manure.CO2e_pb_per_t)
        p_soil_sludge.area_ha = (l30.g_crop.area_ha)
        p_soil_sludge.demand_change = (
            ass('Ass_A_P_soil_N_application_2030_change'))
        p_soil_fertilizer.area_ha_change = (
            - (a18.p_soil_fertilizer.area_ha - p_soil_fertilizer.area_ha))
        p_soil_sludge.CO2e_pb_per_t = (
            a18.p_soil_sludge.CO2e_pb_per_t * (1 + p_soil_sludge.demand_change))
        p_soil_sludge.CO2e_pb = (
            p_soil_sludge.area_ha *
            p_soil_sludge.CO2e_pb_per_t)
        p_soil_fertilizer.CO2e_total = (
            p_soil_fertilizer.CO2e_pb +
            p_soil_fertilizer.CO2e_cb)
        ...
        p_soil_ecrop.demand_change = (
            ass('Ass_A_P_soil_N_application_2030_change'))
        p_soil_manure.area_ha_change = (
            - (a18.p_soil_manure.area_ha - p_soil_manure.area_ha))
        p_soil_ecrop.CO2e_pb_per_t = (
            a18.p_soil_ecrop.CO2e_pb_per_t * (1 + p_soil_ecrop.demand_change))
        p_soil_ecrop.CO2e_pb = (
            p_soil_ecrop.area_ha *
            p_soil_ecrop.CO2e_pb_per_t)
        p_soil_manure.CO2e_total = (
            p_soil_manure.CO2e_pb +
            p_soil_manure.CO2e_cb)
        p_soil_manure.change_CO2e_t = (
            p_soil_manure.CO2e_total -
            a18.p_soil_manure.CO2e_total)
        p_soil_manure.change_CO2e_pct = (
            p_soil_manure.change_CO2e_t /
            a18.p_soil_manure.CO2e_total)
        p_soil_manure.CO2e_total_2021_estimated = (
            a18.p_soil_manure.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        p_fermen_dairycow.pet_sites = (a18.p_fermen_dairycow.amount * (1 + p_fermen_dairycow.demand_change))
        p_fermen_nondairy.pet_sites = (a18.p_fermen_nondairy.amount * (1 + p_fermen_nondairy.demand_change))
        p_fermen_oanimal.pet_sites = (a18.p_fermen_oanimal.amount * (1 + p_fermen_oanimal.demand_change))
        p_soil_grazing.CO2e_pb_per_t = (
            a18.p_soil_grazing.CO2e_pb_per_t *
            (p_fermen_dairycow.pet_sites + p_fermen_nondairy.pet_sites + p_fermen_oanimal.pet_sites) /
            (a18.p_fermen_dairycow.amount + a18.p_fermen_nondairy.amount + a18.p_fermen_oanimal.amount)
        )
        ...
        p_soil_sludge.CO2e_total = (
            p_soil_sludge.CO2e_pb +
            p_soil_sludge.CO2e_cb)
        p_soil_sludge.change_CO2e_t = (
            p_soil_sludge.CO2e_total -
            a18.p_soil_sludge.CO2e_total)
        p_soil_sludge.change_CO2e_pct = (
            p_soil_sludge.change_CO2e_t /
            a18.p_soil_sludge.CO2e_total)
        p_soil_sludge.CO2e_total_2021_estimated = (
            a18.p_soil_sludge.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        p_soil_residue.CO2e_pb = (
            ...
            p_soil_residue.CO2e_pb_per_t)
        p_soil_ecrop.area_ha_change = (
            - (a18.p_soil_ecrop.area_ha - p_soil_ecrop.area_ha))
        ...
        p_soil_ecrop.change_CO2e_t = (
            ...
            a18.p_soil_ecrop.CO2e_total)
        p_soil_ecrop.change_CO2e_pct = (
            p_soil_ecrop.change_CO2e_t /
            a18.p_soil_ecrop.CO2e_total)
        p_soil_ecrop.CO2e_total_2021_estimated = (
            a18.p_soil_ecrop.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        p_soil_grazing.CO2e_total = (
            p_soil_grazing.CO2e_pb +
            p_soil_grazing.CO2e_cb)
        p_soil_grazing.change_CO2e_t = (
            p_soil_grazing.CO2e_total -
            a18.p_soil_grazing.CO2e_total)
        p_soil_grazing.change_CO2e_pct = (
            p_soil_grazing.change_CO2e_t /
            a18.p_soil_grazing.CO2e_total)
        p_soil_grazing.CO2e_total_2021_estimated = (
            a18.p_soil_grazing.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        p_soil_residue.demand_change = (
            p_soil_residue.CO2e_pb_per_t /
            a18.p_soil_residue.CO2e_pb_per_t -
            1)
        p_soil_orgloss.CO2e_pb = (
            p_soil_orgloss.area_ha *
            p_soil_orgloss.CO2e_pb_per_t)
        ...
        p_soil_leaching.demand_change = (
            ass('Ass_A_P_soil_N_application_2030_change'))
        p_soil_residue.CO2e_total = (
            p_soil_residue.CO2e_pb +
            p_soil_residue.CO2e_cb)
        p_soil_residue.change_CO2e_t = (
            p_soil_residue.CO2e_total -
            a18.p_soil_residue.CO2e_total)
        p_soil_residue.change_CO2e_pct = (
            p_soil_residue.change_CO2e_t /
            a18.p_soil_residue.CO2e_total)
        p_soil_residue.CO2e_total_2021_estimated = (
            a18.p_soil_residue.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        p_soil_orgfarm.demand_change = (
            p_soil_orgfarm.CO2e_pb_per_t /
            a18.p_soil_orgfarm.CO2e_pb_per_t -
            1)
        p_soil_leaching.CO2e_pb_per_t = (
            a18.p_soil_leaching.CO2e_pb_per_t * (1 + p_soil_leaching.demand_change))
        ...
        p_soil_orgfarm.CO2e_total = (
            p_soil_orgfarm.CO2e_pb +
            p_soil_orgfarm.CO2e_cb)
        p_soil_orgfarm.change_CO2e_t = (
            p_soil_orgfarm.CO2e_total -
            a18.p_soil_orgfarm.CO2e_total)
        p_soil_orgfarm.change_CO2e_pct = (
            p_soil_orgfarm.change_CO2e_t /
            a18.p_soil_orgfarm.CO2e_total)
        p_soil_orgfarm.CO2e_total_2021_estimated = (
            a18.p_soil_orgfarm.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        p_soil_orgloss.demand_change = (
            p_soil_orgloss.CO2e_pb_per_t /
            a18.p_soil_orgloss.CO2e_pb_per_t -
            1)
        p_soil_deposition.demand_change = (
            ass('Ass_A_P_soil_N_application_2030_change'))
        p_soil_orgloss.area_ha_change = (
            - (a18.p_soil_orgloss.area_ha - p_soil_orgloss.area_ha))
        p_soil_deposition.CO2e_pb_per_t = (
            a18.p_soil_deposition.CO2e_pb_per_t * (1 + p_soil_deposition.demand_change))
        p_soil_deposition.CO2e_pb = (p_soil_deposition.area_ha * p_soil_deposition.CO2e_pb_per_t)
        p_soil_orgloss.CO2e_total = (
            p_soil_orgloss.CO2e_pb +
            p_soil_orgloss.CO2e_cb)
        p_soil_orgloss.change_CO2e_t = (
            p_soil_orgloss.CO2e_total -
            a18.p_soil_orgloss.CO2e_total)
        p_soil_orgloss.change_CO2e_pct = (
            p_soil_orgloss.change_CO2e_t /
            a18.p_soil_orgloss.CO2e_total)
        p_soil_orgloss.CO2e_total_2021_estimated = (
            a18.p_soil_orgloss.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        p_soil_leaching.CO2e_total = (
            p_soil_leaching.CO2e_pb +
            p_soil_leaching.CO2e_cb)
        p_soil_leaching.change_CO2e_t = (
            p_soil_leaching.CO2e_total -
            a18.p_soil_leaching.CO2e_total)
        ...
        p_soil_deposition.cost_climate_saved = (
            ...
            entry('In_M_duration_neutral') *
            fact('Fact_M_cost_per_CO2e_2020'))
        p_other_liming_calcit.demand_change = (ass('Ass_A_P_other_liming_calcit_amount_change'))
        p_other_urea.CO2e_pb = (
            p_other_urea.prod_volume *
            p_other_urea.CO2e_pb_per_t)
        p_other_liming_calcit.prod_volume = (a18.p_other_liming_calcit.prod_volume * (1 + p_other_liming_calcit.demand_change))
        p_other_liming_calcit.CO2e_pb = (
            p_other_liming_calcit.prod_volume *
            p_other_liming_calcit.CO2e_pb_per_t)
        p_other.CO2e_total_2021_estimated = (
            a18.p_other.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        p_other_liming_dolomite.demand_change = (
            ass('Ass_A_P_other_liming_dolomit_amount_change'))
        p_other_liming_dolomite.prod_volume = (a18.p_other_liming_dolomite.prod_volume * (1 + p_other_liming_dolomite.demand_change))
        p_other_liming_dolomite.CO2e_pb_per_t = (fact('Fact_A_P_other_liming_dolomite_ratio_CO2e_pb_to_amount_2018'))
        p_other_liming_dolomite.CO2e_pb = (
            p_other_liming_dolomite.prod_volume *
            p_other_liming_dolomite.CO2e_pb_per_t)
        p_other_liming.CO2e_pb = (p_other_liming_calcit.CO2e_pb + p_other_liming_dolomite.CO2e_pb)
        p_other_kas.demand_change = (ass('Ass_A_P_other_kas_amount_change'))
        p_other_liming.CO2e_total_2021_estimated = (
            a18.p_other_liming.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        p_other_kas.prod_volume = (a18.p_other_kas.prod_volume * (1 + p_other_kas.demand_change))
        p_other_kas.CO2e_pb_per_t = (fact('Fact_A_P_other_kas_ratio_CO2e_pb_to_amount_2018'))
        p_other_kas.CO2e_pb = (
            p_other_kas.prod_volume *
            p_other_kas.CO2e_pb_per_t)
        ...
        p_other_liming_dolomite.CO2e_total = (
            p_other_liming_dolomite.CO2e_pb +
            p_other_liming_dolomite.CO2e_cb)
        ...
        p_other_liming_dolomite.cost_climate_saved = (
            ...
            entry('In_M_duration_neutral') *
            fact('Fact_M_cost_per_CO2e_2020'))
        p_other_ecrop.prod_volume = (
            a18.p_other_ecrop.prod_volume * (1 + p_other_ecrop.demand_change))
        p_other_ecrop.CO2e_pb_per_t = (fact('Fact_A_P_other_ecrop_ratio_CO2e_pb_to_amount_2018'))
        p_other_ecrop.CO2e_pb = (
            p_other_ecrop.prod_volume *
            p_other_ecrop.CO2e_pb_per_t)
        p_other.CO2e_pb = (
        ...
        p_other_urea.change_CO2e_t = (
            ...
            a18.p_other_urea.CO2e_total)
        p_other_urea.change_CO2e_pct = (
            p_other_urea.change_CO2e_t /
            a18.p_other_urea.CO2e_total)
        p_other_urea.CO2e_total_2021_estimated = (
            a18.p_other_urea.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        p_other.change_CO2e_pct = (
            p_other.change_CO2e_t /
            a18.p_other.CO2e_total)
        p_other_kas.CO2e_total = (
            p_other_kas.CO2e_pb +
            p_other_kas.CO2e_cb)
        p_other_kas.change_CO2e_t = (
            p_other_kas.CO2e_total -
            a18.p_other.CO2e_total)
        ...
        p_other_ecrop.CO2e_total = (
            p_other_ecrop.CO2e_pb +
            p_other_ecrop.CO2e_cb)
        p_other_ecrop.change_CO2e_t = (
            p_other_ecrop.CO2e_total -
            a18.p_other_ecrop.CO2e_total)
        p_other_ecrop.change_CO2e_pct = (
            p_other_ecrop.change_CO2e_t /
            a18.p_other_ecrop.CO2e_total)
        p_other_ecrop.CO2e_total_2021_estimated = (
            a18.p_other_ecrop.CO2e_total *
            fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        p_operation_heat.area_m2_rehab = (p_operation_heat.pct_rehab * a18.p_operation_heat.area_m2)
        p_operation_heat.demand_heat_rehab = (
        ...
        p_operation_heat.area_m2_nonrehab = (p_operation_heat.pct_nonrehab * a18.p_operation_heat.area_m2)
        ...
        p_operation_heat.demand_biomass = (
            min(a18.s_biomass.energy, p_operation_heat.energy - s_heatpump.energy))
        ...
        p_operation_heat.demand_emethan = (
            ...
            s_biomass.energy -
            s_heatpump.energy)
        p_operation_heat.fec_factor_averaged = (p_operation_heat.energy / a18.p_operation_heat.area_m2)
        p_operation_heat.change_energy_MWh = (p_operation_heat.energy - a18.p_operation_heat.energy)
        p_operation_heat.change_energy_pct = (
            p_operation_heat.change_energy_MWh /
            a18.p_operation_heat.energy)
        ...
        p_operation_heat.cost_wage = (
            ...
            entry('In_M_duration_target') *
            p_operation_heat.pct_of_wage)
        p_operation_heat.ratio_wage_to_emplo = (
            fact('Fact_B_P_renovations_wage_per_person_per_year_2017'))
        p_operation_heat.demand_emplo = (p_operation_heat.cost_wage / p_operation_heat.ratio_wage_to_emplo)
        ...
        p_operation_heat.demand_emplo_new = (
            max(0, p_operation_heat.demand_emplo - p_operation_heat.emplo_existing))
        p_operation_heat.invest_pa = (p_operation_heat.invest / entry('In_M_duration_target'))
        ...
        p_operation_vehicles.demand_epetrol = (
            p_operation_vehicles.energy * a18.s_petrol.energy / (a18.s_petrol.energy + a18.s_diesel.energy))
        ...
        s_petrol.change_CO2e_t = (
            s_petrol.CO2e_total -
            a18.s_petrol.CO2e_total)
        s_petrol.change_CO2e_pct = (
            s_petrol.change_CO2e_t /
            a18.s_petrol.CO2e_total)
        ...
        s_diesel.change_CO2e_t = (
            s_diesel.CO2e_total -
            a18.s_diesel.CO2e_total)
        s_diesel.change_CO2e_pct = (
            s_diesel.change_CO2e_t /
            a18.s_diesel.CO2e_total)
        ...
        s_fueloil.change_CO2e_t = (
            ...
            a18.s_fueloil.CO2e_total)
        s_fueloil.change_CO2e_pct = (
            s_fueloil.change_CO2e_t /
            a18.s_fueloil.CO2e_total)
        ...
        s_biomass.change_CO2e_t = (
            ...
            a18.s_biomass.CO2e_total)
        s_biomass.change_CO2e_pct = (
            s_biomass.change_CO2e_t /
            a18.s_biomass.CO2e_total)
        ...
        s_heatpump.cost_fuel_per_MWh = (
            fact('Fact_R_S_gas_energy_cost_factor_2018'))
        ...
        s_heatpump.cost_climate_saved = (
            ...
            entry('In_M_duration_neutral') *
            fact('Fact_M_cost_per_CO2e_2020'))
        s_heatpump.change_cost_energy = (
            s_heatpump.cost_fuel - s_heatpump.cost_fuel)
        s_heatpump.invest_per_x = (fact('Fact_R_S_heatpump_cost'))
        s_heatpump.full_load_hour = (
            fact('Fact_B_S_full_usage_hours_buildings'))
        s_heatpump.pct_of_wage = (
            fact('Fact_B_P_plumbing_ratio_wage_to_main_revenue_2017'))
        s_heatpump.power_installed = (
            a18.s_heatpump.energy / s_heatpump.full_load_hour)
        s_heatpump.ratio_wage_to_emplo = (
            fact('Fact_B_P_heating_wage_per_person_per_year'))
        s_heatpump.power_to_be_installed = (max(
            s_heatpump.energy / s_heatpump.full_load_hour - s_heatpump.power_installed, 0))
        s_heatpump.invest = (
            s_heatpump.invest_per_x *
            s_heatpump.power_to_be_installed *
            1000)
        s_heatpump.invest_pa = (
            s_heatpump.invest /
            entry('In_M_duration_target'))
        s_heatpump.cost_wage = (s_heatpump.invest_pa * s_heatpump.pct_of_wage)
        s_heatpump.demand_emplo = (
            s_heatpump.cost_wage /
            s_heatpump.ratio_wage_to_emplo)
        ...
        g_organic.ratio_wage_to_emplo = (fact('Fact_B_P_constr_main_ratio_wage_to_emplo_2017'))
        ...
        g_organic.power_to_be_installed = (g_organic.area_ha_available * (g_organic.power_to_be_installed_pct - g_organic.power_installed))
        ...
        p_operation.energy = (p_operation_heat.energy +
                              p_operation_elec_elcon.energy +
                              p_operation_elec_heatpump.energy +
                              p_operation_vehicles.energy)
        p_operation.change_energy_MWh = (p_operation.energy - a18.p_operation.energy)
        p_operation.change_energy_pct = (p_operation.change_energy_MWh / a18.p_operation.energy)
        p_operation_elec_elcon.change_energy_MWh = (p_operation_elec_elcon.energy - a18.p_operation_elec_elcon.energy)
        p_operation_elec_elcon.change_energy_pct = (p_operation_elec_elcon.change_energy_MWh / a18.p_operation_elec_elcon.energy)
        p_operation_elec_heatpump.demand_electricity = (p_operation_elec_heatpump.energy)
        p_operation_elec_heatpump.energy = (s_heatpump.energy / fact('Fact_R_S_heatpump_mean_annual_performance_factor_all'))
        a18.p_operation_elec_heatpump.energy = 0
        p_operation_elec_heatpump.change_energy_MWh = (p_operation_elec_heatpump.energy - a18.p_operation_elec_heatpump.energy)
        p_operation_vehicles.change_energy_MWh = (p_operation_vehicles.energy - a18.p_operation_vehicles.energy)
        p_operation_vehicles.change_energy_pct = (p_operation_vehicles.change_energy_MWh / a18.p_operation_vehicles.energy)
