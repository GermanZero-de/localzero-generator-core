...
def Industry2018_calc(root):
    ...
    i18.p_miner_cement.energy = (
        i18.p_miner_cement.pct_energy * i18.p_miner.energy
    )
    i18.p_miner_cement.energy_use_factor = fact('Fact_I_P_miner_cement_energy_use_factor_2017')
    i18.p_miner_cement.prod_volume = (
        i18.p_miner_cement.energy * i18.p_miner_cement.energy_use_factor
    )
    i18.p_miner_cement.CO2e_pb_per_t = fact("Fact_I_P_miner_cement_ratio_CO2e_pb_to_prodvol_2018")
    ...
    i18.p_miner_chalk.energy = (
        i18.p_miner.energy * i18.p_miner_chalk.pct_energy
    )
    i18.p_miner_chalk.energy_use_factor = fact('Fact_I_P_miner_chalk_energy_use_factor_2017')
    ...
    i18.p_miner_glas.energy = (
        i18.p_miner.energy * i18.p_miner_glas.pct_energy
    )
    i18.p_miner_glas.energy_use_factor = fact('Fact_I_P_miner_glas_energy_use_factor_2017')
    ...
    i18.p_miner_ceram.energy = (
        i18.p_miner.energy * i18.p_miner_ceram.pct_energy
    )
    i18.p_miner_ceram.energy_use_factor = fact('Fact_I_P_miner_ceram_energy_use_factor_2017')
    ...
    i18.p_chem_basic.energy = (
        entry('In_I_chem_fec') * i18.p_chem_basic.pct_energy
    )
    ...
    i18.p_chem_ammonia.energy = (
        entry('In_I_chem_fec') * i18.p_chem_ammonia.pct_energy
    )
...
# chem other
    i18.p_chem_other.pct_energy = fact(
        "Fact_I_S_chem_other_fec_ratio_to_chem_all_2018"
    )
    i18.p_chem_other.energy = (
        entry('In_I_chem_fec') * i18.p_chem_other.pct_energy
    )
    i18.p_chem_other.energy_use_factor = fact("Fact_I_P_chem_other_ratio_prodvol_to_fec_2018")
    ...
    i18.p_chem_other.CO2e_total = (
        i18.p_chem_other.CO2e_pb + i18.p_chem_other.CO2e_cb
    )
    ...
    i18.p_metal_steel.energy = (
        i18.p_metal.energy * i18.p_metal_steel.pct_energy
    )
    ...
    i18.p_metal_steel_primary.prod_volume = (
        i18.p_metal_steel_primary.energy
        * i18.p_metal_steel_primary.energy_use_factor
    )
    ...
    i18.p_metal_steel_primary.CO2e_pb = (
        i18.p_metal_steel_primary.prod_volume
        * i18.p_metal_steel_primary.CO2e_pb_per_t
    )
    ...
    i18.p_metal_steel_primary.CO2e_cb = (
        i18.p_metal_steel_primary.prod_volume
        * i18.p_metal_steel_primary.CO2e_cb_per_t
    )
    ...
    i18.p_metal_nonfe.energy = (
        i18.p_metal.energy * i18.p_metal_nonfe.pct_energy
    )
    ...
    i18.p_metal_nonfe.CO2e_total = (
        i18.p_metal_nonfe.CO2e_pb + i18.p_metal_nonfe.CO2e_cb
    )
    ...
    i18.p_other_paper.energy = (
        entry('In_I_other_fec') * i18.p_other_paper.pct_energy
    )
    ...
    i18.p_other_paper.CO2e_pb_per_t = fact('Fact_I_P_other_paper_ratio_CO2e_pb_to_prodvol_2018')
    i18.p_other_paper.CO2e_pb = i18.p_other_paper.CO2e_pb_per_t * i18.p_other_paper.prod_volume

    i18.p_other_paper.CO2e_cb_per_t = fact('Fact_I_P_other_paper_ratio_CO2e_cb_to_prodvol_2018')
    i18.p_other_paper.CO2e_cb = (i18.p_other_paper.prod_volume * i18.p_other_paper.CO2e_cb_per_t)
    ...
    i18.p_other_food.energy = (
        entry('In_I_other_fec') * i18.p_other_food.pct_energy
    )
    ...
    i18.p_metal.CO2e_cb = (
        i18.p_metal_steel.CO2e_cb + i18.p_metal_nonfe.CO2e_cb
    )
    ...
    i18.s_renew_orenew.energy = (entry('In_I_orenew_fec') * fact('Fact_R_S_ratio_heatpump_to_orenew_2018'))
