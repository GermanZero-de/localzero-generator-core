...
def Business2030_calc(root):
    ...
    try:
        ...
        g_consult.emplo_existing = (fact('Fact_R_G_energy_consulting_total_personel') * g_consult.demand_emplo /
                                    (r30.g_consult.demand_emplo + g_consult.demand_emplo) * entry('In_M_population_com_2018') / entry('In_M_population_nat'))
        ...
        p_nonresi_com.invest = (p_nonresi_com.area_m2_rehab *
                                (1 - fact('Fact_B_P_ratio_renovated_to_not_renovated_2021')) * p_nonresi_com.invest_per_x)
        ...
        s_solarth.emplo_existing = (fact('Fact_B_P_install_heating_emplo_2017') * entry('In_M_population_com_2018') / entry('In_M_population_nat') * s_solarth.demand_emplo / (
            r30.s_solarth.demand_emplo + r30.s_heatpump.demand_emplo + s_heatpump.demand_emplo + s_solarth.demand_emplo + a30.s_heatpump.demand_emplo))
        ...
        s_emethan.cost_climate_saved = ((s_emethan.CO2e_total_2021_estimated - s_emethan.CO2e_cb) *
                                        entry('In_M_duration_neutral') * fact('Fact_M_cost_per_CO2e_2020'))
        ...
        rp_p.demand_emplo = (r30.g_consult.demand_emplo + r30.p_buildings_total.demand_emplo +
                             r30.s.demand_emplo + g_consult.demand_emplo + p_nonresi.demand_emplo + s.demand_emplo)
        rp_p.emplo_existing = (r30.g_consult.emplo_existing + r30.p_buildings_total.emplo_existing +
                               r30.s.emplo_existing + g_consult.emplo_existing + p_nonresi.emplo_existing + 0)
        rp_p.demand_emplo_new = (r30.g_consult.demand_emplo_new + r30.p_buildings_total.demand_emplo_new +
                                 r30.s.demand_emplo_new + g_consult.demand_emplo_new + p_nonresi.demand_emplo_new + s.demand_emplo_new)
        ...
        rb.cost_climate_saved = ((rb.CO2e_total_2021_estimated - rb.CO2e_cb) *
                                 entry('In_M_duration_neutral') * fact('Fact_M_cost_per_CO2e_2020'))
