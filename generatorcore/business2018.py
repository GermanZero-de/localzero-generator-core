...
def calc(root, inputs: Inputs):
    ...
    b.s_lpg.energy = entry("In_B_lpg_fec")  # 3.007.222 MWh

    b.s_petrol.energy = entry("In_B_petrol_fec")  # 1.667.778 MWh

    b.s_jetfuel.energy = entry("In_B_jetfuel_fec")  # 284.722 MWh

    b.s_diesel.energy = entry("In_B_diesel_fec")  # 9.033.056 MWh

    b.s_fueloil.energy = entry("In_B_fueloil_fec")  # 33.370.278 MWh

    b.s_biomass.energy = entry("In_B_biomass_fec")  # 20.860.278 MWh

    b.s_coal.energy = entry("In_B_coal_fec")  # 232.778 MWh

    b.s_heatnet.energy = entry("In_B_heatnet_fec")  # 6.521.944 MWh
    ...
    b.s_heatpump.energy = entry("In_B_orenew_fec") * fact(
        "Fact_R_S_ratio_heatpump_to_orenew_2018"
    )  # 1.262.040 MWh

    b.s_solarth.energy = entry("In_B_orenew_fec") * (
    ...
    b.s_gas.pct_energy = div(b.s_gas.energy, b.s.energy)  # 52,5%

    b.s_lpg.pct_energy = div(b.s_lpg.energy, b.s.energy)  # 1,6%

    b.s_petrol.pct_energy = div(b.s_petrol.energy, b.s.energy)  # 0,9%

    b.s_jetfuel.pct_energy = div(b.s_jetfuel.energy, b.s.energy)  # 0,2%

    b.s_diesel.pct_energy = div(b.s_diesel.energy, b.s.energy)  # 4,8%

    b.s_fueloil.pct_energy = div(b.s_fueloil.energy, b.s.energy)  # 17,8%

    b.s_biomass.pct_energy = div(b.s_biomass.energy, b.s.energy)  # 11,1%

    b.s_coal.pct_energy = div(b.s_coal.energy, b.s.energy)  # 0,1%

    b.s_heatnet.pct_energy = div(b.s_heatnet.energy, b.s.energy)  # 3,5%

    b.s_elec_heating.pct_energy = div(b.s_elec_heating.energy, b.s_elec.energy)  # 6,9%

    b.s_heatpump.pct_energy = div(b.s_heatpump.energy, b.s.energy)  # 0,7%

    b.s_solarth.pct_energy = div(b.s_solarth.energy, b.s.energy)  # 0,5%

    b.s_elec.pct_energy = div(b.s_elec.energy, b.s.energy)
    ...
    b.p_nonresi_com.pct_x = ass(
        "Ass_H_ratio_municipal_non_res_buildings_to_all_non_res_buildings_2050"
    )
    b.p_nonresi_com.area_m2 = b.p_nonresi.area_m2 * b.p_nonresi_com.pct_x
    b.p_nonresi.energy = (
        b.s_gas.energy
        + b.s_lpg.energy
        + b.s_fueloil.energy
    ...
    b.p_nonresi_com.energy = b.p_nonresi.energy * b.p_nonresi_com.pct_x
    # 38.712.683 MWh
    ...
    b.p_nonresi_com.factor_adapted_to_fec = div(
    ...
    # Wärmepumpen
    b.p_elec_heatpump.energy = b.s_heatpump.energy / fact(
    ...
    b.p_vehicles.energy = b.s_petrol.energy + b.s_jetfuel.energy + b.s_diesel.energy
    b.p_other.energy = (
        b.p_elec_elcon.energy + b.p_elec_heatpump.energy + b.p_vehicles.energy
    )  # SUM(p_elec_elcon.energy:p_vehicles.energy)
    b.p.energy = b.p_nonresi.energy + b.p_other.energy
    b.p_nonresi.factor_adapted_to_fec = div(b.p_nonresi.energy, b.p_nonresi.area_m2)

    b.p_elec_elcon.demand_change = ass("Ass_R_D_fec_elec_elcon_change")

    b.p_vehicles.demand_change = ass("Ass_B_D_fec_vehicles_change")

    b.p_vehicles.demand_ediesel = b.p_vehicles.energy * (1 + b.p_vehicles.demand_change)
    ...
    b.s_gas.cost_fuel = b.s_gas.energy * b.s_gas.cost_fuel_per_MWh / Million

    b.s_lpg.cost_fuel = b.s_lpg.energy * b.s_lpg.cost_fuel_per_MWh / Million
    b.s_petrol.cost_fuel = b.s_petrol.energy * b.s_petrol.cost_fuel_per_MWh / Million
    b.s_jetfuel.cost_fuel = b.s_jetfuel.energy * b.s_jetfuel.cost_fuel_per_MWh / Million
    b.s_diesel.cost_fuel = b.s_diesel.energy * b.s_diesel.cost_fuel_per_MWh / Million
    b.s_fueloil.cost_fuel = b.s_fueloil.energy * b.s_fueloil.cost_fuel_per_MWh / Million
    b.s_biomass.cost_fuel = b.s_biomass.energy * b.s_biomass.cost_fuel_per_MWh / Million
    b.s_coal.cost_fuel = b.s_coal.energy * b.s_coal.cost_fuel_per_MWh / Million
    b.s_heatnet.cost_fuel = b.s_heatnet.energy * b.s_heatnet.cost_fuel_per_MWh / Million
    ...
    b.rp_p.CO2e_total = r.s.CO2e_cb + b.s.CO2e_cb
    b.rb.energy = r.p.energy + b.p.energy
    b.b.CO2e_cb = b.s.CO2e_cb
    b.rb.CO2e_cb = r.r.CO2e_cb + b.b.CO2e_cb
