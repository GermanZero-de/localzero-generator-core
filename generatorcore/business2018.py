...
def Business2018_calc(root):
    ...
    try:
        ...
        b.s_gas.pct_energy = b.s_gas.energy / b.s.energy  # 52,5%

        b.s_lpg.pct_energy = b.s_lpg.energy / b.s.energy  # 1,6%

        b.s_petrol.pct_energy = b.s_petrol.energy / b.s.energy  # 0,9%

        b.s_jetfuel.pct_energy = b.s_jetfuel.energy / b.s.energy  # 0,2%

        b.s_diesel.pct_energy = b.s_diesel.energy / b.s.energy  # 4,8%

        b.s_fueloil.pct_energy = b.s_fueloil.energy / b.s.energy  # 17,8%

        b.s_biomass.pct_energy = b.s_biomass.energy / b.s.energy  # 11,1%

        b.s_coal.pct_energy = b.s_coal.energy / b.s.energy  # 0,1%

        b.s_heatnet.pct_energy = b.s_heatnet.energy / b.s.energy  # 3,5%

        b.s_elec_heating.pct_energy = b.s_elec_heating.energy / b.s_elec.energy  # 6,9%

        b.s_heatpump.pct_energy = b.s_heatpump.energy / b.s.energy  # 0,7%

        b.s_solarth.pct_energy = b.s_solarth.energy / b.s.energy  # 0,5%

        b.s_elec.pct_energy = b.s_elec.energy / b.s.energy
        ...
        b.p_nonresi.factor_adapted_to_fec = b.p_nonresi.energy / b.p_nonresi.area_m2

        b.p_elec_elcon.demand_change = ass("Ass_R_D_fec_elec_elcon_change")

        b.p_vehicles.demand_change = ass("Ass_B_D_fec_vehicles_change")

        b.p_vehicles.demand_ediesel = b.p_vehicles.energy * (
            1 + b.p_vehicles.demand_change
        )
        ...
        b.s_jetfuel.cost_fuel_per_MWh = fact(
            "Fact_R_S_kerosine_energy_cost_factor_2018"
        )
