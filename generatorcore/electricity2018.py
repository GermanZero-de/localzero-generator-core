...
# Zeile Braunkohle
        ...
        p_fossil_coal_brown.cost_fuel = (
            p_fossil_coal_brown.cost_fuel_per_MWh *
            p_fossil_coal_brown.energy *  # check
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018') /
            1000000
...
# Zeile Steinkohle
        ...
        p_fossil_coal_black.cost_fuel = (
            p_fossil_coal_black.cost_fuel_per_MWh *
            p_fossil_coal_black.energy *  # check
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018') /
            1000000
...
# Zeile Photovoltaik Dach
        ...
        p_renew_pv_roof.cost_mro_per_MWh = (
            ...
            entry('In_E_pv_full_load_hours_sta') * 1000
            # result: 18,4 €/MWh
        )
        # 8
        p_renew_pv_roof.cost_mro = (
            p_renew_pv_roof.energy * p_renew_pv_roof.cost_mro_per_MWh *
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018') /
            Million
...
# Zeile PV Fassade
        ...
        p_renew_pv_facade.cost_mro = (
            p_renew_pv_facade.energy * p_renew_pv_facade.cost_mro_per_MWh *
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018') /
            Million
        )
# Zeile PV Freifläche
        ...
        p_renew_pv_park.cost_mro = (
            p_renew_pv_park.energy * p_renew_pv_park.cost_mro_per_MWh *
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018') /
            Million
...
# Zeile PV Agrar
        ...
        p_renew_pv_agri.cost_mro = (
            p_renew_pv_agri.energy * p_renew_pv_agri.cost_mro_per_MWh *
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018') /
            Million
            # result: 6,88 Mio €/d_a
        )
...
# Zeile p_renew_wind 2
        ...
        p_renew_wind.cost_mro = (
            p_renew_wind_onshore.cost_mro +  # Todo Check
            p_renew_wind_offshore.cost_mro
...
# Zeile Laufwasser
        ...
        p_renew_hydro.cost_mro = (
            p_renew_hydro.energy * p_renew_hydro.cost_mro_per_MWh *
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018') / Million
        )
...
# Biomasse Lokal
        ...
        p_local_biomass.CO2e_cb_per_MWh = (
            fact('Fact_E_P_climate_neutral_ratio_CO2e_cb_to_fec') *
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018')
        )
 ...
 # Biomasse KWK Wärme
        ...
        p_local_biomass_cogen.pct_energy = (
            fact('Fact_E_P_renew_cogen_ratio_2018')
        )
        # result: 29,7%
...
# Lokale Bruttostromerzeugung
        ...
        p_fossil.CO2e_cb_per_MWh = (
            p_fossil.CO2e_cb / p_fossil.energy
        )
        ...
        p_renew_pv_roof.CO2e_cb_per_MWh = (
            fact('Fact_E_P_climate_neutral_ratio_CO2e_cb_to_fec') *
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018')
        )
        p_renew_pv_facade.CO2e_cb_per_MWh = (
            fact('Fact_E_P_climate_neutral_ratio_CO2e_cb_to_fec') *
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018')
        )
        p_renew_pv_park.CO2e_cb_per_MWh = (
            fact('Fact_E_P_climate_neutral_ratio_CO2e_cb_to_fec') *
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018')
        )
        p_renew_pv_agri.CO2e_cb_per_MWh = (
            fact('Fact_E_P_climate_neutral_ratio_CO2e_cb_to_fec') *
            fact('Fact_E_P_ratio_gross_electricity_prod_to_fec_electricity_2018')
        )
        ...
        p.CO2e_total = (
            p_fossil.CO2e_total + p_renew.CO2e_total
        )
        e.CO2e_total = p.CO2e_total

        p_fossil_and_renew.energy = p.energy
        p_fossil_and_renew.CO2e_cb = (
            p_fossil.CO2e_cb + p_renew.CO2e_cb
        )
        p_fossil_and_renew.CO2e_cb_per_MWh = (
            p_fossil_and_renew.CO2e_cb / p_fossil_and_renew.energy
        )
        p_fossil_and_renew.CO2e_total = (
            p_fossil.CO2e_total + p_renew.CO2e_total
        )

        p_fossil_and_renew.pct_energy = (
            p_fossil.pct_energy + p_renew.pct_energy
        )
        p_renew.CO2e_cb_per_MWh = (
            p_renew.CO2e_cb / p_renew.energy
        )
        p_local.pct_energy = (
            p_local.energy / p.energy
        )
