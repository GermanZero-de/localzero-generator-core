...
def make_entries(data: refdata.RefData, ags: str, year: int):
    ...
    bioenergy_installable_capacity_sta = (
        div(potential_electricity_from_bioenergy_sta, data.fact("Fact_E_P_biomass_full_load_hours"))
    )
    entry[
    ...
    entry["In_R_coal_fec"] = (
        ...
        * div(entry["In_R_flats_wo_heatnet"], data.fact("Fact_R_P_flats_wo_heatnet_2011"))
    )
    ...
    entry["In_R_elec_fec"] = (
        ...
        *div( entry["In_M_population_com_2018"], entry["In_M_population_nat"])
    )
    entry["In_R_heatnet_fec"] = (
        data.fact("Fact_R_S_heatnet_fec_2018")
        *div( entry["In_R_flats_w_heatnet"] , data.fact("Fact_R_P_flats_w_heatnet_2011"))
    )
