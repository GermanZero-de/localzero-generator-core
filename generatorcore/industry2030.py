...
def Industry2030_calc(root: Generator):
    ...
    p_chem_basic.prod_volume = (
        root.i18.p_chem_basic.prod_volume * (1 + p_chem_basic.demand_change)
    )
    p_chem_basic.demand_electricity = (
        p_chem_basic.prod_volume * ass("Ass_I_P_chem_basic_wo_ammonia_fec_factor_electricity_2050")
    )
    p_chem_basic.demand_emethan = (
        p_chem_basic.prod_volume * ass('Ass_I_P_chem_basic_wo_ammonia_fec_factor_other_energie_2050')
    )
    p_chem_basic.energy = (
        p_chem_basic.demand_electricity + p_chem_basic.demand_emethan
    )

    p_chem_basic.CO2e_cb_per_t = ass('Ass_I_P_chem_basic_ratio_CO2e_cb_to_prodvol_2050')
    p_chem_basic.CO2e_cb = (
        p_chem_basic.prod_volume * p_chem_basic.CO2e_cb_per_t
    )
    ...
    p_chem_basic.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    ...
    p_chem_ammonia.demand_electricity = (
        p_chem_ammonia.prod_volume * ass("Ass_I_P_chem_ammonia_fec_factor_electricity_2050")
    )
    ...
    p_chem_ammonia.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    ...
    p_chem_other.demand_electricity = (
        p_chem_other.prod_volume * ass("Ass_I_P_chem_other_fec_factor_electricity_2050")
    )
    p_chem_other.demand_emethan = (
        p_chem_other.prod_volume * ass('Ass_I_P_chem_other_fec_factor_other_energie_2050')
    )
    p_chem_other.energy = (
        p_chem_other.demand_electricity + p_chem_other.demand_emethan
    )
    p_chem_other.CO2e_cb_per_t = ass('Ass_I_P_chem_other_ratio_CO2e_cb_to_prodvol_2050')
    p_chem_other.CO2e_cb = (
        p_chem_other.prod_volume * p_chem_other.CO2e_cb_per_t
    )
    ...
    p_chem_other.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    ...
    p_chem.change_energy_pct = (
        p_chem.change_energy_MWh / root.i18.p_chem.energy
    )
    ...
    p_chem.change_CO2e_pct = (
        p_chem.change_CO2e_t / root.i18.p_chem.CO2e_total
    )
    ...
    p_metal_steel_primary.demand_electricity = (
        ...
        (ass('Ass_I_P_metal_steel_primary_ratio_fec_to_prodvol_electricity_2030') +
         ass('Ass_I_P_metal_steel_further_processing_ratio_fec_to_prodvol_electricity_2030'))
    )
    p_metal_steel_primary.demand_hydrogen = (
        p_metal_steel_primary.prod_volume *
        ass('Ass_I_P_metal_steel_primary_ratio_fec_to_prodvol_hydrogen_2030')
    )
    p_metal_steel_primary.energy = (
        p_metal_steel_primary.demand_electricity + p_metal_steel_primary.demand_hydrogen
    )
    # CO2 Emissions
    p_metal_steel_primary.CO2e_pb_per_t = ass('Ass_I_P_metal_steel_primary_ratio_CO2e_pb_to_rodvol_2030')
    p_metal_steel_primary.CO2e_pb = (
        p_metal_steel_primary.prod_volume * p_metal_steel_primary.CO2e_pb_per_t
    )
    p_metal_steel_primary.CO2e_cb_per_t = (
        ass('Ass_I_P_metal_steel_primary_ratio_CO2e_eb_to_rodvol_2030') +
    ...
    p_metal_steel_primary.pct_of_wage = fact('Fact_I_P_constr_civil_revenue_pct_of_wage_2018')
    p_metal_steel_primary.cost_wage = (
        p_metal_steel_primary.invest_pa * p_metal_steel_primary.pct_of_wage
    )
    p_metal_steel_primary.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    ...
    # CO2 Emissions
    p_metal_steel_secondary.CO2e_pb_per_t = ass('Ass_I_P_metal_steel_secundary_ratio_CO2e_pb_to_rodvol_2030')
    p_metal_steel_secondary.CO2e_pb = (
        p_metal_steel_secondary.prod_volume * p_metal_steel_secondary.CO2e_pb_per_t
    )
    p_metal_steel_secondary.CO2e_cb_per_t = (
        ass('Ass_I_P_metal_steel_secundary_ratio_CO2e_eb_to_rodvol_2030') +
        ass('Ass_I_P_metal_steel_further_production_ratio_CO2e_eb_to_rodvol_2030')
    )
    ...
    p_metal_steel_secondary.change_CO2e_t = (
        (p_metal_steel_secondary.CO2e_pb + p_metal_steel_secondary.CO2e_cb) -
        (root.i18.p_metal_steel_secondary.CO2e_pb + root.i18.p_metal_steel_secondary.CO2e_cb)
    )
    ...
    p_metal_steel_secondary.pct_of_wage = fact('Fact_I_P_constr_civil_revenue_pct_of_wage_2018')
    p_metal_steel_secondary.cost_wage = (
        p_metal_steel_secondary.invest_pa * p_metal_steel_secondary.pct_of_wage
    )
    p_metal_steel_secondary.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    ...
    p_metal_nonfe.demand_electricity = (
        p_metal_nonfe.prod_volume *
        ass('Ass_I_P_metal_nonfe_ratio_fec_to_prodvol_electricity_2035')
    )
    p_metal_nonfe.demand_biomass = (
        p_metal_nonfe.prod_volume * ass('Ass_I_P_metal_nonfe_ratio_fec_to_prodvol_biomass_2035')
    )
    p_metal_nonfe.demand_hydrogen = (
        p_metal_nonfe.prod_volume * ass('Ass_I_P_metal_nonfe_ratio_fec_to_prodvol_hydrogen_2035')
    )
    ...
    p_metal_nonfe.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    ...
    p_other_paper.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    ...
    p_other_food.CO2e_cb_per_t = ass(
    ...
    p_other_food.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    ...
    p_other_further.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    ...
    p_other_2efgh.CO2e_pb = (
        p_other_further.energy * p_other_2efgh.CO2e_pb_per_MWh
    )
    ...
    p_other_2efgh.invest = (
        (root.i18.p_other_2efgh.CO2e_pb - p_other_2efgh.CO2e_pb) * p_other_2efgh.invest_per_x
    )
    ...
    p_other_2efgh.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    ...
    p_miner_cement.CO2e_pb_per_t = ass('Ass_I_P_miner_cement_ratio_CO2e_pb_to_prodvol_2050')
    p_miner_cement.CO2e_cb_per_t = ass('Ass_I_P_miner_cement_ratio_CO2e_cb_to_prodvol_2050')
    p_miner_cement.demand_change = ass('Ass_I_P_miner_cement_prodvol_change')
    p_miner_cement.prod_volume = (
        i18.p_miner_cement.prod_volume * (1 + p_miner_cement.demand_change)
    )
    p_miner_cement.demand_emethan = (
        ass('Ass_I_P_miner_cement_ratio_fec_gas_to_prodvol_2050') * p_miner_cement.prod_volume
    )

    p_miner_ceram = root.i30.p_miner_ceram

    p_miner_ceram.CO2e_pb_per_t = (
        ass('Ass_I_P_miner_ceramic_ratio_CO2e_pb_to_prodvol_2050')
    )
    p_miner_cement.CO2e_pb = (
        p_miner_cement.prod_volume * p_miner_cement.CO2e_pb_per_t
    )
    p_miner_cement.CO2e_total_2021_estimated = (
        (i18.p_miner_cement.CO2e_pb + i18.p_miner_cement.CO2e_cb) * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
    )
    p_miner_cement.CO2e_cb = (
        p_miner_cement.prod_volume * p_miner_cement.CO2e_cb_per_t
    )

    g_consult = root.i30.g_consult

    g_consult.invest_pa = (
        ass('Ass_I_G_advice_invest_pa_per_capita') * entry('In_M_population_com_2018')
    )
    g_consult.invest_pa_com = g_consult.invest_pa
    g_consult.invest = (
        g_consult.invest_pa * entry('In_M_duration_target')
    )
    g_consult.invest_com = g_consult.invest
    g_consult.pct_of_wage = ass('Ass_I_G_advice_invest_pct_of_wage')
    g_consult.cost_wage = (
        g_consult.invest_pa * g_consult.pct_of_wage
    )
    g_consult.ratio_wage_to_emplo = ass('Ass_T_C_yearly_costs_per_planer')
    g_consult.demand_emplo = (
        g_consult.cost_wage / g_consult.ratio_wage_to_emplo
    )
    ...
    p_miner_cement.invest_per_x = ass('Ass_I_P_miner_cement_kirchdorf_ratio_invest_to_prodvol_2020')
    g.invest = (
        g_consult.invest_pa * entry('In_M_duration_target')
    )
    g.invest_com = g_consult.invest
    p_miner_cement.invest = (
        p_miner_cement.prod_volume * p_miner_cement.invest_per_x
    )
    g.cost_wage = (
        g_consult.invest_pa * ass('Ass_I_G_advice_invest_pct_of_wage')
    )
    g.demand_emplo = (
        g_consult.cost_wage / g_consult.ratio_wage_to_emplo
    )
    ...
    p_miner_cement.invest_pa = (
        p_miner_cement.invest / entry('In_M_duration_target')
    )
    p_miner_cement.cost_wage = (
        p_miner_cement.invest_pa * p_miner_cement.pct_of_wage
    )
    p_miner_cement.demand_electricity = (
        ass('Ass_I_P_miner_cement_ratio_fec_elec_to_prodvol_2050') * p_miner_cement.prod_volume
    )
    ...
    p_miner_ceram.prod_volume = (
        i18.p_miner_ceram.prod_volume * (1 + p_miner_ceram.demand_change)
    )
    p_miner_ceram.CO2e_pb = (
        p_miner_ceram.prod_volume * p_miner_ceram.CO2e_pb_per_t
    )
    ...
    p_miner_chalk.CO2e_pb_per_t = ass('Ass_I_P_miner_chalk_ratio_CO2e_pb_to_prodvol_2050')
    p_miner_chalk.CO2e_pb = (
        p_miner_chalk.prod_volume * p_miner_chalk.CO2e_pb_per_t
    )
    ...
    p_miner_glas.prod_volume = (
        i18.p_miner_glas.prod_volume * (1 + p_miner_glas.demand_change)
    )
    p_miner_glas.CO2e_pb_per_t = (ass('Ass_I_P_miner_glass_ratio_CO2e_pb_to_prodvol_2050'))
    ...
    p_miner_ceram.CO2e_cb_per_t = ass('Ass_I_P_miner_ceramic_ratio_CO2e_cb_to_prodvol_2050')
    ...
    p_miner_cement.change_energy_MWh = (
        p_miner_cement.energy - i18.p_miner_cement.energy
    )
    p_miner_ceram.CO2e_cb = (
        p_miner_ceram.prod_volume * p_miner_ceram.CO2e_cb_per_t
    )
    ...
    p_miner_ceram.CO2e_total_2021_estimated = (
        (i18.p_miner_ceram.CO2e_pb + i18.p_miner_ceram.CO2e_cb) * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
    )
    p_miner_cement.cost_climate_saved = (
        (p_miner_cement.CO2e_total_2021_estimated - (p_miner_cement.CO2e_pb + p_miner_cement.CO2e_cb)) *
        entry('In_M_duration_neutral') * fact('Fact_M_cost_per_CO2e_2020')
    )
    p_miner_ceram.invest = (
        p_miner_ceram.prod_volume * p_miner_ceram.invest_per_x
    )
    p_miner_cement.invest_pa_outside = p_miner_cement.invest_pa

    p_miner_chalk.invest_per_x = ass('Ass_I_P_miner_chalk_vockerode_ratio_invest_to_prodvol_2018')
    p_miner_chalk.invest = (
        p_miner_chalk.prod_volume * p_miner_chalk.invest_per_x
    )
    p_miner_glas.invest_per_x = ass('Ass_I_P_miner_glass_furnace_ratio_invest_to_prodvol_2021')
    p_miner_glas.invest = (
        p_miner_glas.prod_volume * p_miner_glas.invest_per_x
    )
    p_miner.invest = (
        p_miner_cement.invest +
        p_miner_chalk.invest +
    ...
    p_miner_ceram.invest_pa = (
        p_miner_ceram.invest / entry('In_M_duration_target')
    )
    p_miner_cement.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    p.emplo_existing = (
        fact('Fact_I_P_constr_civil_emplo_2018') * entry('In_M_population_com_2018') / entry('In_M_population_nat')
    )
    ...
    p_miner_ceram.demand_electricity = (
        p_miner_ceram.prod_volume * ass('Ass_I_P_miner_ceramic_ratio_fec_elec_to_prodvol_2050')
    )
    p_miner_ceram.demand_hydrogen = (
        p_miner_ceram.prod_volume * ass('Ass_I_P_miner_ceramic_ratio_fec_hydrogen_to_prodvol_2050')
    )
    p_miner_ceram.demand_biomass = (
        p_miner_ceram.prod_volume * ass('Ass_I_P_miner_ceramic_ratio_fec_biomass_to_prodvol_2050')
    )
    p_metal.prod_volume = (
        p_metal_steel.prod_volume + p_metal_nonfe.prod_volume
    )

    p_miner_chalk.CO2e_cb_per_t = ass('Ass_I_P_miner_chalk_ratio_CO2e_cb_to_prodvol_2050')
    p_miner_chalk.CO2e_cb = (
        p_miner_chalk.prod_volume * p_miner_chalk.CO2e_cb_per_t
    )
    p_miner_glas.CO2e_cb_per_t = ass('Ass_I_P_miner_glass_ratio_CO2e_cb_to_prodvol_2050')
    p_miner_glas.CO2e_cb = (
        p_miner_glas.prod_volume * p_miner_glas.CO2e_cb_per_t
    )
    p_miner.CO2e_cb = (
        p_miner_cement.CO2e_cb +
        p_miner_chalk.CO2e_cb +
    ...
    p.CO2e_cb = (
        p_miner.CO2e_cb + p_chem.CO2e_cb + p_metal.CO2e_cb + p_other.CO2e_cb
    )
    p_miner_ceram.CO2e_total = (
        p_miner_ceram.CO2e_pb + p_miner_ceram.CO2e_cb
    )
    p_miner_ceram.energy = (
        p_miner_ceram.demand_electricity + p_miner_ceram.demand_biomass + p_miner_ceram.demand_hydrogen
    )
    p_miner_ceram.change_energy_MWh = (
        p_miner_ceram.energy - i18.p_miner_ceram.energy
    )
    ...
    p_miner_ceram.cost_climate_saved = (
        (p_miner_ceram.CO2e_total_2021_estimated - (p_miner_ceram.CO2e_pb + p_miner_ceram.CO2e_cb)) *
        entry('In_M_duration_neutral') * fact('Fact_M_cost_per_CO2e_2020')
    )
    p_chem.invest_pa = (
        p_chem_basic.invest_pa +
        p_chem_ammonia.invest_pa +
        p_chem_other.invest_pa
    ...
    p.invest = (
        p_miner.invest + p_chem.invest + p_metal.invest + p_other.invest
    )
    ...
    p_chem.cost_wage = (
        p_chem_basic.cost_wage +
        p_chem_ammonia.cost_wage +
        p_chem_other.cost_wage
    ...
    p_miner_chalk.demand_electricity = (
        p_miner_chalk.prod_volume * ass('Ass_I_P_miner_chalk_ratio_fec_elec_to_prodvol_2050')
    )
    p_miner_chalk.demand_emethan = (
        p_miner_chalk.prod_volume *
        ass('Ass_I_P_miner_chalk_ratio_fec_gas_to_prodvol_2050')
    )
    p_miner_chalk.energy = (
        p_miner_chalk.demand_electricity + p_miner_chalk.demand_emethan
    )
    p_miner_chalk.change_energy_MWh = (
        p_miner_chalk.energy - i18.p_miner_chalk.energy
    )
    p_miner_glas.demand_electricity = (
        p_miner_glas.prod_volume *
        ass('Ass_I_P_miner_glass_ratio_fec_elec_to_prodvol_2050')
    )
    p_miner_glas.energy = p_miner_glas.demand_electricity
    p_miner_glas.change_energy_MWh = (
        p_miner_glas.energy - i18.p_miner_glas.energy
    )
    ...
    p_miner.change_energy_pct = (
        p_miner.change_energy_MWh / i18.p_miner.energy
    )
    p.change_energy_MWh = (
        p_miner.change_energy_MWh +
        p_chem.change_energy_MWh +
    ...
    p.change_energy_pct = (
        p.change_energy_MWh / i18.p.energy
    )
    p.change_CO2e_t = (
        (p.CO2e_pb + p.CO2e_cb) - (i18.p.CO2e_pb + i18.p.CO2e_cb)
    )
    ...
    p.change_CO2e_pct = (
        p.change_CO2e_t / i18.p.CO2e_total
    )
    ...
    p_miner_chalk.invest_pa = (
        p_miner_chalk.invest / entry('In_M_duration_target')
    )
    p_miner_glas.invest_pa = (
        p_miner_glas.invest / entry('In_M_duration_target')
    )
    p_miner.invest_pa = (
        p_miner_cement.invest_pa +
        p_miner_chalk.invest_pa +
    ...
    p_miner_ceram.cost_wage = (
        p_miner_ceram.invest_pa * p_miner_ceram.pct_of_wage
    )
    p_miner_ceram.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    ...
    p_miner_chalk.cost_wage = (
        p_miner_chalk.invest_pa * p_miner_chalk.pct_of_wage
    )
    p_miner_chalk.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    p_miner_chalk.demand_emplo = (
        p_miner_chalk.cost_wage / p_miner_chalk.ratio_wage_to_emplo
    )
    p_miner_glas.ratio_wage_to_emplo = fact('Fact_I_P_constr_civil_ratio_wage_to_emplo_2018')
    p_miner_glas.pct_of_wage = fact('Fact_I_P_constr_civil_revenue_pct_of_wage_2018')
    p_miner_glas.cost_wage = (
        p_miner_glas.invest_pa * p_miner_glas.pct_of_wage
    )
    ...
    p.demand_emplo = (p_miner.demand_emplo + p_chem.demand_emplo + p_metal.demand_emplo + p_other.demand_emplo)
    ...
    p_miner.change_CO2e_pct = (
        p_miner.change_CO2e_t / i18.p_miner.CO2e_total
    )
    ...
    p_metal.invest_outside = (
        p_metal_steel.invest_outside + p_metal_nonfe.invest_outside
    )
    p_miner.cost_wage = (
        p_miner_cement.cost_wage +
        p_miner_chalk.cost_wage +
    ...
    p.demand_emplo_new = (
        p.demand_emplo - p.emplo_existing
    )
    i.demand_emplo = (
        g.demand_emplo + p.demand_emplo
    )
    i.demand_emplo_new = (
        g.demand_emplo_new + p.demand_emplo_new
    )
    p_metal_steel.demand_electricity = (
        p_metal_steel_primary.demand_electricity +
        p_metal_steel_secondary.demand_electricity
    )
    p_chem.demand_emethan = (
        p_chem_basic.demand_emethan +
        p_chem_other.demand_emethan
    )
    p_other.invest_pa = (
    ...
    p_chem_ammonia.CO2e_cb_per_t = ass('Ass_I_P_chem_ammonia_ratio_CO2e_cb_to_prodvol_2050')
    ...
    p.demand_biomass = (
        p_miner.demand_biomass + p_metal.demand_biomass
    )
    p_metal.demand_hydrogen = (
        p_metal_steel_primary.demand_hydrogen + p_metal_nonfe.demand_hydrogen
    )
    p.prod_volume = (
        p_miner.prod_volume + p_chem.prod_volume +
        p_metal.prod_volume + p_other.prod_volume
    )
    p.invest_pa = (
        p_miner.invest_pa + p_chem.invest_pa +
        p_metal.invest_pa + p_other.invest_pa
    )
    p.invest_pa_outside = (
        p_miner.invest_pa_outside + p_chem.invest_pa_outside +
        p_metal.invest_pa_outside + p_other.invest_pa_outside
    )
    ...
    p.cost_wage = (
        p_miner.cost_wage + p_chem.cost_wage +
        p_metal.cost_wage + p_other.cost_wage
    )
    p.demand_electricity = (
        p_miner.demand_electricity + p_chem.demand_electricity +
        p_metal.demand_electricity + p_other.demand_electricity
    )
    p.demand_heatnet = p_other.demand_heatnet
    p_other_further.demand_emethan = (
        p_other_further.energy * ass('Ass_I_P_other_further_fec_pct_of_gas_2050')
    )
    i.invest_pa = (
        g.invest_pa + p.invest_pa
    )
    i.invest_pa_outside = p.invest_pa_outside
    p.invest_outside = (
        p_miner.invest_outside + p_chem.invest_outside +
        p_metal.invest_outside + p_other.invest_outside)
    i.cost_wage = (
        g.cost_wage + p.cost_wage
    )
    p_other_paper.CO2e_pb_per_t = fact('Fact_I_P_other_paper_ratio_CO2e_pb_to_prodvol_2018')
    p_other_paper.CO2e_pb = (
        p_other_paper.prod_volume * p_other_paper.CO2e_pb_per_t
    )
    p_other_food.CO2e_pb_per_t = fact('Fact_I_P_other_food_ratio_CO2e_pb_to_prodvol_2018')
    p_other_food.CO2e_pb = (
        p_other_food.prod_volume * p_other_food.CO2e_pb_per_t
    )
    ...
    p.demand_hydrogen = (
        p_miner.demand_hydrogen + p_metal.demand_hydrogen
    )
    ...
    s_renew.energy = (
        s_renew_hydrogen.energy + s_renew_emethan.energy +
        s_renew_biomass.energy + s_renew_heatnet.energy +
        s_renew_elec.energy)
    s = root.i30.s
