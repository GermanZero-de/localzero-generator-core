...
def calc_Z(root, inputs: Inputs):
    ...
    s.CO2e_total_2021_estimated = s.CO2e_total_18 * fact("Fact_M_CO2e_wo_lulucf_2021_vs_2018")
    d.CO2e_total_2021_estimated = d.CO2e_total_18 * fact("Fact_M_CO2e_wo_lulucf_2021_vs_2018")
    z.CO2e_total_2021_estimated = s.CO2e_total_2021_estimated + d.CO2e_total_2021_estimated

    s.cost_climate_saved = (s.CO2e_total_2021_estimated - s.CO2e_total_30) * entry("In_M_duration_neutral") * fact("Fact_M_cost_per_CO2e_2020")
    d.cost_climate_saved = (d.CO2e_total_2021_estimated - d.CO2e_total_30) * entry("In_M_duration_neutral") * fact("Fact_M_cost_per_CO2e_2020")
