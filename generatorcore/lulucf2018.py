...
def Lulucf2018_calc(root):
    ...
    try:
        ...
        g_forest_managed.CO2e_pb_per_t = (
            fact('Fact_L_G_forest_conv_CO2e_per_ha_2018')
        )
        g_forest_managed.CO2e_cb_per_t = (
            fact('Fact_L_G_forest_CO2e_cb_per_ha_2018')
        )
        ...
        g_grass.area_ha = (
            entry('In_M_area_agri_com') *
            fact('Fact_L_G_factor_crop_to_grass') +
        ...
        g_grass_min_conv.pct_x = (
            fact('Fact_L_G_fraction_minrl_soil_grass_strict')
        )
        ...
        g_wet.area_ha = (
            entry('In_M_area_veg_moor_com') +
            entry('In_M_area_water_com') *
        ...
        g_grove_org_low.pct_x = (
            fact('Fact_L_G_fraction_org_soil_fen_grass_woody')
        )
        ...
        g_grove_org_high.pct_x = (
            fact('Fact_L_G_fraction_org_soil_bog_grass_woody')
        )
        ...
        g_water.area_ha = (
            entry('In_M_area_water_com') *
            fact('Fact_L_G_factor_wetland_water')
        )
        g_water_min.CO2e_pb_per_t = (
            fact('Fact_L_G_wetland_water_minrl_soil_ord_CO2e_per_ha_2018')
        )
        g_water_min.pct_x = (
            fact('Fact_L_G_fraction_minrl_soil_wetland_water')
        )
        g_wet_org_low.pct_x = (
            fact('Fact_L_G_fraction_org_soil_fen_wetland_peat')
        )
        ...
        g_wet_org_high.pct_x = (
            fact('Fact_L_G_fraction_org_soil_bog_wetland_peat')
        )
        ...
        g_settlement.area_ha = (
            entry('In_M_area_settlement_com') +
            entry('In_M_area_transport_com')
        )
        g_settlement_min.CO2e_pb_per_t = (
            fact('Fact_L_G_settl_minrl_soil_CO2e_per_ha_2018')
        )
        g_settlement_min.pct_x = (fact('Fact_L_G_fraction_minrl_soil_settl'))

        g_water_min_low.pct_x = (
            fact('Fact_L_G_fraction_org_soil_fen_wetland_water')
        )
        ...
        g_water_min_high.pct_x = (
            fact('Fact_L_G_fraction_org_soil_bog_wetland_water')
        )
        ...
        g_settlement_org_low.pct_x = (
            fact('Fact_L_G_fraction_org_soil_fen_settl')
        )
        ...
        g_settlement_org_high.pct_x = (
            fact('Fact_L_G_fraction_org_soil_bog_settl')
        )
