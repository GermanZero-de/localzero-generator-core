...
@dataclass
class R30:
    g: RColVars2030 = field(default_factory=RColVars2030)
    g_consult: RColVars2030 = field(default_factory=RColVars2030)
    p: RColVars2030 = field(default_factory=RColVars2030)
    p_buildings_total: RColVars2030 = field(default_factory=RColVars2030)
    p_buildings_until_1919: RColVars2030 = field(default_factory=RColVars2030)
    p_buildings_1919_1948: RColVars2030 = field(default_factory=RColVars2030)
    p_buildings_1949_1978: RColVars2030 = field(default_factory=RColVars2030)
    p_buildings_1979_1995: RColVars2030 = field(default_factory=RColVars2030)
    p_buildings_1996_2004: RColVars2030 = field(default_factory=RColVars2030)
    p_buildings_2005_2011: RColVars2030 = field(default_factory=RColVars2030)
    p_buildings_2011_today: RColVars2030 = field(default_factory=RColVars2030)
    p_buildings_new: RColVars2030 = field(default_factory=RColVars2030)
    p_buildings_area_m2_com: RColVars2030 = field(default_factory=RColVars2030)
    r: RColVars2030 = field(default_factory=RColVars2030)
    s: RColVars2030 = field(default_factory=RColVars2030)
    s_fueloil: RColVars2030 = field(default_factory=RColVars2030)
    s_lpg: RColVars2030 = field(default_factory=RColVars2030)
    s_biomass: RColVars2030 = field(default_factory=RColVars2030)
    s_coal: RColVars2030 = field(default_factory=RColVars2030)
    s_petrol: RColVars2030 = field(default_factory=RColVars2030)
    s_heatnet: RColVars2030 = field(default_factory=RColVars2030)
    s_solarth: RColVars2030 = field(default_factory=RColVars2030)
    s_heatpump: RColVars2030 = field(default_factory=RColVars2030)
    s_gas: RColVars2030 = field(default_factory=RColVars2030)
    s_elec_heating: RColVars2030 = field(default_factory=RColVars2030)
    s_emethan: RColVars2030 = field(default_factory=RColVars2030)
    s_elec: RColVars2030 = field(default_factory=RColVars2030)
    r: RColVars2030 = field(default_factory=RColVars2030)
    p_elec_elcon: RColVars2030 = field(default_factory=RColVars2030)
    p_elec_heatpump: RColVars2030 = field(default_factory=RColVars2030)
    p_other: RColVars2030 = field(default_factory=RColVars2030)
    p_vehicles: RColVars2030 = field(default_factory=RColVars2030)
...
def calc(inputs: Inputs, *, r18: residences2018.R18, b18: business2018.B18) -> R30:
    ...
    if p_buildings_total.energy-s_solarth.energy-s_heatpump.energy < r18.s_biomass.energy+r18.s_heatnet.energy+r18.s_elec_heating.energy:
        s_biomass.energy = r18.s_biomass.energy * div(p_buildings_total.energy-s_solarth.energy-s_heatpump.energy,r18.s_biomass.energy+r18.s_heatnet.energy+r18.s_elec_heating.energy)
    else:
    ...
    if p_buildings_total.energy-s_solarth.energy-s_heatpump.energy < r18.s_biomass.energy+r18.s_heatnet.energy+r18.s_elec_heating.energy:
        s_heatnet.energy = r18.s_heatnet.energy * div(p_buildings_total.energy-s_solarth.energy-s_heatpump.energy,r18.s_biomass.energy+r18.s_heatnet.energy+r18.s_elec_heating.energy)
    else:
    ...
    s_emethan.energy = max(0, p_buildings_total.energy - (sum_fueloil_to_heatpump_energy + s_elec_heating.energy))
    ...
    s.change_CO2e_pct = div(s.change_CO2e_t, r18.s.CO2e_cb)
    ...
    s_fueloil.change_CO2e_pct = div(s_fueloil.change_CO2e_t, r18.s_fueloil.CO2e_cb)
    s_biomass.CO2e_total = s_biomass.CO2e_cb
    s_lpg.CO2e_total_2021_estimated = r18.s_lpg.CO2e_cb * fact(
        "Fact_M_CO2e_wo_lulucf_2021_vs_2018"
    )
    s_lpg.change_CO2e_pct = div(s_lpg.change_CO2e_t, r18.s_lpg.CO2e_cb)
    s_coal.CO2e_total = s_coal.CO2e_cb
    s_biomass.CO2e_total_2021_estimated = r18.s_biomass.CO2e_cb * fact(
        "Fact_M_CO2e_wo_lulucf_2021_vs_2018"
    )
    s_biomass.change_CO2e_pct = div(s_biomass.change_CO2e_t, r18.s_biomass.CO2e_cb)
    s_petrol.CO2e_total = s_petrol.CO2e_cb
    s_coal.CO2e_total_2021_estimated = r18.s_coal.CO2e_cb * fact(
        "Fact_M_CO2e_wo_lulucf_2021_vs_2018"
    )
    s_coal.change_CO2e_pct = div(s_coal.change_CO2e_t, r18.s_coal.CO2e_cb)
    s_heatnet.CO2e_total = s_heatnet.CO2e_cb
    s_petrol.CO2e_total_2021_estimated = r18.s_petrol.CO2e_cb * fact(
        "Fact_M_CO2e_wo_lulucf_2021_vs_2018"
    )
    s_petrol.change_CO2e_pct = div(s_petrol.change_CO2e_t, r18.s_petrol.CO2e_cb)
    ...
    s_gas.change_CO2e_pct = div(s_gas.change_CO2e_t, r18.s_gas.CO2e_cb)
