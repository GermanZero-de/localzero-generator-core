...
#    root.a30.p_operation_heat.demand_emplo = exl['a30']['p_operation_heat']['demand_emplo']
    ...
    try:
        ...
        p_buildings_new.pct_x = max(entry('In_M_population_com_203X') / entry('In_M_population_com_2018') - 1, 0)

        p_buildings_new.area_m2 = p_buildings_total.area_m2 * p_buildings_new.pct_x

        p_buildings_until_1919.area_m2_rehab = p_buildings_until_1919.pct_rehab * p_buildings_until_1919.area_m2
        p_buildings_1919_1948.area_m2_rehab = p_buildings_1919_1948.pct_rehab * p_buildings_1919_1948.area_m2
        p_buildings_1949_1978.area_m2_rehab = p_buildings_1949_1978.pct_rehab * p_buildings_1949_1978.area_m2
        p_buildings_1979_1995.area_m2_rehab = p_buildings_1979_1995.pct_rehab * p_buildings_1979_1995.area_m2
        p_buildings_1996_2004.area_m2_rehab = p_buildings_1996_2004.pct_rehab * p_buildings_1996_2004.area_m2
        p_buildings_2005_2011.area_m2_rehab = p_buildings_2005_2011.pct_rehab * p_buildings_2005_2011.area_m2
        p_buildings_2011_today.area_m2_rehab = p_buildings_2011_today.pct_rehab * p_buildings_2011_today.area_m2
        ...
        p_buildings_area_m2_com.area_m2_rehab = p_buildings_total.area_m2_rehab * r18.p_buildings_area_m2_com.pct_x

        p_buildings_total.pct_rehab = p_buildings_total.area_m2_rehab / r18.p_buildings_total.area_m2
        ...
        p_buildings_until_1919.area_m2_nonrehab = p_buildings_until_1919.pct_nonrehab * p_buildings_until_1919.area_m2
        p_buildings_1919_1948.area_m2_nonrehab = p_buildings_1919_1948.pct_nonrehab * p_buildings_1919_1948.area_m2
        p_buildings_1949_1978.area_m2_nonrehab = p_buildings_1949_1978.pct_nonrehab * p_buildings_1949_1978.area_m2
        p_buildings_1979_1995.area_m2_nonrehab = p_buildings_1979_1995.pct_nonrehab * p_buildings_1979_1995.area_m2
        p_buildings_1996_2004.area_m2_nonrehab = p_buildings_1996_2004.pct_nonrehab * p_buildings_1996_2004.area_m2
        p_buildings_2005_2011.area_m2_nonrehab = p_buildings_2005_2011.pct_nonrehab * p_buildings_2005_2011.area_m2
        p_buildings_2011_today.area_m2_nonrehab = p_buildings_2011_today.pct_nonrehab * p_buildings_2011_today.area_m2
        ...
        p_buildings_until_1919.demand_heat_nonrehab = (
            p_buildings_until_1919.area_m2_nonrehab * r18.p_buildings_until_1919.factor_adapted_to_fec
        )
        p_buildings_1919_1948.demand_heat_nonrehab = (
            p_buildings_1919_1948.area_m2_nonrehab * r18.p_buildings_1919_1948.factor_adapted_to_fec
        )
        p_buildings_1949_1978.demand_heat_nonrehab = (
            p_buildings_1949_1978.area_m2_nonrehab * r18.p_buildings_1949_1978.factor_adapted_to_fec
        )
        p_buildings_1979_1995.demand_heat_nonrehab = (
            p_buildings_1979_1995.area_m2_nonrehab * r18.p_buildings_1979_1995.factor_adapted_to_fec
        )
        p_buildings_1996_2004.demand_heat_nonrehab = (
            p_buildings_1996_2004.area_m2_nonrehab * r18.p_buildings_1996_2004.factor_adapted_to_fec
        )
        p_buildings_2005_2011.demand_heat_nonrehab = (
            p_buildings_2005_2011.area_m2_nonrehab * r18.p_buildings_2005_2011.fec_factor_BMWi
        )
        p_buildings_2011_today.demand_heat_nonrehab = (
            p_buildings_2011_today.area_m2_nonrehab * r18.p_buildings_2011_today.fec_factor_BMWi
        )
        ...
        p_buildings_until_1919.demand_heat_rehab = (
            p_buildings_until_1919.area_m2_rehab * ass('Ass_R_P_heat_consumption_after_renovation_per_area')
        )
        p_buildings_1919_1948.demand_heat_rehab = (
            p_buildings_1919_1948.area_m2_rehab * ass('Ass_R_P_heat_consumption_after_renovation_per_area')
        )
        p_buildings_1949_1978.demand_heat_rehab = (
            p_buildings_1949_1978.area_m2_rehab * ass('Ass_R_P_heat_consumption_after_renovation_per_area')
        )
        p_buildings_1979_1995.demand_heat_rehab = (
            p_buildings_1979_1995.area_m2_rehab * ass('Ass_R_P_heat_consumption_after_renovation_per_area')
        )
        p_buildings_1996_2004.demand_heat_rehab = (
            p_buildings_1996_2004.area_m2_rehab * ass('Ass_R_P_heat_consumption_after_renovation_per_area')
        )
        ...
        p_buildings_1949_1978.energy = p_buildings_1949_1978.demand_heat_nonrehab + p_buildings_1949_1978.demand_heat_rehab
        p_buildings_1979_1995.energy = p_buildings_1979_1995.demand_heat_nonrehab + p_buildings_1979_1995.demand_heat_rehab
        p_buildings_1996_2004.energy = p_buildings_1996_2004.demand_heat_nonrehab + p_buildings_1996_2004.demand_heat_rehab
        p_buildings_2005_2011.energy = p_buildings_2005_2011.demand_heat_nonrehab + p_buildings_2005_2011.demand_heat_rehab
        p_buildings_2011_today.energy = p_buildings_2011_today.demand_heat_nonrehab + p_buildings_2011_today.demand_heat_rehab
        ...
        p_buildings_area_m2_com.area_m2 = (p_buildings_total.area_m2 * r18.p_buildings_area_m2_com.pct_x)
        p_buildings_area_m2_com.energy = p_buildings_area_m2_com.area_m2 * p_buildings_area_m2_com.fec_factor_averaged
        p_buildings_new.energy = p_buildings_new.area_m2 * p_buildings_new.fec_factor_averaged
        ...
        p_buildings_until_1919.number_of_buildings_rehab = (
            p_buildings_until_1919.pct_rehab * r18.p_buildings_until_1919.number_of_buildings
        )
        ...
        p_buildings_until_1919.rate_rehab_pa = (
            (p_buildings_until_1919.pct_rehab - fact('Fact_R_P_ratio_renovated_buildings to_not_renovated_2021')) / Kalkulationszeitraum
        )
        p_buildings_1919_1948.rate_rehab_pa = (
            (p_buildings_1919_1948.pct_rehab - fact('Fact_R_P_ratio_renovated_buildings to_not_renovated_2021')) / Kalkulationszeitraum
        )
        p_buildings_1949_1978.rate_rehab_pa = (
            (p_buildings_1949_1978.pct_rehab - fact('Fact_R_P_ratio_renovated_buildings to_not_renovated_2021')) / Kalkulationszeitraum
        )
        p_buildings_1979_1995.rate_rehab_pa = (
            (p_buildings_1979_1995.pct_rehab - fact('Fact_R_P_ratio_renovated_buildings to_not_renovated_2021')) / Kalkulationszeitraum
        )
    ...
    # Definitions
        ...
        s_biomass.energy = (
            r18.s_biomass.number_of_buildings * p_buildings_total.fec_factor_averaged * r18.p_buildings_total.area_m2 /
        ...
        s_heatnet.energy = (
            ...
            p_buildings_total.fec_factor_averaged * r18.p_buildings_total.area_m2
        )
        s_gas.energy = 0
        ...
        s_solarth.energy = (
            max(r18.p_buildings_total.number_of_buildings /
                (r18.p_buildings_total.number_of_buildings + b18.p_nonresi.number_of_buildings) *
        ...
        sum_fueloil_to_heatpump_energy = (
            s_fueloil.energy + s_lpg.energy + s_biomass.energy + s_coal.energy +
            s_petrol.energy + s_heatnet.energy + s_solarth.energy + s_heatpump.energy
        )
        s_elec_heating.energy = 0
        s_emethan.energy = max(0, p_buildings_total.energy - sum_fueloil_to_heatpump_energy)
        ...
        p_buildings_total.change_energy_MWh = p_buildings_total.energy - r18.p_buildings_total.energy
        p_buildings_total.change_energy_pct = p_buildings_total.change_energy_MWh / r18.p_buildings_total.energy
        ...
        s_heatpump.change_energy_pct = s_heatpump.change_energy_MWh / r18.s_heatpump.energy
        s_elec.change_energy_pct = s_elec.change_energy_MWh / r18.s_elec.energy
        s_elec_heating.change_energy_pct = s_elec_heating.change_energy_MWh / r18.s_elec_heating.energy
        ...
        s_fueloil.CO2e_total_2021_estimated = r18.s_fueloil.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        s_lpg.CO2e_total_2021_estimated = r18.s_lpg.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        s_biomass.CO2e_total_2021_estimated = r18.s_biomass.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        s_coal.CO2e_total_2021_estimated = r18.s_coal.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        s_petrol.CO2e_total_2021_estimated = r18.s_petrol.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        s_heatnet.CO2e_total_2021_estimated = r18.s_heatnet.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        s_solarth.CO2e_total_2021_estimated = r18.s_solarth.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        s_heatpump.CO2e_total_2021_estimated = r18.s_heatpump.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        s_gas.CO2e_total_2021_estimated = r18.s_gas.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        s_emethan.CO2e_total_2021_estimated = 0 * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')

        s.CO2e_total_2021_estimated = (
            r18.s.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018')
        )
        ...
        p_buildings_until_1919.invest_per_x = (
            (
                fact('Fact_R_P_energetical_renovation_cost_detached_house_until_1949') *
                (entry('In_R_area_m2_1flat') + entry('In_R_area_m2_2flat')) / entry('In_R_area_m2') +
                fact('Fact_R_P_energetical_renovation_cost_apartm_building_until_1949') *
        ...
        p_buildings_1979_1995.invest_per_x = (
            (
                fact('Fact_R_P_energetical_renovation_cost_detached_house_1980+') *
                (entry('In_R_area_m2_1flat') + entry('In_R_area_m2_2flat')) / entry('In_R_area_m2') +
                fact('Fact_R_P_energetical_renovation_cost_apartm_building_1980+') *
                (entry('In_R_area_m2_3flat') + entry('In_R_area_m2_dorm')) / entry('In_R_area_m2')
            )
        )
        ...
        p_buildings_until_1919.invest = (
            p_buildings_until_1919.area_m2_rehab * (1 - fact('Fact_R_P_ratio_renovated_buildings to_not_renovated_2021')) *
            p_buildings_until_1919.invest_per_x
        )
        p_buildings_1919_1948.invest = (
            p_buildings_1919_1948.area_m2_rehab * (1 - fact('Fact_R_P_ratio_renovated_buildings to_not_renovated_2021')) *
            p_buildings_1919_1948.invest_per_x
        )
        p_buildings_1949_1978.invest = (
            p_buildings_1949_1978.area_m2_rehab * (1 - fact('Fact_R_P_ratio_renovated_buildings to_not_renovated_2021')) *
            p_buildings_1949_1978.invest_per_x
        )
        p_buildings_1979_1995.invest = (
            p_buildings_1979_1995.area_m2_rehab * (1 - fact('Fact_R_P_ratio_renovated_buildings to_not_renovated_2021')) *
            p_buildings_1979_1995.invest_per_x
        )
        p_buildings_1996_2004.invest = (
            p_buildings_1996_2004.area_m2_rehab * (1 - fact('Fact_R_P_ratio_renovated_buildings to_not_renovated_2021')) *
        ...
        p_buildings_total.cost_wage = p_buildings_total.invest / Kalkulationszeitraum * p_buildings_total.pct_of_wage
        ...
        p_buildings_total.ratio_wage_to_emplo = fact('Fact_B_P_renovations_wage_per_person_per_year_2017')
        ...
        p_buildings_total.demand_emplo = p_buildings_total.cost_wage / p_buildings_total.ratio_wage_to_emplo
        g_consult.demand_emplo = g_consult.cost_wage / g_consult.ratio_wage_to_emplo

        p_buildings_total.emplo_existing = (
            fact('Fact_B_P_renovation_emplo_2017') * p_buildings_total.demand_emplo /
            (p_buildings_total.demand_emplo + b30.p_nonresi.demand_emplo + a30.p_operation_heat.demand_emplo) *
        ...
        s_solarth.emplo_existing = (
            ...
            entry('In_M_population_nat') * s_solarth.demand_emplo /
            (s_solarth.demand_emplo + s_heatpump.demand_emplo +
             b30.s_heatpump.demand_emplo + b30.s_solarth.demand_emplo + a30.s_heatpump.demand_emplo)
        )
        ...
        p_buildings_total.demand_emplo_new = (
            max(0, p_buildings_total.demand_emplo - p_buildings_total.emplo_existing)
        )

        g_consult.emplo_existing = (
            fact('Fact_R_G_energy_consulting_total_personel') * g_consult.demand_emplo /
            (g_consult.demand_emplo + b30.g_consult.demand_emplo) *
            entry('In_M_population_com_2018') / entry('In_M_population_nat')
        )
        g_consult.demand_emplo_new = (
            max(0, g_consult.demand_emplo - g_consult.emplo_existing)
        )
        s_solarth.demand_emplo_new = (
        ...
        p_buildings_area_m2_com.invest_com = (
            ...
            r18.p_buildings_area_m2_com.pct_x * p_buildings_area_m2_com.invest_per_x
        )
        ...
        p.demand_emplo_new = (p_buildings_total.demand_emplo_new)
        p_buildings_until_1919.change_energy_MWh = (p_buildings_until_1919.energy - r18.p_buildings_until_1919.energy)
        p_buildings_until_1919.change_energy_pct = (p_buildings_until_1919.change_energy_MWh / r18.p_buildings_until_1919.energy)
        p_buildings_1919_1948.change_energy_MWh = (p_buildings_1919_1948.energy - r18.p_buildings_1919_1948.energy)
        p_buildings_1919_1948.change_energy_pct = (p_buildings_1919_1948.change_energy_MWh / r18.p_buildings_1919_1948.energy)
        p_buildings_1949_1978.change_energy_MWh = (p_buildings_1949_1978.energy - r18.p_buildings_1949_1978.energy)
        p_buildings_1949_1978.change_energy_pct = (p_buildings_1949_1978.change_energy_MWh / r18.p_buildings_1949_1978.energy)
        p_buildings_1979_1995.change_energy_MWh = (p_buildings_1979_1995.energy - r18.p_buildings_1979_1995.energy)
        p_buildings_1979_1995.change_energy_pct = (p_buildings_1979_1995.change_energy_MWh / r18.p_buildings_1979_1995.energy)
        p_buildings_1996_2004.change_energy_MWh = (p_buildings_1996_2004.energy - r18.p_buildings_1996_2004.energy)
        p_buildings_1996_2004.change_energy_pct = (p_buildings_1996_2004.change_energy_MWh / r18.p_buildings_1996_2004.energy)
        p_buildings_2005_2011.change_energy_MWh = (p_buildings_2005_2011.energy - r18.p_buildings_2005_2011.energy)
        p_buildings_2005_2011.change_energy_pct = (p_buildings_2005_2011.change_energy_MWh / r18.p_buildings_2005_2011.energy)
        p_buildings_2011_today.change_energy_MWh = (p_buildings_2011_today.energy - r18.p_buildings_2011_today.energy)
        p_buildings_2011_today.change_energy_pct = (p_buildings_2011_today.change_energy_MWh / r18.p_buildings_2011_today.energy)
        ...
        p_elec_heatpump.demand_change = (p_elec_heatpump.energy / r18.p_elec_heatpump.energy - 1)
        p_elec_heatpump.change_energy_MWh = (p_elec_heatpump.energy - r18.p_elec_heatpump.energy)
        p_elec_heatpump.change_energy_pct = (p_elec_heatpump.change_energy_MWh / r18.p_elec_heatpump.energy)
        p_elec_elcon.change_energy_MWh = (p_elec_elcon.energy - r18.p_elec_elcon.energy)
        p_elec_elcon.change_energy_pct = (p_elec_elcon.change_energy_MWh / r18.p_elec_elcon.energy)
        p_vehicles.change_energy_MWh = (p_vehicles.energy - r18.p_vehicles.energy)
        p_vehicles.change_energy_pct = (p_vehicles.change_energy_MWh / r18.p_vehicles.energy)
        s_fueloil.CO2e_total = (s_fueloil.CO2e_cb)
        s.CO2e_total_2021_estimated = (r18.s.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        ...
        s_elec_heating.CO2e_total_2021_estimated = (r18.s_elec_heating.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
        s_elec_heating.CO2e_total_2021_estimated = (r18.s_elec_heating.CO2e_cb * fact('Fact_M_CO2e_wo_lulucf_2021_vs_2018'))
