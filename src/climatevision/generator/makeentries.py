...
def validate_entries(entries: Entries):
    """Checks that the numeric values are not negative"""

    assert entries.a_area_agri_com_pct_of_organic >= 0
    assert entries.a_biomass_fec >= 0
    assert entries.a_diesel_fec >= 0
    assert entries.a_elec_fec >= 0
    assert entries.a_farm_amount >= 0
    assert entries.a_fermen_dairycow_amount >= 0
    assert entries.a_fermen_nondairy_amount >= 0
    assert entries.a_fermen_oanimal_amount >= 0
    assert entries.a_fermen_pig_amount >= 0
    assert entries.a_fermen_poultry_amount >= 0
    assert entries.a_fueloil_fec >= 0
    assert entries.a_gas_fec >= 0
    assert entries.a_lpg_fec >= 0
    assert entries.a_manure_dairycow_ratio_CO2e_to_amount >= 0
    assert entries.a_manure_deposition_ratio_CO2e_to_amount >= 0
    assert entries.a_manure_nondairy_ratio_CO2e_to_amount >= 0
    assert entries.a_manure_oanimal_ratio_CO2e_to_amount >= 0
    assert entries.a_manure_poultry_ratio_CO2e_to_amount >= 0
    assert entries.a_manure_swine_ratio_CO2e_to_amount >= 0
    assert entries.a_other_ecrop_prod_volume >= 0
    assert entries.a_other_kas_prod_volume >= 0
    assert entries.a_other_liming_calcit_prod_volume >= 0
    assert entries.a_other_liming_dolomite_prod_volume >= 0
    assert entries.a_other_urea_prod_volume >= 0
    assert entries.a_petrol_fec >= 0
    assert entries.a_soil_crazing_ratio_CO2e_to_ha >= 0
    assert entries.a_soil_deposition_ratio_CO2e_to_ha >= 0
    assert entries.a_soil_ecrop_ratio_CO2e_to_ha >= 0
    assert entries.a_soil_fertilizer_ratio_CO2e_to_ha >= 0
    assert entries.a_soil_leaching_ratio_CO2e_to_ha >= 0
    assert entries.a_soil_manure_ratio_CO2e_to_ha >= 0
    assert entries.a_soil_orgfarm_ratio_CO2e_to_ha >= 0
    assert entries.a_soil_orgloss_ratio_CO2e_to_ha >= 0
    assert entries.a_soil_residue_ratio_CO2e_to_ha >= 0
    assert entries.a_soil_sludge_ratio_CO2e_to_ha >= 0
    assert entries.b_biomass_fec >= 0
    assert entries.b_coal_fec >= 0
    assert entries.b_diesel_fec >= 0
    assert entries.b_elec_fec >= 0
    assert entries.b_fueloil_fec >= 0
    assert entries.b_gas_fec >= 0
    assert entries.b_heatnet_fec >= 0
    assert entries.b_jetfuel_fec >= 0
    assert entries.b_lpg_fec >= 0
    assert entries.b_orenew_fec >= 0
    assert entries.b_petrol_fec >= 0
    assert entries.e_local_wind_onshore_ratio_power_to_area_sta >= 0
    assert entries.e_biomass_local_power_installable_sta >= 0
    assert entries.e_PV_power_inst_agripv >= 0
    assert entries.e_PV_power_inst_biomass >= 0
    assert entries.e_PV_power_inst_facade >= 0
    assert entries.e_PV_power_inst_park >= 0
    assert entries.e_PV_power_inst_roof >= 0
    assert entries.e_PV_power_inst_water >= 0
    assert entries.e_PV_power_inst_wind_on >= 0
    assert entries.e_PV_power_to_be_inst_agri >= 0
    assert entries.e_PV_power_to_be_inst_facade >= 0
    assert entries.e_PV_power_to_be_inst_local_biomass >= 0
    assert entries.e_PV_power_to_be_inst_local_wind_onshore >= 0
    assert entries.e_PV_power_to_be_inst_park >= 0
    assert entries.e_PV_power_to_be_inst_roof >= 0
    assert entries.e_pv_full_load_hours_sta >= 0
    assert entries.h_solartherm_to_be_inst >= 0
    assert entries.i_dehst_miner_cement >= 0
    assert entries.i_dehst_miner_chalk >= 0
    assert entries.i_dehst_miner_glas >= 0
    assert entries.i_dehst_miner_ceram >= 0
    assert entries.i_dehst_chem_basic >= 0
    assert entries.i_dehst_chem_ammonia >= 0
    assert entries.i_dehst_chem_other >= 0
    assert entries.i_dehst_metal_steel_primary >= 0
    assert entries.i_dehst_metal_steel_secondary >= 0
    assert entries.i_dehst_metal_nonfe >= 0
    assert entries.i_dehst_other_paper >= 0
    assert entries.i_dehst_other_food >= 0
    assert entries.i_dehst_other_further >= 0
    assert entries.m_GHG_budget_2016_to_year_target >= 0
    assert entries.m_area_agri_com >= 0
    assert entries.m_area_agri_nat >= 0
    assert entries.m_area_agri_sta >= 0
    assert entries.m_area_industry_com >= 0
    assert entries.m_area_industry_nat >= 0
    assert entries.m_area_settlement_com >= 0
    assert entries.m_area_total_com >= 0
    assert entries.m_area_total_dis >= 0
    assert entries.m_area_total_nat >= 0
    assert entries.m_area_total_sta >= 0
    assert entries.m_area_transport_com >= 0
    assert entries.m_area_veg_grove_com >= 0
    assert entries.m_area_veg_heath_com >= 0
    assert entries.m_area_veg_marsh_com >= 0
    assert entries.m_area_veg_moor_com >= 0
    assert entries.m_area_veg_plant_uncover_com >= 0
    assert entries.m_area_veg_wood_com >= 0
    assert entries.m_area_water_com >= 0
    assert entries.m_area_wood_com >= 0
    assert entries.m_duration_neutral >= 0
    assert entries.m_duration_target >= 0
    assert entries.m_nonCO2_budget_2016_to_year_target >= 0
    assert entries.m_population_com_2018 >= 0
    assert entries.m_population_com_203X >= 0
    assert entries.m_population_dis >= 0
    assert entries.m_population_nat >= 0
    assert entries.m_population_sta >= 0
    assert entries.m_year_target >= 0
    assert entries.m_year_baseline >= 0
    assert entries.m_year_ref >= 0
    assert entries.r_area_m2 >= 0
    assert entries.r_area_m2_1flat >= 0
    assert entries.r_area_m2_2flat >= 0
    assert entries.r_area_m2_3flat >= 0
    assert entries.r_area_m2_dorm >= 0
    assert entries.r_biomass_fec >= 0
    assert entries.r_buildings_1919_1948 >= 0
    assert entries.r_buildings_1949_1978 >= 0
    assert entries.r_buildings_1979_1986 >= 0
    assert entries.r_buildings_1987_1990 >= 0
    assert entries.r_buildings_1991_1995 >= 0
    assert entries.r_buildings_1996_2000 >= 0
    assert entries.r_buildings_2001_2004 >= 0
    assert entries.r_buildings_2005_2008 >= 0
    assert entries.r_buildings_2009_2011 >= 0
    assert entries.r_buildings_2011_today >= 0
    assert entries.r_buildings_com >= 0
    assert entries.r_buildings_ge_3_apts >= 0
    assert entries.r_buildings_le_2_apts >= 0
    assert entries.r_buildings_nat >= 0
    assert entries.r_buildings_until_1919 >= 0
    assert entries.r_coal_fec >= 0
    assert entries.r_elec_fec >= 0
    assert entries.r_energy_total >= 0
    assert entries.r_flats_com >= 0
    assert entries.r_flats_w_heatnet >= 0
    assert entries.r_flats_wo_heatnet >= 0
    assert entries.r_fueloil_fec >= 0
    assert entries.r_gas_fec >= 0
    assert entries.r_heatnet_fec >= 0
    assert entries.r_heatnet_ratio_year_target >= 0
    assert entries.r_lpg_fec >= 0
    assert entries.r_orenew_fec >= 0
    assert entries.r_pct_of_area_m2_com >= 0
    assert entries.r_petrol_fec >= 0
    assert entries.r_rehab_rate_pa >= 0
    assert entries.t_bus_mega_km_dis >= 0
    assert entries.t_ec_rail_gds_diesel >= 0
    assert entries.t_ec_rail_gds_elec >= 0
    assert entries.t_ec_rail_ppl_diesel >= 0
    assert entries.t_ec_rail_ppl_elec >= 0
    assert entries.t_metro_mega_km_dis >= 0
    assert entries.t_mil_car_ab >= 0
    assert entries.t_mil_car_it_ot >= 0
    assert entries.t_mil_ldt_ab >= 0
    assert entries.t_mil_ldt_it_ot >= 0
    assert entries.t_mil_mhd_ab >= 0
    assert entries.t_mil_mhd_it_ot >= 0
    assert entries.t_a_eev_kerosene_overseas_total >= 0
    assert entries.t_a_conveyance_capa_inland_pkm_com >= 0
    assert entries.t_a_transport_capa_inland_tkm_com >= 0
    assert entries.t_a_flight_kilometer_inland_km_com >= 0
    assert entries.t_a_eev_kerosene_inland_com >= 0
    assert entries.t_a_eev_petrol_inland_com >= 0
    assert entries.t_a_ghg_inland_com >= 0
    assert entries.t_a_conveyance_capa_overseas_pkm_com >= 0
    assert entries.t_a_transport_capa_overseas_tkm_com >= 0
    assert entries.t_a_flight_kilometer_overseas_km_com >= 0
    assert entries.t_a_eev_kerosene_overseas_com >= 0
    assert entries.t_a_ghg_overseas_com >= 0
    assert entries.t_a_sum_ghg_com >= 0
    assert entries.t_s_eev_diesel_inland_mwh_total >= 0
    assert entries.t_s_eev_fuel_overseas_mwh_total >= 0
    assert entries.t_s_eev_diesel_inland_mwh_com >= 0
    assert entries.t_s_eev_fuel_overseas_mwh_com >= 0
    assert entries.t_s_ghg_inland_com >= 0
    assert entries.t_s_ghg_overseas_com >= 0
    assert entries.t_s_ghg_sum_com >= 0
    assert entries.w_elec_fec >= 0
