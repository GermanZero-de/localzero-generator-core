...
def calc(inputs: Inputs, inputs_germany: Inputs) -> I18:
    ...
    return I18(
        ...
        s=supply.s,
        s_miner=supply.s_miner,
        s_miner_cement=supply.s_miner_cement,
        s_miner_chalk=supply.s_miner_chalk,
        s_miner_glas=supply.s_miner_glas,
        s_miner_ceram=supply.s_miner_ceram,
        s_chem=supply.s_chem,
        s_chem_basic=supply.s_chem_basic,
        s_chem_ammonia=supply.s_chem_ammonia,
        s_chem_other=supply.s_chem_other,
        s_metal=supply.s_metal,
        s_metal_steel=supply.s_metal_steel,
        s_metal_steel_primary=supply.s_metal_steel_primary,
        s_metal_steel_secondary=supply.s_metal_steel_secondary,
        s_metal_nonfe=supply.s_metal_nonfe,
        s_other=supply.s_other,
        s_other_paper=supply.s_other_paper,
        s_other_food=supply.s_other_food,
        s_other_further=supply.s_other_further,
        # s=supply.s,
