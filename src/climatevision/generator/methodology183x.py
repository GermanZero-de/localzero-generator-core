...
def calc_z(
    ...
    *,
    ...
    h.invest_com_wo_state_pct = div(0, z.invest_com_wo_state)
    e.invest_com_wo_state_pct = div(0, z.invest_com_wo_state)
    f.invest_com_wo_state_pct = div(0, z.invest_com_wo_state)
    r.invest_com_wo_state_pct = div(0, z.invest_com_wo_state)
    b.invest_com_wo_state_pct = div(0, z.invest_com_wo_state)
    i.invest_com_wo_state_pct = div(0, z.invest_com_wo_state)
    t.invest_com_state_pct = div(t30.t.invest_com_state, z.invest_com_state)
    a.invest_com_wo_state_pct = div(0, z.invest_com_wo_state)
    l.invest_com_wo_state_pct = div(0, z.invest_com_wo_state)
    w.invest_com_wo_state_pct = div(0, z.invest_com_wo_state)
