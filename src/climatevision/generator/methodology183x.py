...
def calc_budget(
    ...
    *,
    ...
    years_list_2016_to_year_before_baseline_wo_year_ref = (
        years_list_2016_to_year_before_baseline.copy()
    )
    years_list_2016_to_year_before_baseline_wo_year_ref.remove(year_ref)

    years_list_2016_to_2051 = list(range(2016, 2052))

    years_predicted = list(range(year_baseline, 2052))

    years_dict: dict[int, dict[str, float]] = {
        year: {} for year in years_list_2016_to_year_before_baseline
    }
    ...
    # get the CO2e of all sectors for year_ref
    years_dict[year_ref]["CO2e_w_lulucf"] = (
        h18.h.CO2e_total
        + e18.e.CO2e_total
        + f18.f.CO2e_total
        + r18.r.CO2e_total
    ...
    ) = [years_dict[year]["CO2e_w_lulucf"] for year in years_list_2016_to_2051]
...
def calc_z(
    ...
    *,
    ...
    h.invest_com_state_pct = div(0, z.invest_com_state)
    e.invest_com_state_pct = div(0, z.invest_com_state)
    f.invest_com_state_pct = div(0, z.invest_com_state)
    r.invest_com_state_pct = div(0, z.invest_com_state)
    b.invest_com_state_pct = div(0, z.invest_com_state)
    i.invest_com_state_pct = div(0, z.invest_com_state)
    t.invest_com_state_pct = div(t30.t.invest_com_state, z.invest_com_state)
    a.invest_com_state_pct = div(0, z.invest_com_state)
    l.invest_com_state_pct = div(0, z.invest_com_state)
    w.invest_com_state_pct = div(0, z.invest_com_state)
