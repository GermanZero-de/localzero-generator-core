...
class Ship:
    ...
    def calc_ship_domestic(
        ...
        demand_diesel = entries.t_s_eev_diesel_inland_mwh_com * fact(
            "Fact_T_S_ship_diesel_fec_year_ref_ratio_ageb_to_kv"
        )
    ...
    def calc_ship_international(
        ...
        demand_fueloil = entries.t_s_eev_fuel_overseas_mwh_com * fact(
            "Fact_T_S_ship_fueloil_fec_year_ref_ratio_ageb_to_kv"
        )
