...
def calc_production_local_pv_roof(
    ...
    *,
    ...
    invest_per_x = ass("Ass_E_P_local_pv_roof_ratio_invest_to_power_2030") * 1000
    ...
    area_ha_available_pct_of_action = ass("Ass_E_P_local_pv_roof_potential")
    ratio_power_to_area_ha = ass("Ass_E_P_local_pv_roof_ratio_power_to_area_ha")
    power_installable = (
        area_ha_available * area_ha_available_pct_of_action * ratio_power_to_area_ha
    )
    ...
    invest_com = div(
        invest * (r18.p_buildings_area_m2_com.area_m2 + b18.p_nonresi_com.area_m2),
        b18.p_nonresi.area_m2 + r18.p_buildings_total.area_m2,
    )
    change_cost_mro = cost_mro - e18.p_local_pv_roof.cost_mro
    ...
    p_local_pv_roof.change_energy_MWh = energy - e18.p_local_pv_roof.energy
...
def calc_production_local_pv_facade(
    ...
    *,
    ...
    invest_per_x = ass("Ass_E_S_local_pv_facade_ratio_invest_to_power") * 1000
    pct_of_wage = ass("Ass_E_P_pv_invest_pct_of_wage")
    ratio_wage_to_emplo = ass("Ass_E_P_constr_elec_ratio_wage_to_emplo_2017")
    power_to_be_installed_pct = entries.e_PV_power_to_be_inst_facade
    ratio_power_to_area_ha = ass("Ass_E_P_local_pv_facade_ratio_power_to_area_ha")
    area_ha_available = (
        ass("Ass_E_P_lcoal_pv_facade_potential")
        * entries.r_buildings_com
        / entries.r_buildings_nat
    )
    area_ha_available_pct_of_action = ass("Ass_E_P_local_pv_facade_potential_usable")
    power_installable = (
    ...
    change_cost_mro = cost_mro - e18.p_local_pv_facade.cost_mro
    cost_wage = invest_pa * pct_of_wage
    invest_pa_com = invest_com / duration_until_target_year
    ...
    p_local_pv_facade.change_energy_MWh = energy - e18.p_local_pv_facade.energy
...
def calc_production_local_pv_agri(
    ...
    *,
    ...
    invest_per_x = ass("Ass_E_P_local_pv_agri_ratio_invest_to_power") * 1000
    pct_of_wage = ass("Ass_E_P_pv_invest_pct_of_wage")
    ratio_wage_to_emplo = ass("Ass_E_P_constr_elec_ratio_wage_to_emplo_2017")
    ...
    area_ha_available_pct_of_action = ass("Ass_E_P_local_pv_agri_power_installable") / (
    ...
    power_installable = (
        ratio_power_to_area_ha * area_ha_available_pct_of_action * area_ha_available
    )
    cost_mro_per_MWh = (
    ...
    cost_mro = energy * cost_mro_per_MWh / MILLION
    invest_pa = invest / duration_until_target_year
    change_cost_mro = cost_mro - e18.p_local_pv_agri.cost_mro
    cost_wage = invest_pa * pct_of_wage
    change_CO2e_t = 0
    CO2e_total = 0
    change_CO2e_pct = 0
    ...
    p_local_pv_agri.change_energy_MWh = energy - e18.p_local_pv_agri.energy
...
def calc_production_local_pv_park(
    ...
    *,
    ...
    invest_per_x = ass("Ass_E_S_local_pv_park_ratio_invest_to_power_2030") * 1000
    pct_of_wage = ass("Ass_E_P_pv_invest_pct_of_wage")
    ratio_wage_to_emplo = ass("Ass_E_P_constr_elec_ratio_wage_to_emplo_2017")
    ...
    area_ha_available_pct_of_action = ass("Ass_E_P_local_pv_park_area_pct_of_available")
    ...
    cost_mro = energy * cost_mro_per_MWh / MILLION
    invest_pa = invest / duration_until_target_year
    change_cost_mro = cost_mro - e18.p_local_pv_park.cost_mro
    cost_wage = invest_pa * pct_of_wage
    change_CO2e_t = 0
    CO2e_total = 0
    change_CO2e_pct = 0
    ...
    p_local_pv_park.change_energy_MWh = energy - e18.p_local_pv_park.energy
