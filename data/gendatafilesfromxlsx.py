...
def make_entry(ags: str, year: int):
    ...
    entry["In_I_fec_pct_of_other"] =  data.fact("Fact_I_N_sonst_Anteil_EEV_2018") # new (changed in excel 27.01.22"Fact_I_P_other_ratio_fec_to_industry_EEV_2018"
