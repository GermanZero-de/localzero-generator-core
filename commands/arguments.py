...
def add_year_ref_argument(parser: Any):
    parser.add_argument("-year_ref", type=int, default=2018, choices=[2018, 2021], help='year of the reference data')

def add_year_target_argument(parser: Any):
    parser.add_argument("-year_target", type=int, default=2035, choices=range(2025, 2051), help='target year')
